...
void main()
{
    ...
    surfaceshader surface_R3_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            mx_generalized_schlick_bsdf(closureData, schlick_R3_weight, schlick_R3_color0, schlick_R3_color82, schlick_R3_color90, schlick_R3_exponent, schlick_R3_roughness, schlick_R3_retroreflective, schlick_R3_thinfilm_thickness, schlick_R3_thinfilm_ior, geomprop_Nworld_out1, geomprop_Tworld_out1, schlick_R3_distribution, schlick_R3_scatter_mode, schlick_R3_out);
