...
void main()
{
    ...
    surfaceshader surface_layer_RT2_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            mx_generalized_schlick_bsdf(closureData, schlick_R2_weight, schlick_R2_color0, schlick_R2_color82, schlick_R2_color90, schlick_R2_exponent, schlick_R2_roughness, schlick_R2_retroreflective, schlick_R2_thinfilm_thickness, schlick_R2_thinfilm_ior, geomprop_Nworld_out1, geomprop_Tworld_out1, schlick_R2_distribution, schlick_R2_scatter_mode, schlick_R2_out);
            BSDF schlick_T2_out = BSDF(vec3(0.0),vec3(1.0));
            mx_generalized_schlick_bsdf(closureData, schlick_T2_weight, schlick_T2_color0, schlick_T2_color82, schlick_T2_color90, schlick_T2_exponent, schlick_T2_roughness, schlick_T2_retroreflective, schlick_T2_thinfilm_thickness, schlick_T2_thinfilm_ior, geomprop_Nworld_out1, geomprop_Tworld_out1, schlick_T2_distribution, schlick_T2_scatter_mode, schlick_T2_out);
