...
void NG_custom_layer(ClosureData closureData, BSDF top, BSDF base, out BSDF out1)
{
    BSDF layer_out = BSDF(vec3(0.0),vec3(1.0));
    mx_layer_bsdf(closureData, top, base, layer_out);
    out1 = layer_out;
}
...
void main()
{
    ...
    surfaceshader surface1_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            NG_custom_layer(closureData, dielectric_out, conductor_out, custom_layer_out);
