...
uniform float multiply_in2 = 0.500000;
...
void main()
{
    ...
    surfaceshader surface1_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            BSDF multiply_out = BSDF(vec3(0.0),vec3(1.0));
            mx_multiply_bsdf_float(closureData, dielectric_out, multiply_in2, multiply_out);
            ...
            mx_layer_bsdf(closureData, multiply_out, conductor_out, layer_out);

            surface1_out.color += occlusion * layer_out.response;
        }
        ...
        BSDF layer_out = BSDF(vec3(0.0),vec3(1.0));
        mx_layer_bsdf(closureData, multiply_out, conductor_out, layer_out);
        surface1_out.color += layer_out.response;
