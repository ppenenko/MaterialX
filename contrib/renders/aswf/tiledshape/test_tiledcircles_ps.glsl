...
uniform vec2 tiledcircles_color3_uvtiling = vec2(29.000000, 29.000000);
uniform vec2 tiledcircles_color3_uvoffset = vec2(0.000000, 0.000000);
uniform float tiledcircles_color3_size = 0.800000;
uniform bool tiledcircles_color3_staggered = false;
uniform float SR_test_tiledcircles_base = 1.000000;
uniform float SR_test_tiledcircles_diffuse_roughness = 0.000000;
uniform float SR_test_tiledcircles_metalness = 0.000000;
uniform float SR_test_tiledcircles_specular = 1.000000;
uniform vec3 SR_test_tiledcircles_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_tiledcircles_specular_roughness = 0.200000;
uniform float SR_test_tiledcircles_specular_IOR = 1.500000;
uniform float SR_test_tiledcircles_specular_anisotropy = 0.000000;
uniform float SR_test_tiledcircles_specular_rotation = 0.000000;
uniform float SR_test_tiledcircles_transmission = 0.000000;
uniform vec3 SR_test_tiledcircles_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_tiledcircles_transmission_depth = 0.000000;
uniform vec3 SR_test_tiledcircles_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_test_tiledcircles_transmission_scatter_anisotropy = 0.000000;
uniform float SR_test_tiledcircles_transmission_dispersion = 0.000000;
uniform float SR_test_tiledcircles_transmission_extra_roughness = 0.000000;
uniform float SR_test_tiledcircles_subsurface = 0.000000;
uniform vec3 SR_test_tiledcircles_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_test_tiledcircles_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_tiledcircles_subsurface_scale = 1.000000;
uniform float SR_test_tiledcircles_subsurface_anisotropy = 0.000000;
uniform float SR_test_tiledcircles_sheen = 0.000000;
uniform vec3 SR_test_tiledcircles_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_tiledcircles_sheen_roughness = 0.300000;
uniform float SR_test_tiledcircles_coat = 0.000000;
uniform vec3 SR_test_tiledcircles_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_tiledcircles_coat_roughness = 0.100000;
uniform float SR_test_tiledcircles_coat_anisotropy = 0.000000;
uniform float SR_test_tiledcircles_coat_rotation = 0.000000;
uniform float SR_test_tiledcircles_coat_IOR = 1.500000;
uniform float SR_test_tiledcircles_coat_affect_color = 0.000000;
uniform float SR_test_tiledcircles_coat_affect_roughness = 0.000000;
uniform float SR_test_tiledcircles_thin_film_thickness = 0.000000;
uniform float SR_test_tiledcircles_thin_film_IOR = 1.500000;
uniform float SR_test_tiledcircles_emission = 0.000000;
uniform vec3 SR_test_tiledcircles_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_test_tiledcircles_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool SR_test_tiledcircles_thin_walled = false;
...
void main()
{
    ...
    vec3 tiledcircles_color3_out = vec3(0.0);
    NG_tiledcircles_color3(geomprop_UV0_out1, tiledcircles_color3_uvtiling, tiledcircles_color3_uvoffset, tiledcircles_color3_size, tiledcircles_color3_staggered, tiledcircles_color3_out);
    surfaceshader SR_test_tiledcircles_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(SR_test_tiledcircles_base, tiledcircles_color3_out, SR_test_tiledcircles_diffuse_roughness, SR_test_tiledcircles_metalness, SR_test_tiledcircles_specular, SR_test_tiledcircles_specular_color, SR_test_tiledcircles_specular_roughness, SR_test_tiledcircles_specular_IOR, SR_test_tiledcircles_specular_anisotropy, SR_test_tiledcircles_specular_rotation, SR_test_tiledcircles_transmission, SR_test_tiledcircles_transmission_color, SR_test_tiledcircles_transmission_depth, SR_test_tiledcircles_transmission_scatter, SR_test_tiledcircles_transmission_scatter_anisotropy, SR_test_tiledcircles_transmission_dispersion, SR_test_tiledcircles_transmission_extra_roughness, SR_test_tiledcircles_subsurface, SR_test_tiledcircles_subsurface_color, SR_test_tiledcircles_subsurface_radius, SR_test_tiledcircles_subsurface_scale, SR_test_tiledcircles_subsurface_anisotropy, SR_test_tiledcircles_sheen, SR_test_tiledcircles_sheen_color, SR_test_tiledcircles_sheen_roughness, SR_test_tiledcircles_coat, SR_test_tiledcircles_coat_color, SR_test_tiledcircles_coat_roughness, SR_test_tiledcircles_coat_anisotropy, SR_test_tiledcircles_coat_rotation, SR_test_tiledcircles_coat_IOR, geomprop_Nworld_out1, SR_test_tiledcircles_coat_affect_color, SR_test_tiledcircles_coat_affect_roughness, SR_test_tiledcircles_thin_film_thickness, SR_test_tiledcircles_thin_film_IOR, SR_test_tiledcircles_emission, SR_test_tiledcircles_emission_color, SR_test_tiledcircles_opacity, SR_test_tiledcircles_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, SR_test_tiledcircles_out);
    material test_tiledcircles_out = SR_test_tiledcircles_out;
    out1 = vec4(test_tiledcircles_out.color, 1.0);
}
