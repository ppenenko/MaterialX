...
uniform vec2 tiledhexagons_color3_uvtiling = vec2(29.000000, 29.000000);
uniform vec2 tiledhexagons_color3_uvoffset = vec2(0.000000, 0.000000);
uniform float tiledhexagons_color3_size = 0.700000;
uniform bool tiledhexagons_color3_staggered = false;
uniform float SR_test_tiledhexagons_base = 1.000000;
uniform float SR_test_tiledhexagons_diffuse_roughness = 0.000000;
uniform float SR_test_tiledhexagons_metalness = 0.000000;
uniform float SR_test_tiledhexagons_specular = 1.000000;
uniform vec3 SR_test_tiledhexagons_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_tiledhexagons_specular_roughness = 0.200000;
uniform float SR_test_tiledhexagons_specular_IOR = 1.500000;
uniform float SR_test_tiledhexagons_specular_anisotropy = 0.000000;
uniform float SR_test_tiledhexagons_specular_rotation = 0.000000;
uniform float SR_test_tiledhexagons_transmission = 0.000000;
uniform vec3 SR_test_tiledhexagons_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_tiledhexagons_transmission_depth = 0.000000;
uniform vec3 SR_test_tiledhexagons_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_test_tiledhexagons_transmission_scatter_anisotropy = 0.000000;
uniform float SR_test_tiledhexagons_transmission_dispersion = 0.000000;
uniform float SR_test_tiledhexagons_transmission_extra_roughness = 0.000000;
uniform float SR_test_tiledhexagons_subsurface = 0.000000;
uniform vec3 SR_test_tiledhexagons_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_test_tiledhexagons_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_tiledhexagons_subsurface_scale = 1.000000;
uniform float SR_test_tiledhexagons_subsurface_anisotropy = 0.000000;
uniform float SR_test_tiledhexagons_sheen = 0.000000;
uniform vec3 SR_test_tiledhexagons_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_tiledhexagons_sheen_roughness = 0.300000;
uniform float SR_test_tiledhexagons_coat = 0.000000;
uniform vec3 SR_test_tiledhexagons_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_tiledhexagons_coat_roughness = 0.100000;
uniform float SR_test_tiledhexagons_coat_anisotropy = 0.000000;
uniform float SR_test_tiledhexagons_coat_rotation = 0.000000;
uniform float SR_test_tiledhexagons_coat_IOR = 1.500000;
uniform float SR_test_tiledhexagons_coat_affect_color = 0.000000;
uniform float SR_test_tiledhexagons_coat_affect_roughness = 0.000000;
uniform float SR_test_tiledhexagons_thin_film_thickness = 0.000000;
uniform float SR_test_tiledhexagons_thin_film_IOR = 1.500000;
uniform float SR_test_tiledhexagons_emission = 0.000000;
uniform vec3 SR_test_tiledhexagons_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_test_tiledhexagons_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool SR_test_tiledhexagons_thin_walled = false;
...
void main()
{
    ...
    vec3 tiledhexagons_color3_out = vec3(0.0);
    ...
    surfaceshader SR_test_tiledhexagons_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    material test_tiledhexagons_out = SR_test_tiledhexagons_out;
    out1 = vec4(test_tiledhexagons_out.color, 1.0);
}
