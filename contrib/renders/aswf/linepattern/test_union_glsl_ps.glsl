...
uniform vec2 grid_color3_uvtiling = vec2(58.000000, 58.000000);
uniform vec2 grid_color3_uvoffset = vec2(0.000000, 0.000000);
uniform float grid_color3_thickness = 0.100000;
uniform bool grid_color3_staggered = false;
uniform vec2 crosshatch_color3_uvtiling = vec2(29.000000, 29.000000);
uniform vec2 crosshatch_color3_uvoffset = vec2(0.000000, 0.000000);
uniform float crosshatch_color3_thickness = 0.050000;
uniform bool crosshatch_color3_staggered = false;
uniform float SR_test_union_base = 1.000000;
uniform float SR_test_union_diffuse_roughness = 0.000000;
uniform float SR_test_union_metalness = 0.000000;
uniform float SR_test_union_specular = 1.000000;
uniform vec3 SR_test_union_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_union_specular_roughness = 0.200000;
uniform float SR_test_union_specular_IOR = 1.500000;
uniform float SR_test_union_specular_anisotropy = 0.000000;
uniform float SR_test_union_specular_rotation = 0.000000;
uniform float SR_test_union_transmission = 0.000000;
uniform vec3 SR_test_union_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_union_transmission_depth = 0.000000;
uniform vec3 SR_test_union_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_test_union_transmission_scatter_anisotropy = 0.000000;
uniform float SR_test_union_transmission_dispersion = 0.000000;
uniform float SR_test_union_transmission_extra_roughness = 0.000000;
uniform float SR_test_union_subsurface = 0.000000;
uniform vec3 SR_test_union_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_test_union_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_union_subsurface_scale = 1.000000;
uniform float SR_test_union_subsurface_anisotropy = 0.000000;
uniform float SR_test_union_sheen = 0.000000;
uniform vec3 SR_test_union_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_union_sheen_roughness = 0.300000;
uniform float SR_test_union_coat = 0.000000;
uniform vec3 SR_test_union_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_union_coat_roughness = 0.100000;
uniform float SR_test_union_coat_anisotropy = 0.000000;
uniform float SR_test_union_coat_rotation = 0.000000;
uniform float SR_test_union_coat_IOR = 1.500000;
uniform float SR_test_union_coat_affect_color = 0.000000;
uniform float SR_test_union_coat_affect_roughness = 0.000000;
uniform float SR_test_union_thin_film_thickness = 0.000000;
uniform float SR_test_union_thin_film_IOR = 1.500000;
uniform float SR_test_union_emission = 0.000000;
uniform vec3 SR_test_union_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_test_union_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool SR_test_union_thin_walled = false;
...
void main()
{
    ...
    vec3 crosshatch_color3_out = vec3(0.0);
    ...
    vec3 union_color3_out = max(grid_color3_out, crosshatch_color3_out);
    surfaceshader SR_test_union_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    material test_union_out = SR_test_union_out;
    out1 = vec4(test_union_out.color, 1.0);
}
