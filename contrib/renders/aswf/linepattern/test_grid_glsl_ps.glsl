...
uniform float SR_test_grid_base = 1.000000;
uniform float SR_test_grid_diffuse_roughness = 0.000000;
uniform float SR_test_grid_metalness = 0.000000;
uniform float SR_test_grid_specular = 1.000000;
uniform vec3 SR_test_grid_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_grid_specular_roughness = 0.200000;
uniform float SR_test_grid_specular_IOR = 1.500000;
uniform float SR_test_grid_specular_anisotropy = 0.000000;
uniform float SR_test_grid_specular_rotation = 0.000000;
uniform float SR_test_grid_transmission = 0.000000;
uniform vec3 SR_test_grid_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_grid_transmission_depth = 0.000000;
uniform vec3 SR_test_grid_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_test_grid_transmission_scatter_anisotropy = 0.000000;
uniform float SR_test_grid_transmission_dispersion = 0.000000;
uniform float SR_test_grid_transmission_extra_roughness = 0.000000;
uniform float SR_test_grid_subsurface = 0.000000;
uniform vec3 SR_test_grid_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_test_grid_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_grid_subsurface_scale = 1.000000;
uniform float SR_test_grid_subsurface_anisotropy = 0.000000;
uniform float SR_test_grid_sheen = 0.000000;
uniform vec3 SR_test_grid_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_grid_sheen_roughness = 0.300000;
uniform float SR_test_grid_coat = 0.000000;
uniform vec3 SR_test_grid_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_grid_coat_roughness = 0.100000;
uniform float SR_test_grid_coat_anisotropy = 0.000000;
uniform float SR_test_grid_coat_rotation = 0.000000;
uniform float SR_test_grid_coat_IOR = 1.500000;
uniform float SR_test_grid_coat_affect_color = 0.000000;
uniform float SR_test_grid_coat_affect_roughness = 0.000000;
uniform float SR_test_grid_thin_film_thickness = 0.000000;
uniform float SR_test_grid_thin_film_IOR = 1.500000;
uniform float SR_test_grid_emission = 0.000000;
uniform vec3 SR_test_grid_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_test_grid_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool SR_test_grid_thin_walled = false;
...
void main()
{
    ...
    surfaceshader SR_test_grid_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    material test_grid_out = SR_test_grid_out;
    out1 = vec4(test_grid_out.color, 1.0);
}
