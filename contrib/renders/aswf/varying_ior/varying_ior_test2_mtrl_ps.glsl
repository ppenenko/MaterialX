...
uniform float varying_ior_test2_ior = 2.300000;
uniform vec2 varying_ior_test2_roughness = vec2(0.100000, 0.100000);
...
void main()
{
    surfaceshader varying_ior_test2_out = surfaceshader(vec3(0.0),vec3(0.0));
    IMP_foo_surface(varying_ior_test2_ior, varying_ior_test2_roughness, varying_ior_test2_out);
    material varying_ior_test2_mtrl_out = varying_ior_test2_out;
    out1 = vec4(varying_ior_test2_mtrl_out.color, 1.0);
}
