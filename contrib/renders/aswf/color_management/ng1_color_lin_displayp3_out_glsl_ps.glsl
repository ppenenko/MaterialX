...
uniform vec4 color_lin_displayp3_value_cm_in = vec4(0.500000, 0.000000, 0.000000, 1.000000);
uniform float color_lin_displayp3_standard_surface5_base = 1.000000;
uniform float color_lin_displayp3_standard_surface5_diffuse_roughness = 0.000000;
uniform float color_lin_displayp3_standard_surface5_metalness = 0.000000;
uniform float color_lin_displayp3_standard_surface5_specular = 1.000000;
uniform vec3 color_lin_displayp3_standard_surface5_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_lin_displayp3_standard_surface5_specular_roughness = 0.200000;
uniform float color_lin_displayp3_standard_surface5_specular_IOR = 1.500000;
uniform float color_lin_displayp3_standard_surface5_specular_anisotropy = 0.000000;
uniform float color_lin_displayp3_standard_surface5_specular_rotation = 0.000000;
uniform float color_lin_displayp3_standard_surface5_transmission = 0.000000;
uniform vec3 color_lin_displayp3_standard_surface5_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_lin_displayp3_standard_surface5_transmission_depth = 0.000000;
uniform vec3 color_lin_displayp3_standard_surface5_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float color_lin_displayp3_standard_surface5_transmission_scatter_anisotropy = 0.000000;
uniform float color_lin_displayp3_standard_surface5_transmission_dispersion = 0.000000;
uniform float color_lin_displayp3_standard_surface5_transmission_extra_roughness = 0.000000;
uniform float color_lin_displayp3_standard_surface5_subsurface = 0.000000;
uniform vec3 color_lin_displayp3_standard_surface5_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 color_lin_displayp3_standard_surface5_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float color_lin_displayp3_standard_surface5_subsurface_scale = 1.000000;
uniform float color_lin_displayp3_standard_surface5_subsurface_anisotropy = 0.000000;
uniform float color_lin_displayp3_standard_surface5_sheen = 0.000000;
uniform vec3 color_lin_displayp3_standard_surface5_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_lin_displayp3_standard_surface5_sheen_roughness = 0.300000;
uniform float color_lin_displayp3_standard_surface5_coat = 0.000000;
uniform vec3 color_lin_displayp3_standard_surface5_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_lin_displayp3_standard_surface5_coat_roughness = 0.100000;
uniform float color_lin_displayp3_standard_surface5_coat_anisotropy = 0.000000;
uniform float color_lin_displayp3_standard_surface5_coat_rotation = 0.000000;
uniform float color_lin_displayp3_standard_surface5_coat_IOR = 1.500000;
uniform float color_lin_displayp3_standard_surface5_coat_affect_color = 0.000000;
uniform float color_lin_displayp3_standard_surface5_coat_affect_roughness = 0.000000;
uniform float color_lin_displayp3_standard_surface5_thin_film_thickness = 0.000000;
uniform float color_lin_displayp3_standard_surface5_thin_film_IOR = 1.500000;
uniform float color_lin_displayp3_standard_surface5_emission = 0.000000;
uniform vec3 color_lin_displayp3_standard_surface5_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 color_lin_displayp3_standard_surface5_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool color_lin_displayp3_standard_surface5_thin_walled = false;
...
out vec4 color_lin_displayp3_out1;
...
void NG_separate4_color4(vec4 in1, out float outr, out float outg, out float outb, out float outa)
{
    ...
    const int N_extract_3_index_tmp = 3;
    float N_extract_3_out = in1[N_extract_3_index_tmp];
...
void NG_convert_color4_color3(vec4 in1, out vec3 out1)
{
    float separate_outr = 0.0;
    float separate_outg = 0.0;
    float separate_outb = 0.0;
    float separate_outa = 0.0;
    NG_separate4_color4(in1, separate_outr, separate_outg, separate_outb, separate_outa);
...
void NG_lin_displayp3_to_lin_rec709_color4(vec4 in1, out vec4 out1)
{
    vec3 asColor3_out = vec3(0.0);
    NG_convert_color4_color3(in1, asColor3_out);
    const int alpha_index_tmp = 3;
    float alpha_out = in1[alpha_index_tmp];
    vec3 transform_out = vec3(0.0);
    NG_lin_displayp3_to_lin_rec709_color3(asColor3_out, transform_out);
    vec4 asColor4_out = vec4(transform_out[0],transform_out[1],transform_out[2],alpha_out);
    out1 = asColor4_out;
}
...
void main()
{
    vec4 color_lin_displayp3_value_cm_out = vec4(0.0);
    NG_lin_displayp3_to_lin_rec709_color4(color_lin_displayp3_value_cm_in, color_lin_displayp3_value_cm_out);
    vec3 geomprop_Nworld_out1 = normalize(vd.normalWorld);
    vec3 geomprop_Tworld_out1 = normalize(vd.tangentWorld);
    vec3 color_lin_displayp3_color3_out = vec3(0.0);
    NG_convert_color4_color3(color_lin_displayp3_value_cm_out, color_lin_displayp3_color3_out);
    surfaceshader color_lin_displayp3_standard_surface5_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(color_lin_displayp3_standard_surface5_base, color_lin_displayp3_color3_out, color_lin_displayp3_standard_surface5_diffuse_roughness, color_lin_displayp3_standard_surface5_metalness, color_lin_displayp3_standard_surface5_specular, color_lin_displayp3_standard_surface5_specular_color, color_lin_displayp3_standard_surface5_specular_roughness, color_lin_displayp3_standard_surface5_specular_IOR, color_lin_displayp3_standard_surface5_specular_anisotropy, color_lin_displayp3_standard_surface5_specular_rotation, color_lin_displayp3_standard_surface5_transmission, color_lin_displayp3_standard_surface5_transmission_color, color_lin_displayp3_standard_surface5_transmission_depth, color_lin_displayp3_standard_surface5_transmission_scatter, color_lin_displayp3_standard_surface5_transmission_scatter_anisotropy, color_lin_displayp3_standard_surface5_transmission_dispersion, color_lin_displayp3_standard_surface5_transmission_extra_roughness, color_lin_displayp3_standard_surface5_subsurface, color_lin_displayp3_standard_surface5_subsurface_color, color_lin_displayp3_standard_surface5_subsurface_radius, color_lin_displayp3_standard_surface5_subsurface_scale, color_lin_displayp3_standard_surface5_subsurface_anisotropy, color_lin_displayp3_standard_surface5_sheen, color_lin_displayp3_standard_surface5_sheen_color, color_lin_displayp3_standard_surface5_sheen_roughness, color_lin_displayp3_standard_surface5_coat, color_lin_displayp3_standard_surface5_coat_color, color_lin_displayp3_standard_surface5_coat_roughness, color_lin_displayp3_standard_surface5_coat_anisotropy, color_lin_displayp3_standard_surface5_coat_rotation, color_lin_displayp3_standard_surface5_coat_IOR, geomprop_Nworld_out1, color_lin_displayp3_standard_surface5_coat_affect_color, color_lin_displayp3_standard_surface5_coat_affect_roughness, color_lin_displayp3_standard_surface5_thin_film_thickness, color_lin_displayp3_standard_surface5_thin_film_IOR, color_lin_displayp3_standard_surface5_emission, color_lin_displayp3_standard_surface5_emission_color, color_lin_displayp3_standard_surface5_opacity, color_lin_displayp3_standard_surface5_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, color_lin_displayp3_standard_surface5_out);
    color_lin_displayp3_out1 = vec4(color_lin_displayp3_standard_surface5_out.color, 1.0);
}
