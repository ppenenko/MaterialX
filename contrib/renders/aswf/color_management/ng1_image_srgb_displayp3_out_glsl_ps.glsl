...
uniform sampler2D image_srgb_displayp3_file;
uniform int image_srgb_displayp3_layer = 0;
uniform vec3 image_srgb_displayp3_default = vec3(0.000000, 0.000000, 0.000000);
uniform int image_srgb_displayp3_uaddressmode = 2;
uniform int image_srgb_displayp3_vaddressmode = 2;
uniform int image_srgb_displayp3_filtertype = 1;
uniform int image_srgb_displayp3_framerange = 0;
uniform int image_srgb_displayp3_frameoffset = 0;
uniform int image_srgb_displayp3_frameendaction = 0;
uniform vec2 image_srgb_displayp3_uv_scale = vec2(1.000000, 1.000000);
uniform vec2 image_srgb_displayp3_uv_offset = vec2(0.000000, 0.000000);
uniform float image_srgb_displayp3_standard_surface9_base = 1.000000;
uniform float image_srgb_displayp3_standard_surface9_diffuse_roughness = 0.000000;
uniform float image_srgb_displayp3_standard_surface9_metalness = 0.000000;
uniform float image_srgb_displayp3_standard_surface9_specular = 1.000000;
uniform vec3 image_srgb_displayp3_standard_surface9_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_srgb_displayp3_standard_surface9_specular_roughness = 0.200000;
uniform float image_srgb_displayp3_standard_surface9_specular_IOR = 1.500000;
uniform float image_srgb_displayp3_standard_surface9_specular_anisotropy = 0.000000;
uniform float image_srgb_displayp3_standard_surface9_specular_rotation = 0.000000;
uniform float image_srgb_displayp3_standard_surface9_transmission = 0.000000;
uniform vec3 image_srgb_displayp3_standard_surface9_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_srgb_displayp3_standard_surface9_transmission_depth = 0.000000;
uniform vec3 image_srgb_displayp3_standard_surface9_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float image_srgb_displayp3_standard_surface9_transmission_scatter_anisotropy = 0.000000;
uniform float image_srgb_displayp3_standard_surface9_transmission_dispersion = 0.000000;
uniform float image_srgb_displayp3_standard_surface9_transmission_extra_roughness = 0.000000;
uniform float image_srgb_displayp3_standard_surface9_subsurface = 0.000000;
uniform vec3 image_srgb_displayp3_standard_surface9_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_srgb_displayp3_standard_surface9_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float image_srgb_displayp3_standard_surface9_subsurface_scale = 1.000000;
uniform float image_srgb_displayp3_standard_surface9_subsurface_anisotropy = 0.000000;
uniform float image_srgb_displayp3_standard_surface9_sheen = 0.000000;
uniform vec3 image_srgb_displayp3_standard_surface9_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_srgb_displayp3_standard_surface9_sheen_roughness = 0.300000;
uniform float image_srgb_displayp3_standard_surface9_coat = 0.000000;
uniform vec3 image_srgb_displayp3_standard_surface9_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_srgb_displayp3_standard_surface9_coat_roughness = 0.100000;
uniform float image_srgb_displayp3_standard_surface9_coat_anisotropy = 0.000000;
uniform float image_srgb_displayp3_standard_surface9_coat_rotation = 0.000000;
uniform float image_srgb_displayp3_standard_surface9_coat_IOR = 1.500000;
uniform float image_srgb_displayp3_standard_surface9_coat_affect_color = 0.000000;
uniform float image_srgb_displayp3_standard_surface9_coat_affect_roughness = 0.000000;
uniform float image_srgb_displayp3_standard_surface9_thin_film_thickness = 0.000000;
uniform float image_srgb_displayp3_standard_surface9_thin_film_IOR = 1.500000;
uniform float image_srgb_displayp3_standard_surface9_emission = 0.000000;
uniform vec3 image_srgb_displayp3_standard_surface9_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_srgb_displayp3_standard_surface9_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool image_srgb_displayp3_standard_surface9_thin_walled = false;
...
out vec4 image_srgb_displayp3_out1;
...
void main()
{
    ...
    vec3 image_srgb_displayp3_out2 = vec3(0.0);
    mx_image_color3(image_srgb_displayp3_file, image_srgb_displayp3_layer, image_srgb_displayp3_default, geomprop_UV0_out1, image_srgb_displayp3_uaddressmode, image_srgb_displayp3_vaddressmode, image_srgb_displayp3_filtertype, image_srgb_displayp3_framerange, image_srgb_displayp3_frameoffset, image_srgb_displayp3_frameendaction, image_srgb_displayp3_uv_scale, image_srgb_displayp3_uv_offset, image_srgb_displayp3_out2);
    vec3 image_srgb_displayp3_out_cm_out = vec3(0.0);
    NG_srgb_displayp3_to_lin_rec709_color3(image_srgb_displayp3_out2, image_srgb_displayp3_out_cm_out);
    surfaceshader image_srgb_displayp3_standard_surface9_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    image_srgb_displayp3_out1 = vec4(image_srgb_displayp3_standard_surface9_out.color, 1.0);
}
