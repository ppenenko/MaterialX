...
uniform sampler2D image_srgb_texture_file;
uniform int image_srgb_texture_layer = 0;
uniform vec3 image_srgb_texture_default = vec3(0.000000, 0.000000, 0.000000);
uniform int image_srgb_texture_uaddressmode = 2;
uniform int image_srgb_texture_vaddressmode = 2;
uniform int image_srgb_texture_filtertype = 1;
uniform int image_srgb_texture_framerange = 0;
uniform int image_srgb_texture_frameoffset = 0;
uniform int image_srgb_texture_frameendaction = 0;
uniform vec2 image_srgb_texture_uv_scale = vec2(1.000000, 1.000000);
uniform vec2 image_srgb_texture_uv_offset = vec2(0.000000, 0.000000);
uniform float image_srgb_texture_standard_surface6_base = 1.000000;
uniform float image_srgb_texture_standard_surface6_diffuse_roughness = 0.000000;
uniform float image_srgb_texture_standard_surface6_metalness = 0.000000;
uniform float image_srgb_texture_standard_surface6_specular = 1.000000;
uniform vec3 image_srgb_texture_standard_surface6_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_srgb_texture_standard_surface6_specular_roughness = 0.200000;
uniform float image_srgb_texture_standard_surface6_specular_IOR = 1.500000;
uniform float image_srgb_texture_standard_surface6_specular_anisotropy = 0.000000;
uniform float image_srgb_texture_standard_surface6_specular_rotation = 0.000000;
uniform float image_srgb_texture_standard_surface6_transmission = 0.000000;
uniform vec3 image_srgb_texture_standard_surface6_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_srgb_texture_standard_surface6_transmission_depth = 0.000000;
uniform vec3 image_srgb_texture_standard_surface6_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float image_srgb_texture_standard_surface6_transmission_scatter_anisotropy = 0.000000;
uniform float image_srgb_texture_standard_surface6_transmission_dispersion = 0.000000;
uniform float image_srgb_texture_standard_surface6_transmission_extra_roughness = 0.000000;
uniform float image_srgb_texture_standard_surface6_subsurface = 0.000000;
uniform vec3 image_srgb_texture_standard_surface6_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_srgb_texture_standard_surface6_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float image_srgb_texture_standard_surface6_subsurface_scale = 1.000000;
uniform float image_srgb_texture_standard_surface6_subsurface_anisotropy = 0.000000;
uniform float image_srgb_texture_standard_surface6_sheen = 0.000000;
uniform vec3 image_srgb_texture_standard_surface6_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_srgb_texture_standard_surface6_sheen_roughness = 0.300000;
uniform float image_srgb_texture_standard_surface6_coat = 0.000000;
uniform vec3 image_srgb_texture_standard_surface6_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_srgb_texture_standard_surface6_coat_roughness = 0.100000;
uniform float image_srgb_texture_standard_surface6_coat_anisotropy = 0.000000;
uniform float image_srgb_texture_standard_surface6_coat_rotation = 0.000000;
uniform float image_srgb_texture_standard_surface6_coat_IOR = 1.500000;
uniform float image_srgb_texture_standard_surface6_coat_affect_color = 0.000000;
uniform float image_srgb_texture_standard_surface6_coat_affect_roughness = 0.000000;
uniform float image_srgb_texture_standard_surface6_thin_film_thickness = 0.000000;
uniform float image_srgb_texture_standard_surface6_thin_film_IOR = 1.500000;
uniform float image_srgb_texture_standard_surface6_emission = 0.000000;
uniform vec3 image_srgb_texture_standard_surface6_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_srgb_texture_standard_surface6_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool image_srgb_texture_standard_surface6_thin_walled = false;
...
out vec4 image_srgb_texture_out1;
...
void main()
{
    ...
    vec3 image_srgb_texture_out2 = vec3(0.0);
    mx_image_color3(image_srgb_texture_file, image_srgb_texture_layer, image_srgb_texture_default, geomprop_UV0_out1, image_srgb_texture_uaddressmode, image_srgb_texture_vaddressmode, image_srgb_texture_filtertype, image_srgb_texture_framerange, image_srgb_texture_frameoffset, image_srgb_texture_frameendaction, image_srgb_texture_uv_scale, image_srgb_texture_uv_offset, image_srgb_texture_out2);
    vec3 image_srgb_texture_out_cm_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(image_srgb_texture_out2, image_srgb_texture_out_cm_out);
    surfaceshader image_srgb_texture_standard_surface6_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(image_srgb_texture_standard_surface6_base, image_srgb_texture_out_cm_out, image_srgb_texture_standard_surface6_diffuse_roughness, image_srgb_texture_standard_surface6_metalness, image_srgb_texture_standard_surface6_specular, image_srgb_texture_standard_surface6_specular_color, image_srgb_texture_standard_surface6_specular_roughness, image_srgb_texture_standard_surface6_specular_IOR, image_srgb_texture_standard_surface6_specular_anisotropy, image_srgb_texture_standard_surface6_specular_rotation, image_srgb_texture_standard_surface6_transmission, image_srgb_texture_standard_surface6_transmission_color, image_srgb_texture_standard_surface6_transmission_depth, image_srgb_texture_standard_surface6_transmission_scatter, image_srgb_texture_standard_surface6_transmission_scatter_anisotropy, image_srgb_texture_standard_surface6_transmission_dispersion, image_srgb_texture_standard_surface6_transmission_extra_roughness, image_srgb_texture_standard_surface6_subsurface, image_srgb_texture_standard_surface6_subsurface_color, image_srgb_texture_standard_surface6_subsurface_radius, image_srgb_texture_standard_surface6_subsurface_scale, image_srgb_texture_standard_surface6_subsurface_anisotropy, image_srgb_texture_standard_surface6_sheen, image_srgb_texture_standard_surface6_sheen_color, image_srgb_texture_standard_surface6_sheen_roughness, image_srgb_texture_standard_surface6_coat, image_srgb_texture_standard_surface6_coat_color, image_srgb_texture_standard_surface6_coat_roughness, image_srgb_texture_standard_surface6_coat_anisotropy, image_srgb_texture_standard_surface6_coat_rotation, image_srgb_texture_standard_surface6_coat_IOR, geomprop_Nworld_out1, image_srgb_texture_standard_surface6_coat_affect_color, image_srgb_texture_standard_surface6_coat_affect_roughness, image_srgb_texture_standard_surface6_thin_film_thickness, image_srgb_texture_standard_surface6_thin_film_IOR, image_srgb_texture_standard_surface6_emission, image_srgb_texture_standard_surface6_emission_color, image_srgb_texture_standard_surface6_opacity, image_srgb_texture_standard_surface6_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, image_srgb_texture_standard_surface6_out);
    image_srgb_texture_out1 = vec4(image_srgb_texture_standard_surface6_out.color, 1.0);
}
