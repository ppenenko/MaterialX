...
uniform sampler2D image_adobergb_file;
uniform int image_adobergb_layer = 0;
uniform vec3 image_adobergb_default = vec3(0.000000, 0.000000, 0.000000);
uniform int image_adobergb_uaddressmode = 2;
uniform int image_adobergb_vaddressmode = 2;
uniform int image_adobergb_filtertype = 1;
uniform int image_adobergb_framerange = 0;
uniform int image_adobergb_frameoffset = 0;
uniform int image_adobergb_frameendaction = 0;
uniform vec2 image_adobergb_uv_scale = vec2(1.000000, 1.000000);
uniform vec2 image_adobergb_uv_offset = vec2(0.000000, 0.000000);
uniform float image_adobergb_standard_surface7_base = 1.000000;
uniform float image_adobergb_standard_surface7_diffuse_roughness = 0.000000;
uniform float image_adobergb_standard_surface7_metalness = 0.000000;
uniform float image_adobergb_standard_surface7_specular = 1.000000;
uniform vec3 image_adobergb_standard_surface7_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_adobergb_standard_surface7_specular_roughness = 0.200000;
uniform float image_adobergb_standard_surface7_specular_IOR = 1.500000;
uniform float image_adobergb_standard_surface7_specular_anisotropy = 0.000000;
uniform float image_adobergb_standard_surface7_specular_rotation = 0.000000;
uniform float image_adobergb_standard_surface7_transmission = 0.000000;
uniform vec3 image_adobergb_standard_surface7_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_adobergb_standard_surface7_transmission_depth = 0.000000;
uniform vec3 image_adobergb_standard_surface7_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float image_adobergb_standard_surface7_transmission_scatter_anisotropy = 0.000000;
uniform float image_adobergb_standard_surface7_transmission_dispersion = 0.000000;
uniform float image_adobergb_standard_surface7_transmission_extra_roughness = 0.000000;
uniform float image_adobergb_standard_surface7_subsurface = 0.000000;
uniform vec3 image_adobergb_standard_surface7_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_adobergb_standard_surface7_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float image_adobergb_standard_surface7_subsurface_scale = 1.000000;
uniform float image_adobergb_standard_surface7_subsurface_anisotropy = 0.000000;
uniform float image_adobergb_standard_surface7_sheen = 0.000000;
uniform vec3 image_adobergb_standard_surface7_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_adobergb_standard_surface7_sheen_roughness = 0.300000;
uniform float image_adobergb_standard_surface7_coat = 0.000000;
uniform vec3 image_adobergb_standard_surface7_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_adobergb_standard_surface7_coat_roughness = 0.100000;
uniform float image_adobergb_standard_surface7_coat_anisotropy = 0.000000;
uniform float image_adobergb_standard_surface7_coat_rotation = 0.000000;
uniform float image_adobergb_standard_surface7_coat_IOR = 1.500000;
uniform float image_adobergb_standard_surface7_coat_affect_color = 0.000000;
uniform float image_adobergb_standard_surface7_coat_affect_roughness = 0.000000;
uniform float image_adobergb_standard_surface7_thin_film_thickness = 0.000000;
uniform float image_adobergb_standard_surface7_thin_film_IOR = 1.500000;
uniform float image_adobergb_standard_surface7_emission = 0.000000;
uniform vec3 image_adobergb_standard_surface7_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_adobergb_standard_surface7_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool image_adobergb_standard_surface7_thin_walled = false;
...
void main()
{
    ...
    vec3 image_adobergb_out2 = vec3(0.0);
    mx_image_color3(image_adobergb_file, image_adobergb_layer, image_adobergb_default, geomprop_UV0_out1, image_adobergb_uaddressmode, image_adobergb_vaddressmode, image_adobergb_filtertype, image_adobergb_framerange, image_adobergb_frameoffset, image_adobergb_frameendaction, image_adobergb_uv_scale, image_adobergb_uv_offset, image_adobergb_out2);
    vec3 image_adobergb_out_cm_out = vec3(0.0);
    NG_adobergb_to_lin_rec709_color3(image_adobergb_out2, image_adobergb_out_cm_out);
    surfaceshader image_adobergb_standard_surface7_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(image_adobergb_standard_surface7_base, image_adobergb_out_cm_out, image_adobergb_standard_surface7_diffuse_roughness, image_adobergb_standard_surface7_metalness, image_adobergb_standard_surface7_specular, image_adobergb_standard_surface7_specular_color, image_adobergb_standard_surface7_specular_roughness, image_adobergb_standard_surface7_specular_IOR, image_adobergb_standard_surface7_specular_anisotropy, image_adobergb_standard_surface7_specular_rotation, image_adobergb_standard_surface7_transmission, image_adobergb_standard_surface7_transmission_color, image_adobergb_standard_surface7_transmission_depth, image_adobergb_standard_surface7_transmission_scatter, image_adobergb_standard_surface7_transmission_scatter_anisotropy, image_adobergb_standard_surface7_transmission_dispersion, image_adobergb_standard_surface7_transmission_extra_roughness, image_adobergb_standard_surface7_subsurface, image_adobergb_standard_surface7_subsurface_color, image_adobergb_standard_surface7_subsurface_radius, image_adobergb_standard_surface7_subsurface_scale, image_adobergb_standard_surface7_subsurface_anisotropy, image_adobergb_standard_surface7_sheen, image_adobergb_standard_surface7_sheen_color, image_adobergb_standard_surface7_sheen_roughness, image_adobergb_standard_surface7_coat, image_adobergb_standard_surface7_coat_color, image_adobergb_standard_surface7_coat_roughness, image_adobergb_standard_surface7_coat_anisotropy, image_adobergb_standard_surface7_coat_rotation, image_adobergb_standard_surface7_coat_IOR, geomprop_Nworld_out1, image_adobergb_standard_surface7_coat_affect_color, image_adobergb_standard_surface7_coat_affect_roughness, image_adobergb_standard_surface7_thin_film_thickness, image_adobergb_standard_surface7_thin_film_IOR, image_adobergb_standard_surface7_emission, image_adobergb_standard_surface7_emission_color, image_adobergb_standard_surface7_opacity, image_adobergb_standard_surface7_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, image_adobergb_standard_surface7_out);
    image_adobergb_out1 = vec4(image_adobergb_standard_surface7_out.color, 1.0);
}
