...
uniform sampler2D image_gamma18_file;
uniform int image_gamma18_layer = 0;
uniform vec3 image_gamma18_default = vec3(0.000000, 0.000000, 0.000000);
uniform int image_gamma18_uaddressmode = 2;
uniform int image_gamma18_vaddressmode = 2;
uniform int image_gamma18_filtertype = 1;
uniform int image_gamma18_framerange = 0;
uniform int image_gamma18_frameoffset = 0;
uniform int image_gamma18_frameendaction = 0;
uniform vec2 image_gamma18_uv_scale = vec2(1.000000, 1.000000);
uniform vec2 image_gamma18_uv_offset = vec2(0.000000, 0.000000);
uniform float image_gamma18_standard_surface2_base = 1.000000;
uniform float image_gamma18_standard_surface2_diffuse_roughness = 0.000000;
uniform float image_gamma18_standard_surface2_metalness = 0.000000;
uniform float image_gamma18_standard_surface2_specular = 1.000000;
uniform vec3 image_gamma18_standard_surface2_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_gamma18_standard_surface2_specular_roughness = 0.200000;
uniform float image_gamma18_standard_surface2_specular_IOR = 1.500000;
uniform float image_gamma18_standard_surface2_specular_anisotropy = 0.000000;
uniform float image_gamma18_standard_surface2_specular_rotation = 0.000000;
uniform float image_gamma18_standard_surface2_transmission = 0.000000;
uniform vec3 image_gamma18_standard_surface2_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_gamma18_standard_surface2_transmission_depth = 0.000000;
uniform vec3 image_gamma18_standard_surface2_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float image_gamma18_standard_surface2_transmission_scatter_anisotropy = 0.000000;
uniform float image_gamma18_standard_surface2_transmission_dispersion = 0.000000;
uniform float image_gamma18_standard_surface2_transmission_extra_roughness = 0.000000;
uniform float image_gamma18_standard_surface2_subsurface = 0.000000;
uniform vec3 image_gamma18_standard_surface2_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_gamma18_standard_surface2_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float image_gamma18_standard_surface2_subsurface_scale = 1.000000;
uniform float image_gamma18_standard_surface2_subsurface_anisotropy = 0.000000;
uniform float image_gamma18_standard_surface2_sheen = 0.000000;
uniform vec3 image_gamma18_standard_surface2_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_gamma18_standard_surface2_sheen_roughness = 0.300000;
uniform float image_gamma18_standard_surface2_coat = 0.000000;
uniform vec3 image_gamma18_standard_surface2_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_gamma18_standard_surface2_coat_roughness = 0.100000;
uniform float image_gamma18_standard_surface2_coat_anisotropy = 0.000000;
uniform float image_gamma18_standard_surface2_coat_rotation = 0.000000;
uniform float image_gamma18_standard_surface2_coat_IOR = 1.500000;
uniform float image_gamma18_standard_surface2_coat_affect_color = 0.000000;
uniform float image_gamma18_standard_surface2_coat_affect_roughness = 0.000000;
uniform float image_gamma18_standard_surface2_thin_film_thickness = 0.000000;
uniform float image_gamma18_standard_surface2_thin_film_IOR = 1.500000;
uniform float image_gamma18_standard_surface2_emission = 0.000000;
uniform vec3 image_gamma18_standard_surface2_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_gamma18_standard_surface2_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool image_gamma18_standard_surface2_thin_walled = false;
...
void main()
{
    ...
    vec3 image_gamma18_out2 = vec3(0.0);
    mx_image_color3(image_gamma18_file, image_gamma18_layer, image_gamma18_default, geomprop_UV0_out1, image_gamma18_uaddressmode, image_gamma18_vaddressmode, image_gamma18_filtertype, image_gamma18_framerange, image_gamma18_frameoffset, image_gamma18_frameendaction, image_gamma18_uv_scale, image_gamma18_uv_offset, image_gamma18_out2);
    vec3 image_gamma18_out_cm_out = vec3(0.0);
    NG_g18_rec709_to_lin_rec709_color3(image_gamma18_out2, image_gamma18_out_cm_out);
    surfaceshader image_gamma18_standard_surface2_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    image_gamma18_out1 = vec4(image_gamma18_standard_surface2_out.color, 1.0);
}
