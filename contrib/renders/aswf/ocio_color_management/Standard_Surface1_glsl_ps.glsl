...
uniform vec3 switch3_in1_cm_in = vec3(0.398300, 0.329900, 0.276500);
uniform vec3 switch3_in2_cm_in = vec3(0.690300, 0.599300, 0.523600);
uniform vec3 switch3_in3_cm_in = vec3(0.427200, 0.473700, 0.595900);
uniform vec3 switch3_in4_cm_in = vec3(0.365400, 0.415600, 0.282000);
uniform vec3 switch3_in5_cm_in = vec3(0.523100, 0.505900, 0.669500);
uniform vec3 switch3_in6_cm_in = vec3(0.530900, 0.716500, 0.669400);
uniform vec3 switch3_in7_cm_in = vec3(0.690500, 0.514000, 0.221500);
uniform vec3 switch3_in8_cm_in = vec3(0.344400, 0.357800, 0.611800);
uniform vec3 switch3_in9_cm_in = vec3(0.602300, 0.381800, 0.392000);
uniform vec3 switch3_in10_cm_in = vec3(0.326000, 0.247200, 0.401800);
...
uniform vec3 switch2_in1 = vec3(0.368700, 0.327900, 0.276000);
uniform vec3 switch2_in2 = vec3(0.650200, 0.596100, 0.523000);
uniform vec3 switch2_in3 = vec3(0.461400, 0.483300, 0.596300);
uniform vec3 switch2_in4 = vec3(0.358800, 0.400600, 0.282100);
uniform vec3 switch2_in5 = vec3(0.544700, 0.522300, 0.669700);
uniform vec3 switch2_in6 = vec3(0.579700, 0.703700, 0.670400);
uniform vec3 switch2_in7 = vec3(0.588800, 0.494000, 0.220100);
uniform vec3 switch2_in8 = vec3(0.390100, 0.381500, 0.612300);
uniform vec3 switch2_in9 = vec3(0.536800, 0.392600, 0.390800);
uniform vec3 switch2_in10 = vec3(0.327300, 0.265500, 0.401600);
uniform vec3 switch4_in1 = vec3(0.451000, 0.321600, 0.266700);
uniform vec3 switch4_in2 = vec3(0.760800, 0.588200, 0.509800);
uniform vec3 switch4_in3 = vec3(0.384300, 0.478400, 0.615700);
uniform vec3 switch4_in4 = vec3(0.341200, 0.423500, 0.262700);
uniform vec3 switch4_in5 = vec3(0.521600, 0.502000, 0.694100);
uniform vec3 switch4_in6 = vec3(0.403900, 0.741200, 0.666700);
uniform vec3 switch4_in7 = vec3(0.839200, 0.494100, 0.172500);
uniform vec3 switch4_in8 = vec3(0.313700, 0.356900, 0.651000);
uniform vec3 switch4_in9 = vec3(0.756900, 0.352900, 0.388200);
uniform vec3 switch4_in10 = vec3(0.368600, 0.235300, 0.423500);
uniform vec3 switch5_in1 = vec3(0.702100, 0.602600, 0.553200);
uniform vec3 switch5_in2 = vec3(0.886400, 0.790700, 0.741800);
uniform vec3 switch5_in3 = vec3(0.653300, 0.721000, 0.807000);
uniform vec3 switch5_in4 = vec3(0.619000, 0.682500, 0.549500);
uniform vec3 switch5_in5 = vec3(0.749400, 0.736600, 0.851100);
uniform vec3 switch5_in6 = vec3(0.668100, 0.876200, 0.836000);
uniform vec3 switch5_in7 = vec3(0.925700, 0.731500, 0.452300);
uniform vec3 switch5_in8 = vec3(0.595900, 0.631700, 0.827200);
uniform vec3 switch5_in9 = vec3(0.884400, 0.628600, 0.656300);
uniform vec3 switch5_in10 = vec3(0.641100, 0.522300, 0.682500);
uniform vec3 switch6_in1 = vec3(0.685800, 0.606200, 0.560000);
uniform vec3 switch6_in2 = vec3(0.870400, 0.794200, 0.748200);
uniform vec3 switch6_in3 = vec3(0.666000, 0.718800, 0.798800);
uniform vec3 switch6_in4 = vec3(0.630900, 0.680600, 0.561800);
uniform vec3 switch6_in5 = vec3(0.747100, 0.737100, 0.841900);
uniform vec3 switch6_in6 = vec3(0.711000, 0.870300, 0.836500);
uniform vec3 switch6_in7 = vec3(0.895200, 0.739000, 0.492600);
uniform vec3 switch6_in8 = vec3(0.602400, 0.630600, 0.811700);
uniform vec3 switch6_in9 = vec3(0.846200, 0.639300, 0.659100);
uniform vec3 switch6_in10 = vec3(0.622100, 0.526800, 0.671900);
uniform vec3 switch7_in1 = vec3(0.349100, 0.345100, 0.300500);
uniform vec3 switch7_in2 = vec3(0.616100, 0.619300, 0.569400);
uniform vec3 switch7_in3 = vec3(0.440700, 0.468300, 0.649700);
uniform vec3 switch7_in4 = vec3(0.339600, 0.394400, 0.306800);
uniform vec3 switch7_in5 = vec3(0.519900, 0.520000, 0.729700);
uniform vec3 switch7_in6 = vec3(0.551900, 0.664100, 0.729800);
uniform vec3 switch7_in7 = vec3(0.553900, 0.544300, 0.239100);
uniform vec3 switch7_in8 = vec3(0.374500, 0.368900, 0.667400);
uniform vec3 switch7_in9 = vec3(0.508400, 0.441400, 0.425700);
uniform vec3 switch7_in10 = vec3(0.312600, 0.277200, 0.437800);
uniform vec3 switch8_in1 = vec3(0.428000, 0.325900, 0.273800);
uniform vec3 switch8_in2 = vec3(0.730200, 0.594000, 0.519800);
uniform vec3 switch8_in3 = vec3(0.401000, 0.475300, 0.601800);
uniform vec3 switch8_in4 = vec3(0.355800, 0.420800, 0.275700);
uniform vec3 switch8_in5 = vec3(0.518100, 0.502600, 0.677300);
uniform vec3 switch8_in6 = vec3(0.463800, 0.730000, 0.667600);
uniform vec3 switch8_in7 = vec3(0.777900, 0.505600, 0.207200);
uniform vec3 switch8_in8 = vec3(0.321400, 0.355400, 0.623900);
uniform vec3 switch8_in9 = vec3(0.685200, 0.366300, 0.392000);
uniform vec3 switch8_in10 = vec3(0.345000, 0.239700, 0.409000);
uniform vec3 switch9_in1 = vec3(0.400400, 0.329900, 0.274500);
uniform vec3 switch9_in2 = vec3(0.693100, 0.599300, 0.520800);
uniform vec3 switch9_in3 = vec3(0.425300, 0.473500, 0.599800);
uniform vec3 switch9_in4 = vec3(0.364900, 0.416000, 0.278200);
uniform vec3 switch9_in5 = vec3(0.522600, 0.505500, 0.674400);
uniform vec3 switch9_in6 = vec3(0.526400, 0.717000, 0.668900);
uniform vec3 switch9_in7 = vec3(0.696700, 0.514300, 0.211800);
uniform vec3 switch9_in8 = vec3(0.342500, 0.357200, 0.619600);
uniform vec3 switch9_in9 = vec3(0.607900, 0.381300, 0.391200);
uniform vec3 switch9_in10 = vec3(0.327100, 0.246600, 0.406100);
uniform vec3 switch10_in1 = vec3(0.669700, 0.597000, 0.550400);
uniform vec3 switch10_in2 = vec3(0.856700, 0.785600, 0.738200);
uniform vec3 switch10_in3 = vec3(0.667500, 0.715200, 0.798700);
uniform vec3 switch10_in4 = vec3(0.632100, 0.676600, 0.550800);
uniform vec3 switch10_in5 = vec3(0.740200, 0.731000, 0.842600);
uniform vec3 switch10_in6 = vec3(0.729700, 0.872700, 0.833400);
uniform vec3 switch10_in7 = vec3(0.872500, 0.725700, 0.465200);
uniform vec3 switch10_in8 = vec3(0.600700, 0.625900, 0.815700);
uniform vec3 switch10_in9 = vec3(0.817400, 0.622800, 0.649300);
uniform vec3 switch10_in10 = vec3(0.604600, 0.517900, 0.671000);
uniform vec3 switch11_in1 = vec3(0.717600, 0.623300, 0.576500);
uniform vec3 switch11_in2 = vec3(0.892300, 0.801600, 0.755200);
uniform vec3 switch11_in3 = vec3(0.671400, 0.735500, 0.817000);
uniform vec3 switch11_in4 = vec3(0.638900, 0.699100, 0.573000);
uniform vec3 switch11_in5 = vec3(0.762400, 0.750400, 0.858900);
uniform vec3 switch11_in6 = vec3(0.685400, 0.882700, 0.844600);
uniform vec3 switch11_in7 = vec3(0.929600, 0.745500, 0.480900);
uniform vec3 switch11_in8 = vec3(0.616900, 0.650900, 0.836200);
uniform vec3 switch11_in9 = vec3(0.890400, 0.648000, 0.674200);
uniform vec3 switch11_in10 = vec3(0.659800, 0.547200, 0.699100);
...
void main()
{
    ...
    NG_acescg_to_lin_rec709_color3(switch3_in1_cm_in, switch3_in1_cm_out);
    vec3 switch3_in2_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch3_in2_cm_in, switch3_in2_cm_out);
    vec3 switch3_in3_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch3_in3_cm_in, switch3_in3_cm_out);
    vec3 switch3_in4_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch3_in4_cm_in, switch3_in4_cm_out);
    vec3 switch3_in5_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch3_in5_cm_in, switch3_in5_cm_out);
    vec3 switch3_in6_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch3_in6_cm_in, switch3_in6_cm_out);
    vec3 switch3_in7_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch3_in7_cm_in, switch3_in7_cm_out);
    vec3 switch3_in8_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch3_in8_cm_in, switch3_in8_cm_out);
    vec3 switch3_in9_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch3_in9_cm_in, switch3_in9_cm_out);
    vec3 switch3_in10_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch3_in10_cm_in, switch3_in10_cm_out);
    ...
    NG_switch_color3(switch2_in1, switch2_in2, switch2_in3, switch2_in4, switch2_in5, switch2_in6, switch2_in7, switch2_in8, switch2_in9, switch2_in10, multiply3_out, switch2_out);
    ...
    NG_switch_color3(switch4_in1, switch4_in2, switch4_in3, switch4_in4, switch4_in5, switch4_in6, switch4_in7, switch4_in8, switch4_in9, switch4_in10, multiply3_out, switch4_out);
    vec3 switch5_out = vec3(0.0);
    NG_switch_color3(switch5_in1, switch5_in2, switch5_in3, switch5_in4, switch5_in5, switch5_in6, switch5_in7, switch5_in8, switch5_in9, switch5_in10, multiply3_out, switch5_out);
    vec3 switch6_out = vec3(0.0);
    NG_switch_color3(switch6_in1, switch6_in2, switch6_in3, switch6_in4, switch6_in5, switch6_in6, switch6_in7, switch6_in8, switch6_in9, switch6_in10, multiply3_out, switch6_out);
    vec3 switch7_out = vec3(0.0);
    NG_switch_color3(switch7_in1, switch7_in2, switch7_in3, switch7_in4, switch7_in5, switch7_in6, switch7_in7, switch7_in8, switch7_in9, switch7_in10, multiply3_out, switch7_out);
    vec3 switch8_out = vec3(0.0);
    NG_switch_color3(switch8_in1, switch8_in2, switch8_in3, switch8_in4, switch8_in5, switch8_in6, switch8_in7, switch8_in8, switch8_in9, switch8_in10, multiply3_out, switch8_out);
    vec3 switch9_out = vec3(0.0);
    NG_switch_color3(switch9_in1, switch9_in2, switch9_in3, switch9_in4, switch9_in5, switch9_in6, switch9_in7, switch9_in8, switch9_in9, switch9_in10, multiply3_out, switch9_out);
    vec3 switch10_out = vec3(0.0);
    NG_switch_color3(switch10_in1, switch10_in2, switch10_in3, switch10_in4, switch10_in5, switch10_in6, switch10_in7, switch10_in8, switch10_in9, switch10_in10, multiply3_out, switch10_out);
    vec3 switch11_out = vec3(0.0);
    NG_switch_color3(switch11_in1, switch11_in2, switch11_in3, switch11_in4, switch11_in5, switch11_in6, switch11_in7, switch11_in8, switch11_in9, switch11_in10, multiply3_out, switch11_out);
