...
void NG_blur_vector3(vec3 in1, float size, int filtertype, out vec3 out1)
{
    out1 = in1;
}
...
void main()
{
    ...
    vec3 blur_vector3_out = vec3(0.0);
    NG_blur_vector3(tiledimage1_out, blur_vector3_size, blur_vector3_filtertype, blur_vector3_out);
    out11 = vec4(blur_vector3_out, 1.0);
}
