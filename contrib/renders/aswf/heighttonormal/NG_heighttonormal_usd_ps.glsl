...
void IMP_UsdPreviewSurface_surfaceshader(vec3 diffuseColor, vec3 emissiveColor, int useSpecularWorkflow, vec3 specularColor, float metallic, float roughness, float clearcoat, float clearcoatRoughness, float opacity, int opacityMode, float opacityThreshold, float ior, vec3 normal, float displacement, float occlusion, out surfaceshader out1)
{
    ...
    surfaceshader surface_constructor_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            mx_generalized_schlick_bsdf(closureData, clearcoat, coat_F0_out, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 5.000000, coat_roughness_out, false, 0.000000, 1.500000, surface_normal_out, geomprop_Tworld_out1, 0, 0, coat_dielectric_bsdf_out);
            BSDF specular_bsdf1_out = BSDF(vec3(0.0),vec3(1.0));
            mx_generalized_schlick_bsdf(closureData, 1.000000, specularColor, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 5.000000, specular_roughness_out, false, 0.000000, 1.500000, surface_normal_out, geomprop_Tworld_out1, 0, 0, specular_bsdf1_out);
            ...
            mx_generalized_schlick_bsdf(closureData, 1.000000, F0_out, vec3(1.000000, 1.000000, 1.000000), specular_color_metallic_out, 5.000000, specular_roughness_out, false, 0.000000, 1.500000, surface_normal_out, geomprop_Tworld_out1, 0, 0, specular_bsdf2_out);
