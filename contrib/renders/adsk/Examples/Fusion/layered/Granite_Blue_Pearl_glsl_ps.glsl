...
uniform vec2 surfacealbedo_texturemap_realworld_offset_unit_in1 = vec2(0.000000, 0.000000);
uniform float surfacealbedo_texturemap_realworld_offset_unit_in2 = 2.540000;
uniform vec2 surfacealbedo_texturemap_realworld_scale_unit_in1 = vec2(12.000000, 12.000000);
uniform float surfacealbedo_texturemap_realworld_scale_unit_in2 = 2.540000;
uniform vec2 surfaceroughness_texturemap_realworld_offset_unit_in1 = vec2(0.000000, 0.000000);
uniform float surfaceroughness_texturemap_realworld_offset_unit_in2 = 2.540000;
uniform vec2 surfaceroughness_texturemap_realworld_scale_unit_in1 = vec2(12.000000, 12.000000);
uniform float surfaceroughness_texturemap_realworld_scale_unit_in2 = 2.540000;
uniform vec2 layereddiffuse_texturemap_realworld_offset_unit_in1 = vec2(0.000000, 0.000000);
uniform float layereddiffuse_texturemap_realworld_offset_unit_in2 = 2.540000;
uniform vec2 layereddiffuse_texturemap_realworld_scale_unit_in1 = vec2(12.000000, 12.000000);
uniform float layereddiffuse_texturemap_realworld_scale_unit_in2 = 2.540000;
uniform vec2 layeredfraction_texturemap_realworld_offset_unit_in1 = vec2(0.000000, 0.000000);
uniform float layeredfraction_texturemap_realworld_offset_unit_in2 = 2.540000;
uniform vec2 layeredfraction_texturemap_realworld_scale_unit_in1 = vec2(12.000000, 12.000000);
uniform float layeredfraction_texturemap_realworld_scale_unit_in2 = 2.540000;
uniform vec2 layerednormal_texturemap_realworld_offset_unit_in1 = vec2(0.000000, 0.000000);
uniform float layerednormal_texturemap_realworld_offset_unit_in2 = 2.540000;
uniform vec2 layerednormal_texturemap_realworld_scale_unit_in1 = vec2(12.000000, 12.000000);
uniform float layerednormal_texturemap_realworld_scale_unit_in2 = 2.540000;
uniform sampler2D surfacealbedo_texturemap_file;
uniform vec2 surfacealbedo_texturemap_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 surfacealbedo_texturemap_uv_scale = vec2(1.000000, 1.000000);
uniform float surfacealbedo_texturemap_rotation_angle = 0.000000;
uniform float surfacealbedo_texturemap_rgbamount = 1.000000;
uniform bool surfacealbedo_texturemap_invert = false;
uniform int surfacealbedo_texturemap_uaddressmode = 2;
uniform int surfacealbedo_texturemap_vaddressmode = 2;
uniform sampler2D surfaceroughness_texturemap_file;
uniform vec2 surfaceroughness_texturemap_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 surfaceroughness_texturemap_uv_scale = vec2(1.000000, 1.000000);
uniform float surfaceroughness_texturemap_rotation_angle = 0.000000;
uniform float surfaceroughness_texturemap_rgbamount = 1.000000;
uniform bool surfaceroughness_texturemap_invert = false;
uniform int surfaceroughness_texturemap_uaddressmode = 2;
uniform int surfaceroughness_texturemap_vaddressmode = 2;
uniform sampler2D layereddiffuse_texturemap_file;
uniform vec2 layereddiffuse_texturemap_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 layereddiffuse_texturemap_uv_scale = vec2(1.000000, 1.000000);
uniform float layereddiffuse_texturemap_rotation_angle = 0.000000;
uniform float layereddiffuse_texturemap_rgbamount = 1.000000;
uniform bool layereddiffuse_texturemap_invert = false;
uniform int layereddiffuse_texturemap_uaddressmode = 2;
uniform int layereddiffuse_texturemap_vaddressmode = 2;
uniform sampler2D layeredfraction_texturemap_file;
uniform vec2 layeredfraction_texturemap_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 layeredfraction_texturemap_uv_scale = vec2(1.000000, 1.000000);
uniform float layeredfraction_texturemap_rotation_angle = 0.000000;
uniform float layeredfraction_texturemap_rgbamount = 1.000000;
uniform bool layeredfraction_texturemap_invert = false;
uniform int layeredfraction_texturemap_uaddressmode = 2;
uniform int layeredfraction_texturemap_vaddressmode = 2;
uniform sampler2D layerednormal_texturemap_file;
uniform vec2 layerednormal_texturemap_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 layerednormal_texturemap_uv_scale = vec2(1.000000, 1.000000);
uniform float layerednormal_texturemap_rotation_angle = 0.000000;
uniform float layerednormal_texturemap_normal_scale = 0.750000;
uniform int layerednormal_texturemap_uaddressmode = 2;
uniform int layerednormal_texturemap_vaddressmode = 2;
uniform vec3 archviz_layered3_surface_cutout = vec3(1.000000, 1.000000, 1.000000);
uniform float archviz_layered3_surface_anisotropy = 0.000000;
uniform float archviz_layered3_surface_rotation = 0.000000;
uniform float archviz_layered3_layered_f0 = 0.045000;
uniform float archviz_layered3_layered_roughness = 0.120000;
uniform float archviz_layered3_layered_anisotropy = 0.000000;
uniform float archviz_layered3_layered_rotation = 0.000000;
uniform bool archviz_layered3_layered_fraction_invert = false;
uniform vec3 archviz_layered3_layered_bottom_f0 = vec3(1.000000, 1.000000, 1.000000);
...
void adsk_NG_adsk_bitmap_float(sampler2D file, vec2 realworld_offset, vec2 realworld_scale, vec2 uv_offset, vec2 uv_scale, float rotation_angle, float rgbamount, bool invert, int uaddressmode, int vaddressmode, vec2 texcoord, out float out1)
{
    vec2 total_offset_out = realworld_offset + uv_offset;
    vec2 total_scale_out = realworld_scale / uv_scale;
    const float rotation_angle_param_in2_tmp = -1.000000;
    ...
    const bool image_convert_value2_tmp = true;
    vec3 image_convert_out = (invert == image_convert_value2_tmp) ? image_invert_out : image_brightness_out;
    const int extract1_index_tmp = 0;
    float extract1_out = image_convert_out[extract1_index_tmp];
    out1 = extract1_out;
}
...
void adsk_NG_adsk_layered(vec3 surface_normal, vec3 surface_cutout, vec3 surface_albedo, float surface_roughness, float surface_anisotropy, float surface_rotation, vec3 layered_normal, float layered_f0, float layered_roughness, float layered_anisotropy, float layered_rotation, float layered_fraction, bool layered_fraction_invert, vec3 layered_diffuse, vec3 layered_bottom_f0, out surfaceshader out1)
{
    vec3 lfract_x_lbottomf0_out = layered_bottom_f0 * layered_fraction;
    const float oneminus_layerfraction_in1_tmp = 1.000000;
    float oneminus_layerfraction_out = oneminus_layerfraction_in1_tmp - layered_fraction;
    const float oneminus_layeraniso0_in1_tmp = 1.000000;
    float oneminus_layeraniso0_out = oneminus_layeraniso0_in1_tmp - layered_anisotropy;
    const float twotimes_layeraniso0_in1_tmp = 2.000000;
    float twotimes_layeraniso0_out = twotimes_layeraniso0_in1_tmp * layered_anisotropy;
    float pow2_layeraniso0_out = layered_anisotropy * layered_anisotropy;
    const float div_rotation1_in2_tmp = 360.000000;
    float div_rotation1_out = layered_rotation / div_rotation1_in2_tmp;
    vec3 coat_value_color3_out = vec3(0.0);
    mx_luminance_color3(surface_albedo, vec3(0.272229, 0.674082, 0.053689), coat_value_color3_out);
    const float oneminus_surfaniso0_in1_tmp = 1.000000;
    float oneminus_surfaniso0_out = oneminus_surfaniso0_in1_tmp - surface_anisotropy;
    const float twotimes_surfaniso0_in1_tmp = 2.000000;
    float twotimes_surfaniso0_out = twotimes_surfaniso0_in1_tmp * surface_anisotropy;
    float pow2_surfaniso0_out = surface_anisotropy * surface_anisotropy;
    const float div_rotation0_in2_tmp = 360.000000;
    float div_rotation0_out = surface_rotation / div_rotation0_in2_tmp;
    float sqrt_layeredf0_out = sqrt(layered_f0);
    vec3 geomprop_Tworld_out1 = normalize(vd.tangentWorld);
    const bool layered_fraction_value_value2_tmp = true;
    float layered_fraction_value_out = (layered_fraction_invert == layered_fraction_value_value2_tmp) ? oneminus_layerfraction_out : layered_fraction;
    vec3 oneminuslf_x_layerdiffuse_out = layered_diffuse * oneminus_layerfraction_out;
    float sqrt1minus_layeraniso0_out = sqrt(oneminus_layeraniso0_out);
    float specular_anisotropy_value_out = twotimes_layeraniso0_out - pow2_layeraniso0_out;
    const float specular_rotation_value_in2_tmp = 1.000000;
    float specular_rotation_value_out = mx_mod(div_rotation1_out, specular_rotation_value_in2_tmp);
    const int coat_value_index_tmp = 0;
    float coat_value_out = coat_value_color3_out[coat_value_index_tmp];
    float sqrt1minus_surfaniso0_out = sqrt(oneminus_surfaniso0_out);
    float coat_anisotropy_value_out = twotimes_surfaniso0_out - pow2_surfaniso0_out;
    const float coat_rotation_value_in2_tmp = 1.000000;
    float coat_rotation_value_out = mx_mod(div_rotation0_out, coat_rotation_value_in2_tmp);
    const float oneplus_sqrtlayeredf0_in1_tmp = 1.000000;
    float oneplus_sqrtlayeredf0_out = oneplus_sqrtlayeredf0_in1_tmp + sqrt_layeredf0_out;
    const float oneminus_sqrtlayeredf0_in1_tmp = 1.000000;
    float oneminus_sqrtlayeredf0_out = oneminus_sqrtlayeredf0_in1_tmp - sqrt_layeredf0_out;
    vec3 base_color_value_out = lfract_x_lbottomf0_out + oneminuslf_x_layerdiffuse_out;
    float specular_roughness_value_out = sqrt1minus_layeraniso0_out * layered_roughness;
    float coat_roughness_value_out = sqrt1minus_surfaniso0_out * surface_roughness;
    float coat_IOR_value_out = oneplus_sqrtlayeredf0_out / oneminus_sqrtlayeredf0_out;
    surfaceshader standard_surface0_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(1.000000, base_color_value_out, 0.000000, layered_fraction_value_out, 0.000000, vec3(1.000000, 1.000000, 1.000000), specular_roughness_value_out, 1.500000, specular_anisotropy_value_out, specular_rotation_value_out, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.000000, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 1.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, coat_value_out, vec3(1.000000, 1.000000, 1.000000), coat_roughness_value_out, coat_anisotropy_value_out, coat_rotation_value_out, coat_IOR_value_out, surface_normal, 0.000000, 0.000000, 0.000000, 1.500000, 0.000000, vec3(1.000000, 1.000000, 1.000000), surface_cutout, false, layered_normal, geomprop_Tworld_out1, standard_surface0_out);
    out1 = standard_surface0_out;
}
...
void main()
{
    ...
    vec3 geomprop_Tworld_out1 = normalize(vd.tangentWorld);
    vec2 surfacealbedo_texturemap_realworld_offset_unit_out = surfacealbedo_texturemap_realworld_offset_unit_in1 * surfacealbedo_texturemap_realworld_offset_unit_in2;
    vec2 surfacealbedo_texturemap_realworld_scale_unit_out = surfacealbedo_texturemap_realworld_scale_unit_in1 * surfacealbedo_texturemap_realworld_scale_unit_in2;
    vec2 surfaceroughness_texturemap_realworld_offset_unit_out = surfaceroughness_texturemap_realworld_offset_unit_in1 * surfaceroughness_texturemap_realworld_offset_unit_in2;
    vec2 surfaceroughness_texturemap_realworld_scale_unit_out = surfaceroughness_texturemap_realworld_scale_unit_in1 * surfaceroughness_texturemap_realworld_scale_unit_in2;
    vec2 layereddiffuse_texturemap_realworld_offset_unit_out = layereddiffuse_texturemap_realworld_offset_unit_in1 * layereddiffuse_texturemap_realworld_offset_unit_in2;
    vec2 layereddiffuse_texturemap_realworld_scale_unit_out = layereddiffuse_texturemap_realworld_scale_unit_in1 * layereddiffuse_texturemap_realworld_scale_unit_in2;
    vec2 layeredfraction_texturemap_realworld_offset_unit_out = layeredfraction_texturemap_realworld_offset_unit_in1 * layeredfraction_texturemap_realworld_offset_unit_in2;
    vec2 layeredfraction_texturemap_realworld_scale_unit_out = layeredfraction_texturemap_realworld_scale_unit_in1 * layeredfraction_texturemap_realworld_scale_unit_in2;
    vec2 layerednormal_texturemap_realworld_offset_unit_out = layerednormal_texturemap_realworld_offset_unit_in1 * layerednormal_texturemap_realworld_offset_unit_in2;
    vec2 layerednormal_texturemap_realworld_scale_unit_out = layerednormal_texturemap_realworld_scale_unit_in1 * layerednormal_texturemap_realworld_scale_unit_in2;
    vec3 surfacealbedo_texturemap_out = vec3(0.0);
    adsk_NG_adsk_bitmap_color3(surfacealbedo_texturemap_file, surfacealbedo_texturemap_realworld_offset_unit_out, surfacealbedo_texturemap_realworld_scale_unit_out, surfacealbedo_texturemap_uv_offset, surfacealbedo_texturemap_uv_scale, surfacealbedo_texturemap_rotation_angle, surfacealbedo_texturemap_rgbamount, surfacealbedo_texturemap_invert, surfacealbedo_texturemap_uaddressmode, surfacealbedo_texturemap_vaddressmode, geomprop_UV0_out1, surfacealbedo_texturemap_out);
    float surfaceroughness_texturemap_out = 0.0;
    adsk_NG_adsk_bitmap_float(surfaceroughness_texturemap_file, surfaceroughness_texturemap_realworld_offset_unit_out, surfaceroughness_texturemap_realworld_scale_unit_out, surfaceroughness_texturemap_uv_offset, surfaceroughness_texturemap_uv_scale, surfaceroughness_texturemap_rotation_angle, surfaceroughness_texturemap_rgbamount, surfaceroughness_texturemap_invert, surfaceroughness_texturemap_uaddressmode, surfaceroughness_texturemap_vaddressmode, geomprop_UV0_out1, surfaceroughness_texturemap_out);
    vec3 layereddiffuse_texturemap_out = vec3(0.0);
    adsk_NG_adsk_bitmap_color3(layereddiffuse_texturemap_file, layereddiffuse_texturemap_realworld_offset_unit_out, layereddiffuse_texturemap_realworld_scale_unit_out, layereddiffuse_texturemap_uv_offset, layereddiffuse_texturemap_uv_scale, layereddiffuse_texturemap_rotation_angle, layereddiffuse_texturemap_rgbamount, layereddiffuse_texturemap_invert, layereddiffuse_texturemap_uaddressmode, layereddiffuse_texturemap_vaddressmode, geomprop_UV0_out1, layereddiffuse_texturemap_out);
    float layeredfraction_texturemap_out = 0.0;
    adsk_NG_adsk_bitmap_float(layeredfraction_texturemap_file, layeredfraction_texturemap_realworld_offset_unit_out, layeredfraction_texturemap_realworld_scale_unit_out, layeredfraction_texturemap_uv_offset, layeredfraction_texturemap_uv_scale, layeredfraction_texturemap_rotation_angle, layeredfraction_texturemap_rgbamount, layeredfraction_texturemap_invert, layeredfraction_texturemap_uaddressmode, layeredfraction_texturemap_vaddressmode, geomprop_UV0_out1, layeredfraction_texturemap_out);
    vec3 layerednormal_texturemap_out = vec3(0.0);
    adsk_NG_adsk_normal_map(layerednormal_texturemap_file, layerednormal_texturemap_realworld_offset_unit_out, layerednormal_texturemap_realworld_scale_unit_out, layerednormal_texturemap_uv_offset, layerednormal_texturemap_uv_scale, layerednormal_texturemap_rotation_angle, layerednormal_texturemap_normal_scale, layerednormal_texturemap_uaddressmode, layerednormal_texturemap_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, layerednormal_texturemap_out);
    surfaceshader archviz_layered3_out = surfaceshader(vec3(0.0),vec3(0.0));
    adsk_NG_adsk_layered(geomprop_Nworld_out1, archviz_layered3_surface_cutout, surfacealbedo_texturemap_out, surfaceroughness_texturemap_out, archviz_layered3_surface_anisotropy, archviz_layered3_surface_rotation, layerednormal_texturemap_out, archviz_layered3_layered_f0, archviz_layered3_layered_roughness, archviz_layered3_layered_anisotropy, archviz_layered3_layered_rotation, layeredfraction_texturemap_out, archviz_layered3_layered_fraction_invert, layereddiffuse_texturemap_out, archviz_layered3_layered_bottom_f0, archviz_layered3_out);
    material Granite_Blue_Pearl_out = archviz_layered3_out;
    out1 = vec4(Granite_Blue_Pearl_out.color, 1.0);
}
