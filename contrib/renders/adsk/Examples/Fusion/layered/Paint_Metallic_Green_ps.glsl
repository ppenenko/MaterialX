...
uniform vec3 archviz_layered_surface_cutout = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 archviz_layered_surface_albedo = vec3(1.000000, 1.000000, 1.000000);
uniform float archviz_layered_surface_roughness = 0.000000;
uniform float archviz_layered_surface_anisotropy = 0.000000;
uniform float archviz_layered_surface_rotation = 0.000000;
uniform float archviz_layered_layered_f0 = 0.060270;
uniform float archviz_layered_layered_roughness = 0.547723;
uniform float archviz_layered_layered_anisotropy = 0.000000;
uniform float archviz_layered_layered_rotation = 0.000000;
uniform float archviz_layered_layered_fraction = 0.750000;
uniform bool archviz_layered_layered_fraction_invert = false;
uniform vec3 archviz_layered_layered_diffuse = vec3(0.268604, 0.588564, 0.281161);
uniform vec3 archviz_layered_layered_bottom_f0 = vec3(0.268604, 0.588564, 0.281161);
...
void main()
{
    ...
    surfaceshader archviz_layered_out = surfaceshader(vec3(0.0),vec3(0.0));
    adsk_NG_adsk_layered(geomprop_Nworld_out1, archviz_layered_surface_cutout, archviz_layered_surface_albedo, archviz_layered_surface_roughness, archviz_layered_surface_anisotropy, archviz_layered_surface_rotation, geomprop_Nworld_out1, archviz_layered_layered_f0, archviz_layered_layered_roughness, archviz_layered_layered_anisotropy, archviz_layered_layered_rotation, archviz_layered_layered_fraction, archviz_layered_layered_fraction_invert, archviz_layered_layered_diffuse, archviz_layered_layered_bottom_f0, archviz_layered_out);
    material Paint_Metallic_Green_out = archviz_layered_out;
    out1 = vec4(Paint_Metallic_Green_out.color, 1.0);
}
