...
uniform vec3 archviz_layered2_surface_cutout = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 archviz_layered2_surface_albedo = vec3(1.000000, 1.000000, 1.000000);
uniform float archviz_layered2_surface_roughness = 0.000000;
uniform float archviz_layered2_surface_anisotropy = 0.000000;
uniform float archviz_layered2_surface_rotation = 0.000000;
uniform float archviz_layered2_layered_f0 = 0.060270;
uniform float archviz_layered2_layered_roughness = 0.547723;
uniform float archviz_layered2_layered_anisotropy = 0.000000;
uniform float archviz_layered2_layered_rotation = 0.000000;
uniform float archviz_layered2_layered_fraction = 0.750000;
uniform bool archviz_layered2_layered_fraction_invert = false;
uniform vec3 archviz_layered2_layered_diffuse = vec3(0.767376, 0.205984, 0.151704);
uniform vec3 archviz_layered2_layered_bottom_f0 = vec3(0.767376, 0.205984, 0.151704);
...
void main()
{
    ...
    surfaceshader archviz_layered2_out = surfaceshader(vec3(0.0),vec3(0.0));
    adsk_NG_adsk_layered(geomprop_Nworld_out1, archviz_layered2_surface_cutout, archviz_layered2_surface_albedo, archviz_layered2_surface_roughness, archviz_layered2_surface_anisotropy, archviz_layered2_surface_rotation, geomprop_Nworld_out1, archviz_layered2_layered_f0, archviz_layered2_layered_roughness, archviz_layered2_layered_anisotropy, archviz_layered2_layered_rotation, archviz_layered2_layered_fraction, archviz_layered2_layered_fraction_invert, archviz_layered2_layered_diffuse, archviz_layered2_layered_bottom_f0, archviz_layered2_out);
    material Paint_Metallic_Red_out = archviz_layered2_out;
    out1 = vec4(Paint_Metallic_Red_out.color, 1.0);
}
