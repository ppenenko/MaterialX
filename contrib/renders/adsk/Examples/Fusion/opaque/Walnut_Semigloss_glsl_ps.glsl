...
uniform float heightnormal_texturemap_depth = 0.030000;
...
uniform vec3 shaderref4_surface_cutout = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 shaderref4_surface_albedo = vec3(1.000000, 1.000000, 1.000000);
uniform float shaderref4_surface_anisotropy = 0.000000;
uniform float shaderref4_surface_rotation = 0.000000;
uniform float shaderref4_opaque_f0 = 0.052900;
uniform bool shaderref4_opaque_translucency = false;
uniform vec3 shaderref4_opaque_mfp_modifier = vec3(1.000000, 1.000000, 1.000000);
uniform float shaderref4_opaque_mfp = 0.500000;
uniform bool shaderref4_opaque_emission = false;
uniform float shaderref4_opaque_luminance = 0.000000;
uniform vec3 shaderref4_opaque_luminance_modifier = vec3(1.000000, 1.000000, 1.000000);
...
void main()
{
    ...
    surfaceshader shaderref4_out = surfaceshader(vec3(0.0),vec3(0.0));
    adsk_NG_adsk_opaque(heightnormal_texturemap_out, shaderref4_surface_cutout, shaderref4_surface_albedo, opaquealbedo_texturemap_out, surfaceroughness_texturemap_out, shaderref4_surface_anisotropy, shaderref4_surface_rotation, shaderref4_opaque_f0, shaderref4_opaque_translucency, shaderref4_opaque_mfp_modifier, shaderref4_opaque_mfp, shaderref4_opaque_emission, shaderref4_opaque_luminance, shaderref4_opaque_luminance_modifier, shaderref4_out);
    material Walnut_Semigloss_out = shaderref4_out;
    out1 = vec4(Walnut_Semigloss_out.color, 1.0);
}
