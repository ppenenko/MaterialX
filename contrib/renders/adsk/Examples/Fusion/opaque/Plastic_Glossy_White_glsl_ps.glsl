...
uniform vec3 archviz_opaque_surface_cutout = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 archviz_opaque_surface_albedo = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 archviz_opaque_opaque_albedo = vec3(0.963976, 0.963976, 0.954687);
uniform float archviz_opaque_surface_roughness = 0.122474;
uniform float archviz_opaque_surface_anisotropy = 0.000000;
uniform float archviz_opaque_surface_rotation = 0.000000;
uniform float archviz_opaque_opaque_f0 = 0.052900;
uniform bool archviz_opaque_opaque_translucency = false;
uniform vec3 archviz_opaque_opaque_mfp_modifier = vec3(1.000000, 1.000000, 1.000000);
uniform float archviz_opaque_opaque_mfp = 0.500000;
uniform bool archviz_opaque_opaque_emission = false;
uniform float archviz_opaque_opaque_luminance = 0.000000;
uniform vec3 archviz_opaque_opaque_luminance_modifier = vec3(1.000000, 1.000000, 1.000000);
...
{
    vec3 geomprop_Nworld_out1 = normalize(vd.normalWorld);
    surfaceshader archviz_opaque_out = surfaceshader(vec3(0.0),vec3(0.0));
    adsk_NG_adsk_opaque(geomprop_Nworld_out1, archviz_opaque_surface_cutout, archviz_opaque_surface_albedo, archviz_opaque_opaque_albedo, archviz_opaque_surface_roughness, archviz_opaque_surface_anisotropy, archviz_opaque_surface_rotation, archviz_opaque_opaque_f0, archviz_opaque_opaque_translucency, archviz_opaque_opaque_mfp_modifier, archviz_opaque_opaque_mfp, archviz_opaque_opaque_emission, archviz_opaque_opaque_luminance, archviz_opaque_opaque_luminance_modifier, archviz_opaque_out);
    material Plastic_Glossy_White_out = archviz_opaque_out;
    out1 = vec4(Plastic_Glossy_White_out.color, 1.0);
}
