...
uniform vec2 heightnormal_texturemap_realworld_offset_unit_in1 = vec2(0.000000, 0.000000);
uniform float heightnormal_texturemap_realworld_offset_unit_in2 = 2.540000;
uniform vec2 heightnormal_texturemap_realworld_scale_unit_in1 = vec2(6.000000, 12.000000);
uniform float heightnormal_texturemap_realworld_scale_unit_in2 = 2.540000;
uniform float heightnormal_texturemap_depth_unit_in1 = 0.030000;
uniform float heightnormal_texturemap_depth_unit_in2 = 2.540000;
...
uniform vec2 surfaceroughness_texturemap_realworld_scale_unit_in1 = vec2(6.000000, 12.000000);
uniform float surfaceroughness_texturemap_realworld_scale_unit_in2 = 2.540000;
uniform vec2 opaquealbedo_texturemap_realworld_offset_unit_in1 = vec2(0.000000, 0.000000);
uniform float opaquealbedo_texturemap_realworld_offset_unit_in2 = 2.540000;
uniform vec2 opaquealbedo_texturemap_realworld_scale_unit_in1 = vec2(6.000000, 12.000000);
uniform float opaquealbedo_texturemap_realworld_scale_unit_in2 = 2.540000;
uniform sampler2D heightnormal_texturemap_file;
uniform vec2 heightnormal_texturemap_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 heightnormal_texturemap_uv_scale = vec2(1.000000, 1.000000);
uniform float heightnormal_texturemap_rotation_angle = 0.000000;
uniform int heightnormal_texturemap_uaddressmode = 2;
uniform int heightnormal_texturemap_vaddressmode = 2;
...
uniform sampler2D opaquealbedo_texturemap_file;
uniform vec2 opaquealbedo_texturemap_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 opaquealbedo_texturemap_uv_scale = vec2(1.000000, 1.000000);
uniform float opaquealbedo_texturemap_rotation_angle = 0.000000;
uniform float opaquealbedo_texturemap_rgbamount = 1.000000;
uniform bool opaquealbedo_texturemap_invert = false;
uniform int opaquealbedo_texturemap_uaddressmode = 2;
uniform int opaquealbedo_texturemap_vaddressmode = 2;
uniform vec3 shaderref3_surface_cutout = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 shaderref3_surface_albedo = vec3(1.000000, 1.000000, 1.000000);
uniform float shaderref3_surface_anisotropy = 0.000000;
uniform float shaderref3_surface_rotation = 0.000000;
uniform float shaderref3_opaque_f0 = 0.052900;
uniform bool shaderref3_opaque_translucency = false;
uniform vec3 shaderref3_opaque_mfp_modifier = vec3(1.000000, 1.000000, 1.000000);
uniform float shaderref3_opaque_mfp = 0.500000;
uniform bool shaderref3_opaque_emission = false;
uniform float shaderref3_opaque_luminance = 0.000000;
uniform vec3 shaderref3_opaque_luminance_modifier = vec3(1.000000, 1.000000, 1.000000);
...
void adsk_NG_adsk_opaque(vec3 surface_normal, vec3 surface_cutout, vec3 surface_albedo, vec3 opaque_albedo, float surface_roughness, float surface_anisotropy, float surface_rotation, float opaque_f0, bool opaque_translucency, vec3 opaque_mfp_modifier, float opaque_mfp, bool opaque_emission, float opaque_luminance, vec3 opaque_luminance_modifier, out surfaceshader out1)
{
    ...
    float sqrt_opaquef0_out = sqrt(opaque_f0);
    ...
    float subsurface_value_out = (opaque_translucency == subsurface_value_value2_tmp) ? subsurface_value_in1_tmp : subsurface_value_in2_tmp;
    ...
    float emission_value_out = (opaque_emission == emission_value_value2_tmp) ? opaque_luminance : emission_value_in2_tmp;
    vec3 geomprop_Tworld_out1 = normalize(vd.tangentWorld);
    float sqrt1minus_surfaniso0_out = sqrt(oneminus_surfaniso0_out);
    const float oneplus_sqrtopaquef0_in1_tmp = 1.000000;
    float oneplus_sqrtopaquef0_out = oneplus_sqrtopaquef0_in1_tmp + sqrt_opaquef0_out;
    const float oneminus_sqrtopaquef0_in1_tmp = 1.000000;
    float oneminus_sqrtopaquef0_out = oneminus_sqrtopaquef0_in1_tmp - sqrt_opaquef0_out;
    float specular_anisotropy_value_out = twotimes_surfaniso0_out - pow2_surfaniso0_out;
    const float specular_rotation_value_in2_tmp = 1.000000;
    float specular_rotation_value_out = mx_mod(div_rotation0_out, specular_rotation_value_in2_tmp);
    ...
    float specular_roughness_value_out = sqrt1minus_surfaniso0_out * surface_roughness;
    float specular_IOR_value_out = oneplus_sqrtopaquef0_out / oneminus_sqrtopaquef0_out;
    surfaceshader standard_surface0_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(1.000000, opaque_albedo, 0.000000, 0.000000, 1.000000, surface_albedo, specular_roughness_value_out, specular_IOR_value_out, specular_anisotropy_value_out, specular_rotation_value_out, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.000000, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, 0.000000, subsurface_value_out, opaque_albedo, opaque_mfp_modifier, opaque_mfp, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.100000, 0.000000, 0.000000, 1.500000, geomprop_Nworld_out1, 0.000000, 0.000000, 0.000000, 1.500000, emission_value_scaled_out, opaque_luminance_modifier, surface_cutout, false, surface_normal, geomprop_Tworld_out1, standard_surface0_out);
...
void main()
{
    ...
    vec3 geomprop_Tworld_out1 = normalize(vd.tangentWorld);
    vec2 heightnormal_texturemap_realworld_offset_unit_out = heightnormal_texturemap_realworld_offset_unit_in1 * heightnormal_texturemap_realworld_offset_unit_in2;
    ...
    float heightnormal_texturemap_depth_unit_out = heightnormal_texturemap_depth_unit_in1 * heightnormal_texturemap_depth_unit_in2;
    ...
    vec2 opaquealbedo_texturemap_realworld_offset_unit_out = opaquealbedo_texturemap_realworld_offset_unit_in1 * opaquealbedo_texturemap_realworld_offset_unit_in2;
    vec2 opaquealbedo_texturemap_realworld_scale_unit_out = opaquealbedo_texturemap_realworld_scale_unit_in1 * opaquealbedo_texturemap_realworld_scale_unit_in2;
    vec3 heightnormal_texturemap_out = vec3(0.0);
    adsk_NG_adsk_height_map(heightnormal_texturemap_file, heightnormal_texturemap_realworld_offset_unit_out, heightnormal_texturemap_realworld_scale_unit_out, heightnormal_texturemap_uv_offset, heightnormal_texturemap_uv_scale, heightnormal_texturemap_rotation_angle, heightnormal_texturemap_depth_unit_out, heightnormal_texturemap_uaddressmode, heightnormal_texturemap_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, heightnormal_texturemap_out);
    ...
    vec3 opaquealbedo_texturemap_out = vec3(0.0);
    adsk_NG_adsk_bitmap_color3(opaquealbedo_texturemap_file, opaquealbedo_texturemap_realworld_offset_unit_out, opaquealbedo_texturemap_realworld_scale_unit_out, opaquealbedo_texturemap_uv_offset, opaquealbedo_texturemap_uv_scale, opaquealbedo_texturemap_rotation_angle, opaquealbedo_texturemap_rgbamount, opaquealbedo_texturemap_invert, opaquealbedo_texturemap_uaddressmode, opaquealbedo_texturemap_vaddressmode, geomprop_UV0_out1, opaquealbedo_texturemap_out);
    surfaceshader shaderref3_out = surfaceshader(vec3(0.0),vec3(0.0));
    adsk_NG_adsk_opaque(heightnormal_texturemap_out, shaderref3_surface_cutout, shaderref3_surface_albedo, opaquealbedo_texturemap_out, surfaceroughness_texturemap_out, shaderref3_surface_anisotropy, shaderref3_surface_rotation, shaderref3_opaque_f0, shaderref3_opaque_translucency, shaderref3_opaque_mfp_modifier, shaderref3_opaque_mfp, shaderref3_opaque_emission, shaderref3_opaque_luminance, shaderref3_opaque_luminance_modifier, shaderref3_out);
    material Walnut_out = shaderref3_out;
    out1 = vec4(Walnut_out.color, 1.0);
}
