...
uniform vec3 archviz_transparent2_surface_cutout = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 archviz_transparent2_surface_albedo = vec3(1.000000, 1.000000, 1.000000);
uniform float archviz_transparent2_surface_roughness = 0.000000;
uniform float archviz_transparent2_surface_anisotropy = 0.000000;
uniform float archviz_transparent2_surface_rotation = 0.000000;
uniform float archviz_transparent2_transparent_ior = 2.419000;
uniform vec3 archviz_transparent2_transparent_color = vec3(0.906332, 0.906332, 0.896244);
uniform float archviz_transparent2_transparent_distance = 5.000000;
...
void adsk_NG_adsk_transparent(vec3 surface_normal, vec3 surface_cutout, vec3 surface_albedo, float surface_roughness, float surface_anisotropy, float surface_rotation, float transparent_ior, vec3 transparent_color, float transparent_distance, out surfaceshader out1)
{
    ...
    NG_standard_surface_surfaceshader_100(1.000000, vec3(0.800000, 0.800000, 0.800000), 0.000000, 0.000000, 1.000000, surface_albedo, specular_roughness_value_out, transparent_ior, specular_anisotropy_value_out, specular_rotation_value_out, 1.000000, transparent_color, transparent_distance, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 1.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.100000, 0.000000, 0.000000, 1.500000, geomprop_Nworld_out1, 0.000000, 0.000000, 0.000000, 1.500000, 0.000000, vec3(1.000000, 1.000000, 1.000000), surface_cutout, false, surface_normal, geomprop_Tworld_out1, standard_surface0_out);
...
{
    vec3 geomprop_Nworld_out1 = normalize(vd.normalWorld);
    surfaceshader archviz_transparent2_out = surfaceshader(vec3(0.0),vec3(0.0));
    adsk_NG_adsk_transparent(geomprop_Nworld_out1, archviz_transparent2_surface_cutout, archviz_transparent2_surface_albedo, archviz_transparent2_surface_roughness, archviz_transparent2_surface_anisotropy, archviz_transparent2_surface_rotation, archviz_transparent2_transparent_ior, archviz_transparent2_transparent_color, archviz_transparent2_transparent_distance, archviz_transparent2_out);
    material Gemstone_Diamond_out = archviz_transparent2_out;
    float outAlpha = clamp(1.0 - dot(Gemstone_Diamond_out.transparency, vec3(0.3333)), 0.0, 1.0);
    out1 = vec4(Gemstone_Diamond_out.color, outAlpha);
