...
uniform vec3 archviz_transparent_surface_cutout = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 archviz_transparent_surface_albedo = vec3(1.000000, 1.000000, 1.000000);
uniform float archviz_transparent_surface_roughness = 0.000000;
uniform float archviz_transparent_surface_anisotropy = 0.000000;
uniform float archviz_transparent_surface_rotation = 0.000000;
uniform float archviz_transparent_transparent_ior = 1.770000;
uniform vec3 archviz_transparent_transparent_color = vec3(0.977692, 0.151704, 0.151704);
uniform float archviz_transparent_transparent_distance = 2.000000;
...
{
    vec3 geomprop_Nworld_out1 = normalize(vd.normalWorld);
    surfaceshader archviz_transparent_out = surfaceshader(vec3(0.0),vec3(0.0));
    adsk_NG_adsk_transparent(geomprop_Nworld_out1, archviz_transparent_surface_cutout, archviz_transparent_surface_albedo, archviz_transparent_surface_roughness, archviz_transparent_surface_anisotropy, archviz_transparent_surface_rotation, archviz_transparent_transparent_ior, archviz_transparent_transparent_color, archviz_transparent_transparent_distance, archviz_transparent_out);
    material Gemstone_Ruby_out = archviz_transparent_out;
    float outAlpha = clamp(1.0 - dot(Gemstone_Ruby_out.transparency, vec3(0.3333)), 0.0, 1.0);
    out1 = vec4(Gemstone_Ruby_out.color, outAlpha);
