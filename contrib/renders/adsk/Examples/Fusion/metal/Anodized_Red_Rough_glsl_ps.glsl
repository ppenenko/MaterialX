...
uniform vec3 shaderref2_metal_f0 = vec3(0.700000, 0.100000, 0.100000);
uniform vec3 shaderref2_surface_albedo = vec3(1.000000, 1.000000, 1.000000);
uniform float shaderref2_surface_roughness = 0.547723;
uniform float shaderref2_surface_anisotropy = 0.000000;
uniform float shaderref2_surface_rotation = 0.000000;
uniform vec3 shaderref2_surface_cutout = vec3(1.000000, 1.000000, 1.000000);
...
{
    vec3 geomprop_Nworld_out1 = normalize(vd.normalWorld);
    surfaceshader shaderref2_out = surfaceshader(vec3(0.0),vec3(0.0));
    adsk_NG_adsk_metal(shaderref2_metal_f0, shaderref2_surface_albedo, shaderref2_surface_roughness, shaderref2_surface_anisotropy, shaderref2_surface_rotation, geomprop_Nworld_out1, shaderref2_surface_cutout, shaderref2_out);
    material Anodized_Red_Rough_out = shaderref2_out;
    out1 = vec4(Anodized_Red_Rough_out.color, 1.0);
}
