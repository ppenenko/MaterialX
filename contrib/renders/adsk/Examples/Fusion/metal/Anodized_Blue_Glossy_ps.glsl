...
uniform vec3 shaderref0_metal_f0 = vec3(0.100000, 0.300000, 0.700000);
uniform vec3 shaderref0_surface_albedo = vec3(1.000000, 1.000000, 1.000000);
uniform float shaderref0_surface_roughness = 0.122474;
uniform float shaderref0_surface_anisotropy = 0.000000;
uniform float shaderref0_surface_rotation = 0.000000;
uniform vec3 shaderref0_surface_cutout = vec3(1.000000, 1.000000, 1.000000);
...
{
    vec3 geomprop_Nworld_out1 = normalize(vd.normalWorld);
    surfaceshader shaderref0_out = surfaceshader(vec3(0.0),vec3(0.0));
    adsk_NG_adsk_metal(shaderref0_metal_f0, shaderref0_surface_albedo, shaderref0_surface_roughness, shaderref0_surface_anisotropy, shaderref0_surface_rotation, geomprop_Nworld_out1, shaderref0_surface_cutout, shaderref0_out);
    material Anodized_Blue_Glossy_out = shaderref0_out;
    out1 = vec4(Anodized_Blue_Glossy_out.color, 1.0);
}
