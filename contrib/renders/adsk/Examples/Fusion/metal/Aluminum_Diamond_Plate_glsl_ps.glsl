...
uniform vec2 normal_texturemap_realworld_scale_unit_in1 = vec2(30.000000, 30.000000);
...
uniform vec3 shaderref5_metal_f0 = vec3(0.959822, 0.962260, 0.965052);
uniform vec3 shaderref5_surface_albedo = vec3(1.000000, 1.000000, 1.000000);
uniform float shaderref5_surface_roughness = 0.122474;
uniform float shaderref5_surface_anisotropy = 0.000000;
uniform float shaderref5_surface_rotation = 0.000000;
uniform vec3 shaderref5_surface_cutout = vec3(1.000000, 1.000000, 1.000000);
...
void main()
{
    ...
    surfaceshader shaderref5_out = surfaceshader(vec3(0.0),vec3(0.0));
    adsk_NG_adsk_metal(shaderref5_metal_f0, shaderref5_surface_albedo, shaderref5_surface_roughness, shaderref5_surface_anisotropy, shaderref5_surface_rotation, normal_texturemap_out, shaderref5_surface_cutout, shaderref5_out);
    material Aluminum_Diamond_Plate_out = shaderref5_out;
    out1 = vec4(Aluminum_Diamond_Plate_out.color, 1.0);
}
