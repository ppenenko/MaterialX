...
uniform vec2 heightnormal_texturemap_realworld_scale_unit_in1 = vec2(30.000000, 30.000000);
...
uniform vec2 surfaceroughness_texturemap_realworld_scale_unit_in1 = vec2(30.000000, 30.000000);
...
uniform float heightnormal_texturemap_depth = 0.075000;
...
uniform vec3 shaderref4_metal_f0 = vec3(0.959822, 0.962260, 0.965052);
...
void main()
{
    ...
    adsk_NG_adsk_metal(shaderref4_metal_f0, shaderref4_surface_albedo, surfaceroughness_texturemap_out, shaderref4_surface_anisotropy, shaderref4_surface_rotation, heightnormal_texturemap_out, shaderref4_surface_cutout, shaderref4_out);
    material Aluminum_Cast_out = shaderref4_out;
    out1 = vec4(Aluminum_Cast_out.color, 1.0);
}
