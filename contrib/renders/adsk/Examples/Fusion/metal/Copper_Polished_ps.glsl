...
uniform vec3 shaderref1_metal_f0 = vec3(0.848522, 0.614431, 0.546826);
uniform vec3 shaderref1_surface_albedo = vec3(1.000000, 1.000000, 1.000000);
uniform float shaderref1_surface_roughness = 0.077460;
uniform float shaderref1_surface_anisotropy = 0.000000;
uniform float shaderref1_surface_rotation = 0.000000;
uniform vec3 shaderref1_surface_cutout = vec3(1.000000, 1.000000, 1.000000);
...
void main()
{
    ...
    adsk_NG_adsk_metal(shaderref1_metal_f0, shaderref1_surface_albedo, shaderref1_surface_roughness, shaderref1_surface_anisotropy, shaderref1_surface_rotation, geomprop_Nworld_out1, shaderref1_surface_cutout, shaderref1_out);
    material Copper_Polished_out = shaderref1_out;
    out1 = vec4(Copper_Polished_out.color, 1.0);
}
