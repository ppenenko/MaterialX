...
uniform vec2 normal_texturemap_realworld_offset_unit_in1 = vec2(0.000000, 0.000000);
uniform float normal_texturemap_realworld_offset_unit_in2 = 2.540000;
uniform vec2 normal_texturemap_realworld_scale_unit_in1 = vec2(60.000000, 60.000000);
uniform float normal_texturemap_realworld_scale_unit_in2 = 2.540000;
uniform vec2 surfacecutout_texturemap_realworld_offset_unit_in1 = vec2(0.000000, 0.000000);
uniform float surfacecutout_texturemap_realworld_offset_unit_in2 = 2.540000;
uniform vec2 surfacecutout_texturemap_realworld_scale_unit_in1 = vec2(60.000000, 60.000000);
uniform float surfacecutout_texturemap_realworld_scale_unit_in2 = 2.540000;
uniform sampler2D surfacealbedo_texturemap_file;
uniform vec2 surfacealbedo_texturemap_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 surfacealbedo_texturemap_realworld_scale = vec2(1.000000, 1.000000);
...
uniform sampler2D normal_texturemap_file;
uniform vec2 normal_texturemap_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 normal_texturemap_uv_scale = vec2(1.000000, 1.000000);
uniform float normal_texturemap_rotation_angle = 0.000000;
uniform float normal_texturemap_normal_scale = 1.000000;
uniform int normal_texturemap_uaddressmode = 2;
uniform int normal_texturemap_vaddressmode = 2;
uniform sampler2D surfacecutout_texturemap_file;
uniform vec2 surfacecutout_texturemap_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 surfacecutout_texturemap_uv_scale = vec2(1.000000, 1.000000);
uniform float surfacecutout_texturemap_rotation_angle = 0.000000;
uniform float surfacecutout_texturemap_rgbamount = 1.000000;
uniform bool surfacecutout_texturemap_invert = false;
uniform int surfacecutout_texturemap_uaddressmode = 2;
uniform int surfacecutout_texturemap_vaddressmode = 2;
uniform vec3 shaderref3_metal_f0 = vec3(0.900000, 0.600000, 0.200000);
uniform float shaderref3_surface_roughness = 0.122474;
uniform float shaderref3_surface_anisotropy = 0.950000;
...
void adsk_NG_adsk_metal(vec3 metal_f0, vec3 surface_albedo, float surface_roughness, float surface_anisotropy, float surface_rotation, vec3 surface_normal, vec3 surface_cutout, out surfaceshader out1)
{
    vec3 geomprop_Nworld_out1 = normalize(vd.normalWorld);
    vec3 geomprop_Tworld_out1 = normalize(vd.tangentWorld);
    vec3 base_color_value_out = surface_albedo * metal_f0;
...
void main()
{
    ...
    vec3 geomprop_Tworld_out1 = normalize(vd.tangentWorld);
    vec2 normal_texturemap_realworld_offset_unit_out = normal_texturemap_realworld_offset_unit_in1 * normal_texturemap_realworld_offset_unit_in2;
