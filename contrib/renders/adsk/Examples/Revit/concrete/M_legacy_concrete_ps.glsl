...
uniform vec3 image_color3_default = vec3(0.000000, 0.000000, 0.000000);
...
uniform sampler2D texture_broomstraight_file;
uniform vec2 texture_broomstraight_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 texture_broomstraight_realworld_scale = vec2(0.250000, 0.250000);
uniform vec2 texture_broomstraight_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 texture_broomstraight_uv_scale = vec2(1.000000, 1.000000);
uniform float texture_broomstraight_rotation_angle = 0.000000;
uniform float texture_broomstraight_depth = 1.000000;
uniform int texture_broomstraight_uaddressmode = 2;
uniform int texture_broomstraight_vaddressmode = 2;
uniform sampler2D texture_broomcurved_file;
uniform vec2 texture_broomcurved_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 texture_broomcurved_realworld_scale = vec2(0.250000, 0.250000);
uniform vec2 texture_broomcurved_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 texture_broomcurved_uv_scale = vec2(1.000000, 1.000000);
uniform float texture_broomcurved_rotation_angle = 0.000000;
uniform float texture_broomcurved_depth = 1.000000;
uniform int texture_broomcurved_uaddressmode = 2;
uniform int texture_broomcurved_vaddressmode = 2;
uniform sampler2D texture_smooth_file;
uniform vec2 texture_smooth_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 texture_smooth_realworld_scale = vec2(0.250000, 0.250000);
uniform vec2 texture_smooth_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 texture_smooth_uv_scale = vec2(1.000000, 1.000000);
uniform float texture_smooth_rotation_angle = 0.000000;
uniform float texture_smooth_depth = 1.000000;
uniform int texture_smooth_uaddressmode = 2;
uniform int texture_smooth_vaddressmode = 2;
uniform sampler2D texture_polished_file;
uniform vec2 texture_polished_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 texture_polished_realworld_scale = vec2(0.250000, 0.250000);
uniform vec2 texture_polished_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 texture_polished_uv_scale = vec2(1.000000, 1.000000);
uniform float texture_polished_rotation_angle = 0.000000;
uniform float texture_polished_depth = 0.100000;
uniform int texture_polished_uaddressmode = 2;
uniform int texture_polished_vaddressmode = 2;
uniform sampler2D texture_custom_file;
uniform vec2 texture_custom_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 texture_custom_realworld_scale = vec2(0.250000, 0.250000);
uniform vec2 texture_custom_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 texture_custom_uv_scale = vec2(1.000000, 1.000000);
uniform float texture_custom_rotation_angle = 0.000000;
uniform float texture_custom_depth = 0.500000;
uniform int texture_custom_uaddressmode = 2;
uniform int texture_custom_vaddressmode = 2;
uniform vec3 SR_legacy_concrete_color = vec3(0.600000, 0.600000, 0.600000);
uniform bool SR_legacy_concrete_tint_enable = true;
uniform vec3 SR_legacy_concrete_tint_color = vec3(0.500000, 0.500000, 0.950000);
uniform int SR_legacy_concrete_sealant = 0;
uniform int SR_legacy_concrete_finish_bump = 0;
uniform bool SR_legacy_concrete_weathering_enable = true;
uniform int SR_legacy_concrete_weathering_type = 0;
uniform vec3 SR_legacy_concrete_weathering_auto = vec3(1.000000, 1.000000, 1.000000);
...
void NG_legacy_concrete(vec3 color, bool tint_enable, vec3 tint_color, int sealant, int finish_bump, vec3 normal_broomstraight, vec3 normal_broomcurved, vec3 normal_smooth, vec3 normal_polished, vec3 normal_custom, bool weathering_enable, int weathering_type, vec3 weathering_auto, vec3 weathering_custom, out surfaceshader out1)
{
    vec3 tint_mult_out = color * tint_color;
    vec3 switch_weathering_out = vec3(0.0);
    NG_switch_color3I(weathering_auto, weathering_custom, vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), weathering_type, switch_weathering_out);
    float switch_rough_out = 0.0;
    NG_switch_floatI(0.700000, 0.600000, 0.500000, 0.300000, 0.500000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, finish_bump, switch_rough_out);
    float switch_coat_onoff_out = 0.0;
    NG_switch_floatI(0.000000, 1.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, sealant, switch_coat_onoff_out);
    float switch_coat_rough_out = 0.0;
    NG_switch_floatI(0.500000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, sealant, switch_coat_rough_out);
    float switch_coat_ior_out = 0.0;
    NG_switch_floatI(1.500000, 1.550000, 1.490000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, sealant, switch_coat_ior_out);
    vec3 geomprop_Nworld_out1 = normalize(vd.normalWorld);
    vec3 switch_bump_out = vec3(0.0);
    NG_switch_vector3I(normal_broomstraight, normal_broomcurved, normal_smooth, normal_polished, normal_custom, vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), finish_bump, switch_bump_out);
    ...
    const bool ifequal_color3B_value2_tmp = true;
    const vec3 ifequal_color3B_in2_tmp = vec3(1.000000, 1.000000, 1.000000);
    vec3 ifequal_color3B_out = (weathering_enable == ifequal_color3B_value2_tmp) ? switch_weathering_out : ifequal_color3B_in2_tmp;
    vec3 multiply_weathering_out = tint_selection_out * ifequal_color3B_out;
    surfaceshader standard_surface_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(1.000000, multiply_weathering_out, 0.000000, 0.000000, 1.000000, vec3(1.000000, 1.000000, 1.000000), switch_rough_out, 1.500000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.000000, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 1.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, switch_coat_onoff_out, vec3(1.000000, 1.000000, 1.000000), switch_coat_rough_out, 0.000000, 0.000000, switch_coat_ior_out, geomprop_Nworld_out1, 0.500000, 0.000000, 0.000000, 1.500000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), false, switch_bump_out, geomprop_Tworld_out1, standard_surface_out);
...
void main()
{
    ...
    mx_image_color3(image_color3_file, image_color3_layer, image_color3_default, geomprop_UV0_out1, image_color3_uaddressmode, image_color3_vaddressmode, image_color3_filtertype, image_color3_framerange, image_color3_frameoffset, image_color3_frameendaction, image_color3_uv_scale, image_color3_uv_offset, image_color3_out);
    vec3 texture_broomstraight_out = vec3(0.0);
    adsk_NG_adsk_height_map(texture_broomstraight_file, texture_broomstraight_realworld_offset, texture_broomstraight_realworld_scale, texture_broomstraight_uv_offset, texture_broomstraight_uv_scale, texture_broomstraight_rotation_angle, texture_broomstraight_depth, texture_broomstraight_uaddressmode, texture_broomstraight_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, texture_broomstraight_out);
    vec3 texture_broomcurved_out = vec3(0.0);
    adsk_NG_adsk_height_map(texture_broomcurved_file, texture_broomcurved_realworld_offset, texture_broomcurved_realworld_scale, texture_broomcurved_uv_offset, texture_broomcurved_uv_scale, texture_broomcurved_rotation_angle, texture_broomcurved_depth, texture_broomcurved_uaddressmode, texture_broomcurved_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, texture_broomcurved_out);
    vec3 texture_smooth_out = vec3(0.0);
    adsk_NG_adsk_height_map(texture_smooth_file, texture_smooth_realworld_offset, texture_smooth_realworld_scale, texture_smooth_uv_offset, texture_smooth_uv_scale, texture_smooth_rotation_angle, texture_smooth_depth, texture_smooth_uaddressmode, texture_smooth_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, texture_smooth_out);
    vec3 texture_polished_out = vec3(0.0);
    adsk_NG_adsk_height_map(texture_polished_file, texture_polished_realworld_offset, texture_polished_realworld_scale, texture_polished_uv_offset, texture_polished_uv_scale, texture_polished_rotation_angle, texture_polished_depth, texture_polished_uaddressmode, texture_polished_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, texture_polished_out);
    vec3 texture_custom_out = vec3(0.0);
    adsk_NG_adsk_height_map(texture_custom_file, texture_custom_realworld_offset, texture_custom_realworld_scale, texture_custom_uv_offset, texture_custom_uv_scale, texture_custom_rotation_angle, texture_custom_depth, texture_custom_uaddressmode, texture_custom_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, texture_custom_out);
    surfaceshader SR_legacy_concrete_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_legacy_concrete(SR_legacy_concrete_color, SR_legacy_concrete_tint_enable, SR_legacy_concrete_tint_color, SR_legacy_concrete_sealant, SR_legacy_concrete_finish_bump, texture_broomstraight_out, texture_broomcurved_out, texture_smooth_out, texture_polished_out, texture_custom_out, SR_legacy_concrete_weathering_enable, SR_legacy_concrete_weathering_type, SR_legacy_concrete_weathering_auto, image_color3_out, SR_legacy_concrete_out);
    material M_legacy_concrete_out = SR_legacy_concrete_out;
    out1 = vec4(M_legacy_concrete_out.color, 1.0);
}
