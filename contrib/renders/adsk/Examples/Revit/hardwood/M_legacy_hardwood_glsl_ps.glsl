...
uniform sampler2D image_hardwood_file;
uniform int image_hardwood_layer = 0;
uniform vec3 image_hardwood_default = vec3(0.000000, 0.000000, 0.000000);
uniform int image_hardwood_uaddressmode = 2;
uniform int image_hardwood_vaddressmode = 2;
uniform int image_hardwood_filtertype = 1;
uniform int image_hardwood_framerange = 0;
uniform int image_hardwood_frameoffset = 0;
uniform int image_hardwood_frameendaction = 0;
uniform vec2 image_hardwood_uv_scale = vec2(1.000000, 1.000000);
uniform vec2 image_hardwood_uv_offset = vec2(0.000000, 0.000000);
uniform sampler2D height_map1_hardwood_file;
uniform vec2 height_map1_hardwood_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 height_map1_hardwood_realworld_scale = vec2(1.000000, 1.000000);
uniform vec2 height_map1_hardwood_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 height_map1_hardwood_uv_scale = vec2(1.000000, 1.000000);
uniform float height_map1_hardwood_rotation_angle = 0.000000;
uniform float height_map1_hardwood_depth = 1.000000;
uniform int height_map1_hardwood_uaddressmode = 2;
uniform int height_map1_hardwood_vaddressmode = 2;
uniform bool SR_legacy_hardwood_stain_enable = true;
uniform vec3 SR_legacy_hardwood_stain_color = vec3(0.400000, 0.200000, 0.100000);
uniform int SR_legacy_hardwood_finish = 0;
uniform int SR_legacy_hardwood_used_for = 0;
uniform bool SR_legacy_hardwood_tint_enable = false;
uniform vec3 SR_legacy_hardwood_tint_color = vec3(0.950000, 0.500000, 0.500000);
uniform bool SR_legacy_hardwood_relief_pattern_enable = false;
uniform int SR_legacy_hardwood_relief_pattern_type = 0;
uniform float SR_legacy_hardwood_relief_pattern_auto_amount = 0.050000;
...
void NG_legacy_stain_color3(vec3 color, vec3 stain_color, out vec3 out1)
{
    float separate_color_outr = 0.0;
    float separate_color_outg = 0.0;
    float separate_color_outb = 0.0;
    NG_separate3_color3(color, separate_color_outr, separate_color_outg, separate_color_outb);
    float separate_stain_outr = 0.0;
    float separate_stain_outg = 0.0;
    float separate_stain_outb = 0.0;
    NG_separate3_color3(stain_color, separate_stain_outr, separate_stain_outg, separate_stain_outb);
    const float inv_col_R_in1_tmp = 1.000000;
    float inv_col_R_out = inv_col_R_in1_tmp - separate_color_outr;
    const float inv_col_G_in1_tmp = 1.000000;
    float inv_col_G_out = inv_col_G_in1_tmp - separate_color_outg;
    const float inv_col_B_in1_tmp = 1.000000;
    float inv_col_B_out = inv_col_B_in1_tmp - separate_color_outb;
    const float inv_stain_R_in1_tmp = 1.000000;
    float inv_stain_R_out = inv_stain_R_in1_tmp - separate_stain_outr;
    float mul_col_stain_R_out = separate_color_outr * separate_stain_outr;
    const float inv_stain_G_in1_tmp = 1.000000;
    float inv_stain_G_out = inv_stain_G_in1_tmp - separate_stain_outg;
    float mul_col_stain_G_out = separate_color_outg * separate_stain_outg;
    const float inv_stain_B_in1_tmp = 1.000000;
    float inv_stain_B_out = inv_stain_B_in1_tmp - separate_stain_outb;
    float mul_col_stain_B_out = separate_color_outb * separate_stain_outb;
    float mul_inv_col_stain_R_out = inv_col_R_out * inv_stain_R_out;
    const float mul_2R_1_in2_tmp = 2.000000;
    float mul_2R_1_out = mul_col_stain_R_out * mul_2R_1_in2_tmp;
    float mul_inv_col_stain_G_out = inv_col_G_out * inv_stain_G_out;
    const float mul_2G_1_in2_tmp = 2.000000;
    float mul_2G_1_out = mul_col_stain_G_out * mul_2G_1_in2_tmp;
    float mul_inv_col_stain_B_out = inv_col_B_out * inv_stain_B_out;
    const float mul_2B_1_in2_tmp = 2.000000;
    float mul_2B_1_out = mul_col_stain_B_out * mul_2B_1_in2_tmp;
    const float mul_2R_2_in2_tmp = 2.000000;
    float mul_2R_2_out = mul_inv_col_stain_R_out * mul_2R_2_in2_tmp;
    const float mul_2G_2_in2_tmp = 2.000000;
    float mul_2G_2_out = mul_inv_col_stain_G_out * mul_2G_2_in2_tmp;
    const float mul_2B_2_in2_tmp = 2.000000;
    float mul_2B_2_out = mul_inv_col_stain_B_out * mul_2B_2_in2_tmp;
    const float inv_R_in1_tmp = 1.000000;
    float inv_R_out = inv_R_in1_tmp - mul_2R_2_out;
    const float inv_G_in1_tmp = 1.000000;
    float inv_G_out = inv_G_in1_tmp - mul_2G_2_out;
    const float inv_B_in1_tmp = 1.000000;
    float inv_B_out = inv_B_in1_tmp - mul_2B_2_out;
    const float ifgreater_R_value2_tmp = 0.500000;
    float ifgreater_R_out = (separate_color_outr > ifgreater_R_value2_tmp) ? inv_R_out : mul_2R_1_out;
    const float ifgreater_G_value2_tmp = 0.500000;
    float ifgreater_G_out = (separate_color_outg > ifgreater_G_value2_tmp) ? inv_G_out : mul_2G_1_out;
    const float ifgreater_B_value2_tmp = 0.500000;
    float ifgreater_B_out = (separate_color_outb > ifgreater_B_value2_tmp) ? inv_B_out : mul_2B_1_out;
    vec3 combine_col_stain_out = vec3(ifgreater_R_out,ifgreater_G_out,ifgreater_B_out);
    vec3 add_col_result_out = color + combine_col_stain_out;
    const vec3 divide_col_result_in2_tmp = vec3(2.000000, 2.000000, 2.000000);
    vec3 divide_col_result_out = add_col_result_out / divide_col_result_in2_tmp;
    vec3 mul_stain_result_out = divide_col_result_out * stain_color;
    vec3 add_col_result_1_out = divide_col_result_out + mul_stain_result_out;
    const vec3 divide_col_result_1_in2_tmp = vec3(2.000000, 2.000000, 2.000000);
    vec3 divide_col_result_1_out = add_col_result_1_out / divide_col_result_1_in2_tmp;
    out1 = divide_col_result_1_out;
}
...
void NG_legacy_hardwood(vec3 color, bool stain_enable, vec3 stain_color, int finish, int used_for, bool tint_enable, vec3 tint_color, bool relief_pattern_enable, int relief_pattern_type, float relief_pattern_auto_amount, vec3 normal_pattern_custom, vec3 normal_floor_bump, out surfaceshader out1)
{
    vec3 texture_stain_out = vec3(0.0);
    NG_legacy_stain_color3(color, stain_color, texture_stain_out);
    float switch_rough_out = 0.0;
    NG_switch_floatI(0.750000, 0.600000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, used_for, switch_rough_out);
    float switch_coat_out = 0.0;
    NG_switch_floatI(1.000000, 1.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, finish, switch_coat_out);
    float switch_finish_out = 0.0;
    NG_switch_floatI(0.050000, 0.200000, 0.400000, 0.700000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, finish, switch_finish_out);
    vec3 geomprop_Nworld_out1 = normalize(vd.normalWorld);
    vec3 luminance_color_out = vec3(0.0);
    mx_luminance_color3(color, vec3(0.299000, 0.587000, 0.114000), luminance_color_out);
    ...
    const bool stain_selection_value2_tmp = true;
    vec3 stain_selection_out = (stain_enable == stain_selection_value2_tmp) ? texture_stain_out : color;
    const int extract_float_bump_index_tmp = 0;
    float extract_float_bump_out = luminance_color_out[extract_float_bump_index_tmp];
    vec3 normalmap_neutral_normal_out = vec3(0.0);
    mx_normalmap_float(vec3(0.500000, 0.500000, 1.000000), 1.000000, geomprop_Nworld_out1, geomprop_Tworld_out1, geomprop_Bworld_out1, normalmap_neutral_normal_out);
    vec3 tint_mult_out = stain_selection_out * tint_color;
    vec3 heighttonormal_color_bump_out = vec3(0.0);
    mx_heighttonormal_vector3(extract_float_bump_out, relief_pattern_auto_amount, geomprop_UV0_out1, heighttonormal_color_bump_out);
    const bool tint_selection_value2_tmp = true;
    vec3 tint_selection_out = (tint_enable == tint_selection_value2_tmp) ? tint_mult_out : stain_selection_out;
    vec3 normalmap_color_bump_out = vec3(0.0);
    mx_normalmap_float(heighttonormal_color_bump_out, 1.000000, geomprop_Nworld_out1, geomprop_Tworld_out1, geomprop_Bworld_out1, normalmap_color_bump_out);
    vec3 switch_relief_pattern_out = vec3(0.0);
    NG_switch_vector3I(normalmap_color_bump_out, normal_pattern_custom, vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), relief_pattern_type, switch_relief_pattern_out);
    const bool relief_pattern_selection_value2_tmp = true;
    vec3 relief_pattern_selection_out = (relief_pattern_enable == relief_pattern_selection_value2_tmp) ? switch_relief_pattern_out : normalmap_neutral_normal_out;
    surfaceshader standard_surface_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(1.000000, tint_selection_out, 0.000000, 0.000000, 1.000000, vec3(1.000000, 1.000000, 1.000000), switch_rough_out, 1.500000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.000000, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 1.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, switch_coat_out, vec3(1.000000, 1.000000, 1.000000), switch_finish_out, 0.000000, 0.000000, 1.500000, geomprop_Nworld_out1, 0.000000, 0.000000, 0.000000, 1.500000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), false, relief_pattern_selection_out, geomprop_Tworld_out1, standard_surface_out);
...
void main()
{
    ...
    vec2 geomprop_UV0_out1 = vd.texcoord_0.xy;
    vec3 geomprop_Tworld_out1 = normalize(vd.tangentWorld);
    vec3 image_hardwood_out = vec3(0.0);
    mx_image_color3(image_hardwood_file, image_hardwood_layer, image_hardwood_default, geomprop_UV0_out1, image_hardwood_uaddressmode, image_hardwood_vaddressmode, image_hardwood_filtertype, image_hardwood_framerange, image_hardwood_frameoffset, image_hardwood_frameendaction, image_hardwood_uv_scale, image_hardwood_uv_offset, image_hardwood_out);
    vec3 height_map1_hardwood_out = vec3(0.0);
    adsk_NG_adsk_height_map(height_map1_hardwood_file, height_map1_hardwood_realworld_offset, height_map1_hardwood_realworld_scale, height_map1_hardwood_uv_offset, height_map1_hardwood_uv_scale, height_map1_hardwood_rotation_angle, height_map1_hardwood_depth, height_map1_hardwood_uaddressmode, height_map1_hardwood_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, height_map1_hardwood_out);
    surfaceshader SR_legacy_hardwood_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_legacy_hardwood(image_hardwood_out, SR_legacy_hardwood_stain_enable, SR_legacy_hardwood_stain_color, SR_legacy_hardwood_finish, SR_legacy_hardwood_used_for, SR_legacy_hardwood_tint_enable, SR_legacy_hardwood_tint_color, SR_legacy_hardwood_relief_pattern_enable, SR_legacy_hardwood_relief_pattern_type, SR_legacy_hardwood_relief_pattern_auto_amount, height_map1_hardwood_out, geomprop_Nworld_out1, SR_legacy_hardwood_out);
    material M_legacy_hardwood_out = SR_legacy_hardwood_out;
    out1 = vec4(M_legacy_hardwood_out.color, 1.0);
}
