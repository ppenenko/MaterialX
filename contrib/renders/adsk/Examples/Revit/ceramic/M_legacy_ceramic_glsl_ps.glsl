...
uniform sampler2D height_map3_ceramic_file;
uniform vec2 height_map3_ceramic_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 height_map3_ceramic_realworld_scale = vec2(1.000000, 1.000000);
uniform vec2 height_map3_ceramic_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 height_map3_ceramic_uv_scale = vec2(1.000000, 1.000000);
uniform float height_map3_ceramic_rotation_angle = 0.000000;
uniform float height_map3_ceramic_depth = 1.000000;
uniform int height_map3_ceramic_uaddressmode = 2;
uniform int height_map3_ceramic_vaddressmode = 2;
uniform sampler2D height_map1_ceramic_file;
uniform vec2 height_map1_ceramic_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 height_map1_ceramic_realworld_scale = vec2(1.000000, 1.000000);
uniform vec2 height_map1_ceramic_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 height_map1_ceramic_uv_scale = vec2(1.000000, 1.000000);
uniform float height_map1_ceramic_rotation_angle = 0.000000;
uniform float height_map1_ceramic_depth = 1.000000;
uniform int height_map1_ceramic_uaddressmode = 2;
uniform int height_map1_ceramic_vaddressmode = 2;
uniform vec3 SR_legacy_ceramic_color = vec3(0.750000, 0.550000, 0.650000);
uniform bool SR_legacy_ceramic_tint_enable = false;
uniform vec3 SR_legacy_ceramic_tint_color = vec3(0.500000, 0.500000, 0.950000);
uniform int SR_legacy_ceramic_type = 0;
uniform int SR_legacy_ceramic_finish = 1;
uniform bool SR_legacy_ceramic_finish_bump_enable = false;
uniform int SR_legacy_ceramic_finish_bump = 0;
uniform bool SR_legacy_ceramic_relief_pattern_enable = false;
...
void NG_legacy_ceramic(vec3 color, bool tint_enable, vec3 tint_color, int type, int finish, bool finish_bump_enable, int finish_bump, vec3 normal_custom_finish, vec3 normal_wavy_finish, bool relief_pattern_enable, vec3 normal_relief_pattern, out surfaceshader out1)
{
    vec3 tint_mult_out = color * tint_color;
    float switch_rough_out = 0.0;
    NG_switch_floatI(0.150000, 0.300000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, type, switch_rough_out);
    float switch_type_out = 0.0;
    NG_switch_floatI(0.030000, 0.060000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, type, switch_type_out);
    float switch_ior_out = 0.0;
    NG_switch_floatI(1.300000, 1.500000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, type, switch_ior_out);
    vec3 geomprop_Nworld_out1 = normalize(vd.normalWorld);
    vec3 switch_normal_out = vec3(0.0);
    NG_switch_vector3I(normal_wavy_finish, normal_custom_finish, vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), finish_bump, switch_normal_out);
    ...
    NG_switch_floatI(switch_type_out, 0.150000, 0.500000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, finish, switch_coat_out);
    ...
    const bool bump_enable_select_value2_tmp = true;
    vec3 bump_enable_select_out = (finish_bump_enable == bump_enable_select_value2_tmp) ? switch_normal_out : normalmap2_out;
    surfaceshader standard_surface_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(1.000000, tint_selection_out, 0.000000, 0.000000, 1.000000, vec3(1.000000, 1.000000, 1.000000), switch_rough_out, 1.500000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.000000, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 1.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, 1.000000, vec3(1.000000, 1.000000, 1.000000), switch_coat_out, 0.000000, 0.000000, switch_ior_out, geomprop_Nworld_out1, 0.000000, 0.000000, 0.000000, 1.500000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), false, bump_enable_select_out, geomprop_Tworld_out1, standard_surface_out);
...
void main()
{
    ...
    vec3 geomprop_Tworld_out1 = normalize(vd.tangentWorld);
    vec3 height_map3_ceramic_out = vec3(0.0);
    adsk_NG_adsk_height_map(height_map3_ceramic_file, height_map3_ceramic_realworld_offset, height_map3_ceramic_realworld_scale, height_map3_ceramic_uv_offset, height_map3_ceramic_uv_scale, height_map3_ceramic_rotation_angle, height_map3_ceramic_depth, height_map3_ceramic_uaddressmode, height_map3_ceramic_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, height_map3_ceramic_out);
    vec3 height_map1_ceramic_out = vec3(0.0);
    adsk_NG_adsk_height_map(height_map1_ceramic_file, height_map1_ceramic_realworld_offset, height_map1_ceramic_realworld_scale, height_map1_ceramic_uv_offset, height_map1_ceramic_uv_scale, height_map1_ceramic_rotation_angle, height_map1_ceramic_depth, height_map1_ceramic_uaddressmode, height_map1_ceramic_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, height_map1_ceramic_out);
    surfaceshader SR_legacy_ceramic_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_legacy_ceramic(SR_legacy_ceramic_color, SR_legacy_ceramic_tint_enable, SR_legacy_ceramic_tint_color, SR_legacy_ceramic_type, SR_legacy_ceramic_finish, SR_legacy_ceramic_finish_bump_enable, SR_legacy_ceramic_finish_bump, height_map3_ceramic_out, geomprop_Nworld_out1, SR_legacy_ceramic_relief_pattern_enable, height_map1_ceramic_out, SR_legacy_ceramic_out);
    material M_legacy_ceramic_out = SR_legacy_ceramic_out;
    out1 = vec4(M_legacy_ceramic_out.color, 1.0);
}
