...
uniform vec3 SR_legacy_mirror_color = vec3(0.980000, 0.980000, 0.980000);
uniform bool SR_legacy_mirror_tint_enable = true;
uniform vec3 SR_legacy_mirror_tint_color = vec3(0.950000, 0.500000, 0.500000);
...
void NG_legacy_mirror(vec3 color, bool tint_enable, vec3 tint_color, out surfaceshader out1)
{
    ...
    NG_standard_surface_surfaceshader_100(1.000000, tint_selection_out, 0.000000, 1.000000, 1.000000, vec3(1.000000, 1.000000, 1.000000), 0.000000, 1.500000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.000000, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 1.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.100000, 0.000000, 0.000000, 1.500000, geomprop_Nworld_out1, 0.000000, 0.000000, 0.000000, 1.500000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), false, geomprop_Nworld_out1, geomprop_Tworld_out1, standard_surface_out);
    out1 = standard_surface_out;
}

void main()
{
    surfaceshader SR_legacy_mirror_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_legacy_mirror(SR_legacy_mirror_color, SR_legacy_mirror_tint_enable, SR_legacy_mirror_tint_color, SR_legacy_mirror_out);
    material M_legacy_mirror_out = SR_legacy_mirror_out;
    out1 = vec4(M_legacy_mirror_out.color, 1.0);
}
