...
uniform sampler2D height_map1_water_file;
uniform vec2 height_map1_water_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 height_map1_water_realworld_scale = vec2(0.100000, 0.100000);
uniform vec2 height_map1_water_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 height_map1_water_uv_scale = vec2(1.000000, 1.000000);
uniform float height_map1_water_rotation_angle = 0.000000;
uniform float height_map1_water_depth = 0.500000;
uniform int height_map1_water_uaddressmode = 2;
uniform int height_map1_water_vaddressmode = 2;
uniform sampler2D height_map_water_file;
uniform vec2 height_map_water_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 height_map_water_realworld_scale = vec2(0.100000, 0.100000);
uniform vec2 height_map_water_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 height_map_water_uv_scale = vec2(1.000000, 1.000000);
uniform float height_map_water_rotation_angle = 0.000000;
uniform float height_map_water_depth = 0.500000;
uniform int height_map_water_uaddressmode = 2;
uniform int height_map_water_vaddressmode = 2;
uniform sampler2D height_map2_water_file;
uniform vec2 height_map2_water_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 height_map2_water_realworld_scale = vec2(0.100000, 0.100000);
uniform vec2 height_map2_water_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 height_map2_water_uv_scale = vec2(1.000000, 1.000000);
uniform float height_map2_water_rotation_angle = 0.000000;
uniform float height_map2_water_depth = 0.500000;
uniform int height_map2_water_uaddressmode = 2;
uniform int height_map2_water_vaddressmode = 2;
uniform int SR_legacy_water_type = 2;
uniform bool SR_legacy_water_test_sRGB = false;
uniform int SR_legacy_water_secondary_color = 7;
uniform vec3 SR_legacy_water_custom_color = vec3(0.100000, 0.100000, 0.950000);
uniform bool SR_legacy_water_tint_enable = false;
uniform vec3 SR_legacy_water_tint_color = vec3(0.950000, 0.500000, 0.500000);
...
void NG_legacy_water(int type, bool test_sRGB, int secondary_color, vec3 custom_color, bool tint_enable, vec3 tint_color, vec3 normal_swimming_pool, vec3 normal_generic_refl_pool, vec3 normal_generic_stream, vec3 normal_generic_pond, vec3 normal_generic_sea, out surfaceshader out1)
{
    float convert_seccol_float_out = float(secondary_color);
    float type_water_transmission_out = 0.0;
    NG_switch_floatI(0.900000, 0.850000, 0.600000, 0.400000, 0.400000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, type, type_water_transmission_out);
    vec3 geomprop_Nworld_out1 = normalize(vd.normalWorld);
    vec3 type_bump_map_out = vec3(0.0);
    NG_switch_vector3I(normal_swimming_pool, normal_generic_refl_pool, normal_generic_stream, normal_generic_pond, normal_generic_sea, vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), type, type_bump_map_out);
    vec3 geomprop_Tworld_out1 = normalize(vd.tangentWorld);
    const float modulo_sec_color_in2_tmp = 5.000000;
    float modulo_sec_color_out = mx_mod(convert_seccol_float_out, modulo_sec_color_in2_tmp);
    const float divide_sec_color_in2_tmp = 5.000000;
    float divide_sec_color_out = convert_seccol_float_out / divide_sec_color_in2_tmp;
    vec3 switch_sec_color1_out = vec3(0.0);
    NG_switch_color3(vec3(0.416000, 0.953000, 0.847000), vec3(0.675000, 0.686000, 0.557000), vec3(0.050000, 0.149000, 0.243000), vec3(0.050000, 0.149000, 0.243000), vec3(0.459000, 0.435000, 0.192000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), modulo_sec_color_out, switch_sec_color1_out);
    vec3 switch_sec_color2_out = vec3(0.0);
    NG_switch_color3(vec3(0.145000, 0.161000, 0.067000), vec3(0.145000, 0.161000, 0.067000), custom_color, vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), modulo_sec_color_out, switch_sec_color2_out);
    vec3 switch_sec_color_out = vec3(0.0);
    NG_switch_color3(switch_sec_color1_out, switch_sec_color2_out, vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), divide_sec_color_out, switch_sec_color_out);
    vec3 type_water_color_out = vec3(0.0);
    NG_switch_color3I(vec3(0.415000, 0.952000, 0.847000), vec3(0.865000, 0.910000, 0.866000), switch_sec_color_out, switch_sec_color_out, switch_sec_color_out, vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), type, type_water_color_out);
    vec3 srgb_texture_to_lin_rec709_color3_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(type_water_color_out, srgb_texture_to_lin_rec709_color3_out);
    const bool test_srgb_value2_tmp = true;
    vec3 test_srgb_out = (test_sRGB == test_srgb_value2_tmp) ? srgb_texture_to_lin_rec709_color3_out : type_water_color_out;
    vec3 tint_mult_out = test_srgb_out * tint_color;
    const bool tint_selection_value2_tmp = true;
    vec3 tint_selection_out = (tint_enable == tint_selection_value2_tmp) ? tint_mult_out : test_srgb_out;
    surfaceshader standard_surface_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(1.000000, tint_selection_out, 0.000000, 0.000000, 1.000000, vec3(1.000000, 1.000000, 1.000000), 0.030000, 1.330000, 0.000000, 0.000000, type_water_transmission_out, tint_selection_out, 0.000000, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 1.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.100000, 0.000000, 0.000000, 1.500000, geomprop_Nworld_out1, 0.000000, 0.000000, 0.000000, 1.500000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), false, type_bump_map_out, geomprop_Tworld_out1, standard_surface_out);
...
void main()
{
    ...
    vec3 geomprop_Nworld_out1 = normalize(vd.normalWorld);
    vec3 geomprop_Tworld_out1 = normalize(vd.tangentWorld);
    vec3 height_map1_water_out = vec3(0.0);
    adsk_NG_adsk_height_map(height_map1_water_file, height_map1_water_realworld_offset, height_map1_water_realworld_scale, height_map1_water_uv_offset, height_map1_water_uv_scale, height_map1_water_rotation_angle, height_map1_water_depth, height_map1_water_uaddressmode, height_map1_water_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, height_map1_water_out);
    vec3 height_map_water_out = vec3(0.0);
    adsk_NG_adsk_height_map(height_map_water_file, height_map_water_realworld_offset, height_map_water_realworld_scale, height_map_water_uv_offset, height_map_water_uv_scale, height_map_water_rotation_angle, height_map_water_depth, height_map_water_uaddressmode, height_map_water_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, height_map_water_out);
    vec3 height_map2_water_out = vec3(0.0);
    adsk_NG_adsk_height_map(height_map2_water_file, height_map2_water_realworld_offset, height_map2_water_realworld_scale, height_map2_water_uv_offset, height_map2_water_uv_scale, height_map2_water_rotation_angle, height_map2_water_depth, height_map2_water_uaddressmode, height_map2_water_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, height_map2_water_out);
    surfaceshader SR_legacy_water_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_legacy_water(SR_legacy_water_type, SR_legacy_water_test_sRGB, SR_legacy_water_secondary_color, SR_legacy_water_custom_color, SR_legacy_water_tint_enable, SR_legacy_water_tint_color, height_map1_water_out, height_map_water_out, height_map1_water_out, height_map_water_out, height_map2_water_out, SR_legacy_water_out);
    material M_legacy_water_out = SR_legacy_water_out;
    float outAlpha = clamp(1.0 - dot(M_legacy_water_out.transparency, vec3(0.3333)), 0.0, 1.0);
    out1 = vec4(M_legacy_water_out.color, outAlpha);
