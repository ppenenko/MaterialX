...
uniform int SR_legacy_glazing_color = 6;
uniform vec3 SR_legacy_glazing_custom_color = vec3(0.990000, 0.000000, 0.000000);
uniform bool SR_legacy_glazing_test_sRGB = false;
uniform float SR_legacy_glazing_reflectance = 0.120000;
uniform float SR_legacy_glazing_reflection_color = 1.000000;
uniform int SR_legacy_glazing_sheets_of_glass = 1;
uniform bool SR_legacy_glazing_tint_enable = false;
uniform vec3 SR_legacy_glazing_tint_color = vec3(0.500000, 0.500000, 0.950000);
...
void NG_legacy_glazing(int color, vec3 custom_color, bool test_sRGB, float reflectance, float reflection_color, int sheets_of_glass, bool tint_enable, vec3 tint_color, out surfaceshader out1)
{
    ...
    const vec3 refl_color_mix_bg_tmp = vec3(1.000000, 1.000000, 1.000000);
    vec3 refl_color_mix_out = mix(refl_color_mix_bg_tmp, tint_selection_out, reflection_color);
    surfaceshader standard_surface_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(1.000000, refl_color_mix_out, 0.000000, metallic_component_out, 1.000000, refl_color_mix_out, 0.000000, 1.500000, 0.000000, 0.000000, 1.000000, tint_selection_out, 0.000000, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 1.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.100000, 0.000000, 0.000000, 1.500000, geomprop_Nworld_out1, 0.000000, 0.000000, 0.000000, 1.500000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), true, geomprop_Nworld_out1, geomprop_Tworld_out1, standard_surface_out);
    out1 = standard_surface_out;
}

void main()
{
    surfaceshader SR_legacy_glazing_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_legacy_glazing(SR_legacy_glazing_color, SR_legacy_glazing_custom_color, SR_legacy_glazing_test_sRGB, SR_legacy_glazing_reflectance, SR_legacy_glazing_reflection_color, SR_legacy_glazing_sheets_of_glass, SR_legacy_glazing_tint_enable, SR_legacy_glazing_tint_color, SR_legacy_glazing_out);
    material M_legacy_glazing_out = SR_legacy_glazing_out;
    float outAlpha = clamp(1.0 - dot(M_legacy_glazing_out.transparency, vec3(0.3333)), 0.0, 1.0);
    out1 = vec4(M_legacy_glazing_out.color, outAlpha);
