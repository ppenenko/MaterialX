...
uniform vec2 test_uv_mult_in1 = vec2(1.000000, 1.000000);
uniform float test_uv_mult_in2 = 10.000000;
uniform sampler2D roller_map_file;
uniform vec2 roller_map_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 roller_map_realworld_scale = vec2(1.000000, 1.000000);
uniform vec2 roller_map_uv_offset = vec2(0.000000, 0.000000);
uniform float roller_map_rotation_angle = 0.000000;
uniform float roller_map_depth = 1.000000;
uniform int roller_map_uaddressmode = 2;
uniform int roller_map_vaddressmode = 2;
uniform sampler2D brush_map_file;
uniform vec2 brush_map_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 brush_map_realworld_scale = vec2(1.000000, 1.000000);
uniform vec2 brush_map_uv_offset = vec2(0.000000, 0.000000);
uniform float brush_map_rotation_angle = 0.000000;
uniform float brush_map_depth = 1.000000;
uniform int brush_map_uaddressmode = 2;
uniform int brush_map_vaddressmode = 2;
uniform sampler2D spray_map_file;
uniform vec2 spray_map_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 spray_map_realworld_scale = vec2(1.000000, 1.000000);
uniform vec2 spray_map_uv_offset = vec2(0.000000, 0.000000);
uniform float spray_map_rotation_angle = 0.000000;
uniform float spray_map_depth = 1.000000;
uniform int spray_map_uaddressmode = 2;
uniform int spray_map_vaddressmode = 2;
uniform vec3 SR_legacy_wallpaint_color = vec3(0.100000, 0.900000, 0.100000);
uniform int SR_legacy_wallpaint_finish = 1;
uniform int SR_legacy_wallpaint_application = 0;
uniform bool SR_legacy_wallpaint_tint_enable = false;
uniform vec3 SR_legacy_wallpaint_tint_color = vec3(0.950000, 0.500000, 0.500000);
...
void NG_legacy_wallpaint(vec3 color, int finish, int application, bool tint_enable, vec3 tint_color, vec3 normal_roller, vec3 normal_brush, vec3 normal_spray, out surfaceshader out1)
{
    vec3 tint_mult_out = color * tint_color;
    float convert_finish_float_out = float(finish);
    vec3 geomprop_Nworld_out1 = normalize(vd.normalWorld);
    vec3 switch_application_out = vec3(0.0);
    NG_switch_vector3I(normal_roller, normal_brush, normal_spray, vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), application, switch_application_out);
    ...
    const float modulo_rough_in2_tmp = 5.000000;
    float modulo_rough_out = mx_mod(convert_finish_float_out, modulo_rough_in2_tmp);
    const float divide_rough_in2_tmp = 5.000000;
    float divide_rough_out = convert_finish_float_out / divide_rough_in2_tmp;
    float roughness_amount1_out = 0.0;
    NG_switch_float(0.600000, 0.450000, 0.350000, 0.200000, 0.100000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, modulo_rough_out, roughness_amount1_out);
    float roughness_amount2_out = 0.0;
    NG_switch_float(0.050000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, modulo_rough_out, roughness_amount2_out);
    float roughness_amount_out = 0.0;
    NG_switch_float(roughness_amount1_out, roughness_amount2_out, 0.400000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, divide_rough_out, roughness_amount_out);
    surfaceshader standard_surface_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(1.000000, tint_selection_out, 0.000000, 0.000000, 1.000000, vec3(1.000000, 1.000000, 1.000000), roughness_amount_out, 1.460000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.000000, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 1.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.100000, 0.000000, 0.000000, 1.500000, geomprop_Nworld_out1, 0.000000, 0.000000, 0.000000, 1.500000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), false, switch_application_out, geomprop_Tworld_out1, standard_surface_out);
...
void main()
{
    ...
    vec3 geomprop_Nworld_out1 = normalize(vd.normalWorld);
    vec3 geomprop_Tworld_out1 = normalize(vd.tangentWorld);
    vec2 test_uv_mult_out = test_uv_mult_in1 * test_uv_mult_in2;
    vec3 roller_map_out = vec3(0.0);
    adsk_NG_adsk_height_map(roller_map_file, roller_map_realworld_offset, roller_map_realworld_scale, roller_map_uv_offset, test_uv_mult_out, roller_map_rotation_angle, roller_map_depth, roller_map_uaddressmode, roller_map_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, roller_map_out);
    vec3 brush_map_out = vec3(0.0);
    adsk_NG_adsk_height_map(brush_map_file, brush_map_realworld_offset, brush_map_realworld_scale, brush_map_uv_offset, test_uv_mult_out, brush_map_rotation_angle, brush_map_depth, brush_map_uaddressmode, brush_map_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, brush_map_out);
    vec3 spray_map_out = vec3(0.0);
    adsk_NG_adsk_height_map(spray_map_file, spray_map_realworld_offset, spray_map_realworld_scale, spray_map_uv_offset, test_uv_mult_out, spray_map_rotation_angle, spray_map_depth, spray_map_uaddressmode, spray_map_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, spray_map_out);
    surfaceshader SR_legacy_wallpaint_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_legacy_wallpaint(SR_legacy_wallpaint_color, SR_legacy_wallpaint_finish, SR_legacy_wallpaint_application, SR_legacy_wallpaint_tint_enable, SR_legacy_wallpaint_tint_color, roller_map_out, brush_map_out, spray_map_out, SR_legacy_wallpaint_out);
    material M_legacy_wallpaint_out = SR_legacy_wallpaint_out;
    out1 = vec4(M_legacy_wallpaint_out.color, 1.0);
}
