...
uniform sampler2D height_map1_plastic_file;
uniform vec2 height_map1_plastic_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 height_map1_plastic_realworld_scale = vec2(1.000000, 1.000000);
uniform vec2 height_map1_plastic_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 height_map1_plastic_uv_scale = vec2(1.000000, 1.000000);
uniform float height_map1_plastic_rotation_angle = 0.000000;
uniform float height_map1_plastic_depth = 1.000000;
uniform int height_map1_plastic_uaddressmode = 2;
uniform int height_map1_plastic_vaddressmode = 2;
uniform sampler2D height_map2_plastic_file;
uniform vec2 height_map2_plastic_realworld_offset = vec2(0.000000, 0.000000);
uniform vec2 height_map2_plastic_realworld_scale = vec2(1.000000, 1.000000);
uniform vec2 height_map2_plastic_uv_offset = vec2(0.000000, 0.000000);
uniform vec2 height_map2_plastic_uv_scale = vec2(1.000000, 1.000000);
uniform float height_map2_plastic_rotation_angle = 0.000000;
uniform float height_map2_plastic_depth = 1.000000;
uniform int height_map2_plastic_uaddressmode = 2;
uniform int height_map2_plastic_vaddressmode = 2;
uniform int SR_legacy_plastic_type = 1;
uniform vec3 SR_legacy_plastic_color = vec3(0.430000, 0.070000, 0.070000);
uniform int SR_legacy_plastic_finish = 0;
uniform bool SR_legacy_plastic_tint_enable = false;
uniform vec3 SR_legacy_plastic_tint_color = vec3(0.950000, 0.500000, 0.500000);
uniform bool SR_legacy_plastic_finish_bump_enable = false;
uniform bool SR_legacy_plastic_relief_pattern_enable = false;
...
void NG_legacy_plastic(int type, vec3 color, int finish, bool tint_enable, vec3 tint_color, bool finish_bump_enable, vec3 normal_finish_bump, bool relief_pattern_enable, vec3 normal_relief_pattern, out surfaceshader out1)
{
    vec3 tint_mult_out = color * tint_color;
    float roughness_amount_out = 0.0;
    NG_switch_floatI(0.010000, 0.050000, 0.200000, 0.500000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, finish, roughness_amount_out);
    float transmission_amount_out = 0.0;
    NG_switch_floatI(0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, type, transmission_amount_out);
    ...
    vec3 surface_color_out = vec3(0.0);
    NG_switch_color3I(tint_selection_out, tint_selection_out, tint_selection_out, vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), type, surface_color_out);
    vec3 transmission_color_out = vec3(0.0);
    NG_switch_color3I(vec3(1.000000, 1.000000, 1.000000), tint_selection_out, vec3(1.000000, 1.000000, 1.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), vec3(0.000000, 0.000000, 0.000000), type, transmission_color_out);
    const bool finish_bump_selection_value2_tmp = true;
    vec3 finish_bump_selection_out = (finish_bump_enable == finish_bump_selection_value2_tmp) ? normal_finish_bump : normalmap_out;
    surfaceshader standard_surface_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(1.000000, surface_color_out, 0.000000, 0.000000, 1.000000, vec3(1.000000, 1.000000, 1.000000), roughness_amount_out, 1.460000, 0.000000, 0.000000, transmission_amount_out, transmission_color_out, 0.000000, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 1.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.100000, 0.000000, 0.000000, 1.500000, geomprop_Nworld_out1, 0.000000, 0.000000, 0.000000, 1.500000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), false, finish_bump_selection_out, geomprop_Tworld_out1, standard_surface_out);
...
void main()
{
    ...
    vec3 geomprop_Nworld_out1 = normalize(vd.normalWorld);
    vec3 geomprop_Tworld_out1 = normalize(vd.tangentWorld);
    vec3 height_map1_plastic_out = vec3(0.0);
    adsk_NG_adsk_height_map(height_map1_plastic_file, height_map1_plastic_realworld_offset, height_map1_plastic_realworld_scale, height_map1_plastic_uv_offset, height_map1_plastic_uv_scale, height_map1_plastic_rotation_angle, height_map1_plastic_depth, height_map1_plastic_uaddressmode, height_map1_plastic_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, height_map1_plastic_out);
    vec3 height_map2_plastic_out = vec3(0.0);
    adsk_NG_adsk_height_map(height_map2_plastic_file, height_map2_plastic_realworld_offset, height_map2_plastic_realworld_scale, height_map2_plastic_uv_offset, height_map2_plastic_uv_scale, height_map2_plastic_rotation_angle, height_map2_plastic_depth, height_map2_plastic_uaddressmode, height_map2_plastic_vaddressmode, geomprop_UV0_out1, geomprop_Nworld_out1, geomprop_Tworld_out1, height_map2_plastic_out);
    surfaceshader SR_legacy_plastic_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_legacy_plastic(SR_legacy_plastic_type, SR_legacy_plastic_color, SR_legacy_plastic_finish, SR_legacy_plastic_tint_enable, SR_legacy_plastic_tint_color, SR_legacy_plastic_finish_bump_enable, height_map1_plastic_out, SR_legacy_plastic_relief_pattern_enable, height_map2_plastic_out, SR_legacy_plastic_out);
    material M_legacy_plastic_out = SR_legacy_plastic_out;
    float outAlpha = clamp(1.0 - dot(M_legacy_plastic_out.transparency, vec3(0.3333)), 0.0, 1.0);
    out1 = vec4(M_legacy_plastic_out.color, outAlpha);
