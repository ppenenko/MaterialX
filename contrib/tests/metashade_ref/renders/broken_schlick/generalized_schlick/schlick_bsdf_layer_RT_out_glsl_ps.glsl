...
void main()
{
    ...
    surfaceshader surface_layer_RT_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            mx_generalized_schlick_bsdf_broken(closureData, schlick_R_weight, schlick_R_color0, schlick_R_color82, schlick_R_color90, schlick_R_exponent, schlick_R_roughness, schlick_R_retroreflective, schlick_R_thinfilm_thickness, schlick_R_thinfilm_ior, geomprop_Nworld_out1, geomprop_Tworld_out1, schlick_R_distribution, schlick_R_scatter_mode, schlick_R_out);
            BSDF schlick_T_out = BSDF(vec3(0.0),vec3(1.0));
            mx_generalized_schlick_bsdf_broken(closureData, schlick_T_weight, schlick_T_color0, schlick_T_color82, schlick_T_color90, schlick_T_exponent, schlick_T_roughness, schlick_T_retroreflective, schlick_T_thinfilm_thickness, schlick_T_thinfilm_ior, geomprop_Nworld_out1, geomprop_Tworld_out1, schlick_T_distribution, schlick_T_scatter_mode, schlick_T_out);
