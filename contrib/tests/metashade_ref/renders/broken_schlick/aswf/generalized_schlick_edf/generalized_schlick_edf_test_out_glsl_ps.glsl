...
uniform vec3 uniform_edf_1_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 generalized_schlick_edf_1_color0 = vec3(0.100000, 1.000000, 0.100000);
uniform vec3 generalized_schlick_edf_1_color90 = vec3(1.000000, 0.100000, 0.200000);
uniform float generalized_schlick_edf_1_exponent = 3.000000;
...
void main()
{
    surfaceshader surface1_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add surface emission
        {
            ...
            EDF uniform_edf_1_out = EDF(0.0);
            mx_uniform_edf(closureData, uniform_edf_1_color, uniform_edf_1_out);
            EDF generalized_schlick_edf_1_out = EDF(0.0);
            mx_generalized_schlick_edf(closureData, generalized_schlick_edf_1_color0, generalized_schlick_edf_1_color90, generalized_schlick_edf_1_exponent, uniform_edf_1_out, generalized_schlick_edf_1_out);
            surface1_out.color += generalized_schlick_edf_1_out;
        }
