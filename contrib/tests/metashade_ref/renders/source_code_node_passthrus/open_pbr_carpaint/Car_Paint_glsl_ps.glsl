...
uniform vec3 open_pbr_surface_surfaceshader_base_color = vec3(0.100000, 0.600000, 0.900000);
...
uniform float open_pbr_surface_surfaceshader_specular_roughness = 0.300000;
uniform float open_pbr_surface_surfaceshader_specular_ior = 1.600000;
...
uniform float open_pbr_surface_surfaceshader_coat_roughness = 0.020000;
...
void main()
{
    ...
    material Car_Paint_out = open_pbr_surface_surfaceshader_out;
