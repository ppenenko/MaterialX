...
uniform vec2 tiledcloverleafs_color3_uvtiling = vec2(29.000000, 29.000000);
uniform vec2 tiledcloverleafs_color3_uvoffset = vec2(0.000000, 0.000000);
uniform float tiledcloverleafs_color3_size = 0.800000;
uniform bool tiledcloverleafs_color3_staggered = false;
uniform float SR_test_tiledcloverleafs_base = 1.000000;
uniform float SR_test_tiledcloverleafs_diffuse_roughness = 0.000000;
uniform float SR_test_tiledcloverleafs_metalness = 0.000000;
uniform float SR_test_tiledcloverleafs_specular = 1.000000;
uniform vec3 SR_test_tiledcloverleafs_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_tiledcloverleafs_specular_roughness = 0.200000;
uniform float SR_test_tiledcloverleafs_specular_IOR = 1.500000;
uniform float SR_test_tiledcloverleafs_specular_anisotropy = 0.000000;
uniform float SR_test_tiledcloverleafs_specular_rotation = 0.000000;
uniform float SR_test_tiledcloverleafs_transmission = 0.000000;
uniform vec3 SR_test_tiledcloverleafs_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_tiledcloverleafs_transmission_depth = 0.000000;
uniform vec3 SR_test_tiledcloverleafs_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_test_tiledcloverleafs_transmission_scatter_anisotropy = 0.000000;
uniform float SR_test_tiledcloverleafs_transmission_dispersion = 0.000000;
uniform float SR_test_tiledcloverleafs_transmission_extra_roughness = 0.000000;
uniform float SR_test_tiledcloverleafs_subsurface = 0.000000;
uniform vec3 SR_test_tiledcloverleafs_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_test_tiledcloverleafs_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_tiledcloverleafs_subsurface_scale = 1.000000;
uniform float SR_test_tiledcloverleafs_subsurface_anisotropy = 0.000000;
uniform float SR_test_tiledcloverleafs_sheen = 0.000000;
uniform vec3 SR_test_tiledcloverleafs_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_tiledcloverleafs_sheen_roughness = 0.300000;
uniform float SR_test_tiledcloverleafs_coat = 0.000000;
uniform vec3 SR_test_tiledcloverleafs_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_tiledcloverleafs_coat_roughness = 0.100000;
uniform float SR_test_tiledcloverleafs_coat_anisotropy = 0.000000;
uniform float SR_test_tiledcloverleafs_coat_rotation = 0.000000;
uniform float SR_test_tiledcloverleafs_coat_IOR = 1.500000;
uniform float SR_test_tiledcloverleafs_coat_affect_color = 0.000000;
uniform float SR_test_tiledcloverleafs_coat_affect_roughness = 0.000000;
uniform float SR_test_tiledcloverleafs_thin_film_thickness = 0.000000;
uniform float SR_test_tiledcloverleafs_thin_film_IOR = 1.500000;
uniform float SR_test_tiledcloverleafs_emission = 0.000000;
uniform vec3 SR_test_tiledcloverleafs_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_test_tiledcloverleafs_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool SR_test_tiledcloverleafs_thin_walled = false;
...
void main()
{
    ...
    vec3 tiledcloverleafs_color3_out = vec3(0.0);
    NG_tiledcloverleafs_color3(geomprop_UV0_out1, tiledcloverleafs_color3_uvtiling, tiledcloverleafs_color3_uvoffset, tiledcloverleafs_color3_size, tiledcloverleafs_color3_staggered, tiledcloverleafs_color3_out);
    surfaceshader SR_test_tiledcloverleafs_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(SR_test_tiledcloverleafs_base, tiledcloverleafs_color3_out, SR_test_tiledcloverleafs_diffuse_roughness, SR_test_tiledcloverleafs_metalness, SR_test_tiledcloverleafs_specular, SR_test_tiledcloverleafs_specular_color, SR_test_tiledcloverleafs_specular_roughness, SR_test_tiledcloverleafs_specular_IOR, SR_test_tiledcloverleafs_specular_anisotropy, SR_test_tiledcloverleafs_specular_rotation, SR_test_tiledcloverleafs_transmission, SR_test_tiledcloverleafs_transmission_color, SR_test_tiledcloverleafs_transmission_depth, SR_test_tiledcloverleafs_transmission_scatter, SR_test_tiledcloverleafs_transmission_scatter_anisotropy, SR_test_tiledcloverleafs_transmission_dispersion, SR_test_tiledcloverleafs_transmission_extra_roughness, SR_test_tiledcloverleafs_subsurface, SR_test_tiledcloverleafs_subsurface_color, SR_test_tiledcloverleafs_subsurface_radius, SR_test_tiledcloverleafs_subsurface_scale, SR_test_tiledcloverleafs_subsurface_anisotropy, SR_test_tiledcloverleafs_sheen, SR_test_tiledcloverleafs_sheen_color, SR_test_tiledcloverleafs_sheen_roughness, SR_test_tiledcloverleafs_coat, SR_test_tiledcloverleafs_coat_color, SR_test_tiledcloverleafs_coat_roughness, SR_test_tiledcloverleafs_coat_anisotropy, SR_test_tiledcloverleafs_coat_rotation, SR_test_tiledcloverleafs_coat_IOR, geomprop_Nworld_out1, SR_test_tiledcloverleafs_coat_affect_color, SR_test_tiledcloverleafs_coat_affect_roughness, SR_test_tiledcloverleafs_thin_film_thickness, SR_test_tiledcloverleafs_thin_film_IOR, SR_test_tiledcloverleafs_emission, SR_test_tiledcloverleafs_emission_color, SR_test_tiledcloverleafs_opacity, SR_test_tiledcloverleafs_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, SR_test_tiledcloverleafs_out);
    material test_tiledcloverleafs_out = SR_test_tiledcloverleafs_out;
    out1 = vec4(test_tiledcloverleafs_out.color, 1.0);
}
