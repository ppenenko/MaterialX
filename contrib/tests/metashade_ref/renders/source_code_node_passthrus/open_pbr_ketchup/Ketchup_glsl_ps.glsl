...
uniform vec3 open_pbr_surface_surfaceshader_base_color = vec3(0.164000, 0.006000, 0.002000);
...
uniform float open_pbr_surface_surfaceshader_specular_ior = 1.300000;
...
uniform vec3 open_pbr_surface_surfaceshader_subsurface_color = vec3(0.164000, 0.006000, 0.002000);
uniform float open_pbr_surface_surfaceshader_subsurface_radius = 1.000000;
uniform vec3 open_pbr_surface_surfaceshader_subsurface_radius_scale = vec3(0.476000, 0.058000, 0.039000);
...
void main()
{
    ...
    material Ketchup_out = open_pbr_surface_surfaceshader_out;
    out1 = vec4(Ketchup_out.color, 1.0);
}
