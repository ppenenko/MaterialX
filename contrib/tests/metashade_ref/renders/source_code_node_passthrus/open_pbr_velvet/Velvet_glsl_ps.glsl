...
uniform vec3 open_pbr_surface_surfaceshader_base_color = vec3(0.020000, 0.020000, 0.020000);
...
uniform float open_pbr_surface_surfaceshader_specular_roughness = 0.800000;
...
uniform float open_pbr_surface_surfaceshader_fuzz_weight = 1.000000;
uniform vec3 open_pbr_surface_surfaceshader_fuzz_color = vec3(0.400000, 0.400000, 0.400000);
...
void main()
{
    ...
    material Velvet_out = open_pbr_surface_surfaceshader_out;
