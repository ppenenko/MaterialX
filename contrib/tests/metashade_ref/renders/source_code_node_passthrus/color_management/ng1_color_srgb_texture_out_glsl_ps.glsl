...
uniform vec4 color_srgb_texture_value_cm_in = vec4(0.500000, 0.000000, 0.000000, 1.000000);
uniform float color_srgb_texture_standard_surface6_base = 1.000000;
uniform float color_srgb_texture_standard_surface6_diffuse_roughness = 0.000000;
uniform float color_srgb_texture_standard_surface6_metalness = 0.000000;
uniform float color_srgb_texture_standard_surface6_specular = 1.000000;
uniform vec3 color_srgb_texture_standard_surface6_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_srgb_texture_standard_surface6_specular_roughness = 0.200000;
uniform float color_srgb_texture_standard_surface6_specular_IOR = 1.500000;
uniform float color_srgb_texture_standard_surface6_specular_anisotropy = 0.000000;
uniform float color_srgb_texture_standard_surface6_specular_rotation = 0.000000;
uniform float color_srgb_texture_standard_surface6_transmission = 0.000000;
uniform vec3 color_srgb_texture_standard_surface6_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_srgb_texture_standard_surface6_transmission_depth = 0.000000;
uniform vec3 color_srgb_texture_standard_surface6_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float color_srgb_texture_standard_surface6_transmission_scatter_anisotropy = 0.000000;
uniform float color_srgb_texture_standard_surface6_transmission_dispersion = 0.000000;
uniform float color_srgb_texture_standard_surface6_transmission_extra_roughness = 0.000000;
uniform float color_srgb_texture_standard_surface6_subsurface = 0.000000;
uniform vec3 color_srgb_texture_standard_surface6_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 color_srgb_texture_standard_surface6_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float color_srgb_texture_standard_surface6_subsurface_scale = 1.000000;
uniform float color_srgb_texture_standard_surface6_subsurface_anisotropy = 0.000000;
uniform float color_srgb_texture_standard_surface6_sheen = 0.000000;
uniform vec3 color_srgb_texture_standard_surface6_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_srgb_texture_standard_surface6_sheen_roughness = 0.300000;
uniform float color_srgb_texture_standard_surface6_coat = 0.000000;
uniform vec3 color_srgb_texture_standard_surface6_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_srgb_texture_standard_surface6_coat_roughness = 0.100000;
uniform float color_srgb_texture_standard_surface6_coat_anisotropy = 0.000000;
uniform float color_srgb_texture_standard_surface6_coat_rotation = 0.000000;
uniform float color_srgb_texture_standard_surface6_coat_IOR = 1.500000;
uniform float color_srgb_texture_standard_surface6_coat_affect_color = 0.000000;
uniform float color_srgb_texture_standard_surface6_coat_affect_roughness = 0.000000;
uniform float color_srgb_texture_standard_surface6_thin_film_thickness = 0.000000;
uniform float color_srgb_texture_standard_surface6_thin_film_IOR = 1.500000;
uniform float color_srgb_texture_standard_surface6_emission = 0.000000;
uniform vec3 color_srgb_texture_standard_surface6_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 color_srgb_texture_standard_surface6_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool color_srgb_texture_standard_surface6_thin_walled = false;
...
out vec4 color_srgb_texture_out1;
...
void main()
{
    vec4 color_srgb_texture_value_cm_out = vec4(0.0);
    ...
    vec3 color_srgb_texture_color3_out = vec3(0.0);
    NG_convert_color4_color3(color_srgb_texture_value_cm_out, color_srgb_texture_color3_out);
    surfaceshader color_srgb_texture_standard_surface6_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    color_srgb_texture_out1 = vec4(color_srgb_texture_standard_surface6_out.color, 1.0);
}
