...
uniform vec4 color_gamma18_value_cm_in = vec4(0.500000, 0.000000, 0.000000, 1.000000);
uniform float color_gamma18_standard_surface2_base = 1.000000;
uniform float color_gamma18_standard_surface2_diffuse_roughness = 0.000000;
uniform float color_gamma18_standard_surface2_metalness = 0.000000;
uniform float color_gamma18_standard_surface2_specular = 1.000000;
uniform vec3 color_gamma18_standard_surface2_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_gamma18_standard_surface2_specular_roughness = 0.200000;
uniform float color_gamma18_standard_surface2_specular_IOR = 1.500000;
uniform float color_gamma18_standard_surface2_specular_anisotropy = 0.000000;
uniform float color_gamma18_standard_surface2_specular_rotation = 0.000000;
uniform float color_gamma18_standard_surface2_transmission = 0.000000;
uniform vec3 color_gamma18_standard_surface2_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_gamma18_standard_surface2_transmission_depth = 0.000000;
uniform vec3 color_gamma18_standard_surface2_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float color_gamma18_standard_surface2_transmission_scatter_anisotropy = 0.000000;
uniform float color_gamma18_standard_surface2_transmission_dispersion = 0.000000;
uniform float color_gamma18_standard_surface2_transmission_extra_roughness = 0.000000;
uniform float color_gamma18_standard_surface2_subsurface = 0.000000;
uniform vec3 color_gamma18_standard_surface2_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 color_gamma18_standard_surface2_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float color_gamma18_standard_surface2_subsurface_scale = 1.000000;
uniform float color_gamma18_standard_surface2_subsurface_anisotropy = 0.000000;
uniform float color_gamma18_standard_surface2_sheen = 0.000000;
uniform vec3 color_gamma18_standard_surface2_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_gamma18_standard_surface2_sheen_roughness = 0.300000;
uniform float color_gamma18_standard_surface2_coat = 0.000000;
uniform vec3 color_gamma18_standard_surface2_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_gamma18_standard_surface2_coat_roughness = 0.100000;
uniform float color_gamma18_standard_surface2_coat_anisotropy = 0.000000;
uniform float color_gamma18_standard_surface2_coat_rotation = 0.000000;
uniform float color_gamma18_standard_surface2_coat_IOR = 1.500000;
uniform float color_gamma18_standard_surface2_coat_affect_color = 0.000000;
uniform float color_gamma18_standard_surface2_coat_affect_roughness = 0.000000;
uniform float color_gamma18_standard_surface2_thin_film_thickness = 0.000000;
uniform float color_gamma18_standard_surface2_thin_film_IOR = 1.500000;
uniform float color_gamma18_standard_surface2_emission = 0.000000;
uniform vec3 color_gamma18_standard_surface2_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 color_gamma18_standard_surface2_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool color_gamma18_standard_surface2_thin_walled = false;
...
void NG_g18_rec709_to_lin_rec709_color4(vec4 in1, out vec4 out1)
{
...
void main()
{
    vec4 color_gamma18_value_cm_out = vec4(0.0);
    ...
    vec3 color_gamma18_color3_out = vec3(0.0);
    NG_convert_color4_color3(color_gamma18_value_cm_out, color_gamma18_color3_out);
    surfaceshader color_gamma18_standard_surface2_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    color_gamma18_out1 = vec4(color_gamma18_standard_surface2_out.color, 1.0);
}
