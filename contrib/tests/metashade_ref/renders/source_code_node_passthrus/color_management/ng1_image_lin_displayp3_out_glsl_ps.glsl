...
uniform sampler2D image_lin_displayp3_file;
uniform int image_lin_displayp3_layer = 0;
uniform vec3 image_lin_displayp3_default = vec3(0.000000, 0.000000, 0.000000);
uniform int image_lin_displayp3_uaddressmode = 2;
uniform int image_lin_displayp3_vaddressmode = 2;
uniform int image_lin_displayp3_filtertype = 1;
uniform int image_lin_displayp3_framerange = 0;
uniform int image_lin_displayp3_frameoffset = 0;
uniform int image_lin_displayp3_frameendaction = 0;
uniform vec2 image_lin_displayp3_uv_scale = vec2(1.000000, 1.000000);
uniform vec2 image_lin_displayp3_uv_offset = vec2(0.000000, 0.000000);
uniform float image_lin_displayp3_standard_surface10_base = 1.000000;
uniform float image_lin_displayp3_standard_surface10_diffuse_roughness = 0.000000;
uniform float image_lin_displayp3_standard_surface10_metalness = 0.000000;
uniform float image_lin_displayp3_standard_surface10_specular = 1.000000;
uniform vec3 image_lin_displayp3_standard_surface10_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_lin_displayp3_standard_surface10_specular_roughness = 0.200000;
uniform float image_lin_displayp3_standard_surface10_specular_IOR = 1.500000;
uniform float image_lin_displayp3_standard_surface10_specular_anisotropy = 0.000000;
uniform float image_lin_displayp3_standard_surface10_specular_rotation = 0.000000;
uniform float image_lin_displayp3_standard_surface10_transmission = 0.000000;
uniform vec3 image_lin_displayp3_standard_surface10_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_lin_displayp3_standard_surface10_transmission_depth = 0.000000;
uniform vec3 image_lin_displayp3_standard_surface10_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float image_lin_displayp3_standard_surface10_transmission_scatter_anisotropy = 0.000000;
uniform float image_lin_displayp3_standard_surface10_transmission_dispersion = 0.000000;
uniform float image_lin_displayp3_standard_surface10_transmission_extra_roughness = 0.000000;
uniform float image_lin_displayp3_standard_surface10_subsurface = 0.000000;
uniform vec3 image_lin_displayp3_standard_surface10_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_lin_displayp3_standard_surface10_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float image_lin_displayp3_standard_surface10_subsurface_scale = 1.000000;
uniform float image_lin_displayp3_standard_surface10_subsurface_anisotropy = 0.000000;
uniform float image_lin_displayp3_standard_surface10_sheen = 0.000000;
uniform vec3 image_lin_displayp3_standard_surface10_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_lin_displayp3_standard_surface10_sheen_roughness = 0.300000;
uniform float image_lin_displayp3_standard_surface10_coat = 0.000000;
uniform vec3 image_lin_displayp3_standard_surface10_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_lin_displayp3_standard_surface10_coat_roughness = 0.100000;
uniform float image_lin_displayp3_standard_surface10_coat_anisotropy = 0.000000;
uniform float image_lin_displayp3_standard_surface10_coat_rotation = 0.000000;
uniform float image_lin_displayp3_standard_surface10_coat_IOR = 1.500000;
uniform float image_lin_displayp3_standard_surface10_coat_affect_color = 0.000000;
uniform float image_lin_displayp3_standard_surface10_coat_affect_roughness = 0.000000;
uniform float image_lin_displayp3_standard_surface10_thin_film_thickness = 0.000000;
uniform float image_lin_displayp3_standard_surface10_thin_film_IOR = 1.500000;
uniform float image_lin_displayp3_standard_surface10_emission = 0.000000;
uniform vec3 image_lin_displayp3_standard_surface10_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_lin_displayp3_standard_surface10_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool image_lin_displayp3_standard_surface10_thin_walled = false;
...
out vec4 image_lin_displayp3_out1;
...
void main()
{
    ...
    vec3 image_lin_displayp3_out2 = vec3(0.0);
    mx_image_color3(image_lin_displayp3_file, image_lin_displayp3_layer, image_lin_displayp3_default, geomprop_UV0_out1, image_lin_displayp3_uaddressmode, image_lin_displayp3_vaddressmode, image_lin_displayp3_filtertype, image_lin_displayp3_framerange, image_lin_displayp3_frameoffset, image_lin_displayp3_frameendaction, image_lin_displayp3_uv_scale, image_lin_displayp3_uv_offset, image_lin_displayp3_out2);
    vec3 image_lin_displayp3_out_cm_out = vec3(0.0);
    NG_lin_displayp3_to_lin_rec709_color3(image_lin_displayp3_out2, image_lin_displayp3_out_cm_out);
    surfaceshader image_lin_displayp3_standard_surface10_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(image_lin_displayp3_standard_surface10_base, image_lin_displayp3_out_cm_out, image_lin_displayp3_standard_surface10_diffuse_roughness, image_lin_displayp3_standard_surface10_metalness, image_lin_displayp3_standard_surface10_specular, image_lin_displayp3_standard_surface10_specular_color, image_lin_displayp3_standard_surface10_specular_roughness, image_lin_displayp3_standard_surface10_specular_IOR, image_lin_displayp3_standard_surface10_specular_anisotropy, image_lin_displayp3_standard_surface10_specular_rotation, image_lin_displayp3_standard_surface10_transmission, image_lin_displayp3_standard_surface10_transmission_color, image_lin_displayp3_standard_surface10_transmission_depth, image_lin_displayp3_standard_surface10_transmission_scatter, image_lin_displayp3_standard_surface10_transmission_scatter_anisotropy, image_lin_displayp3_standard_surface10_transmission_dispersion, image_lin_displayp3_standard_surface10_transmission_extra_roughness, image_lin_displayp3_standard_surface10_subsurface, image_lin_displayp3_standard_surface10_subsurface_color, image_lin_displayp3_standard_surface10_subsurface_radius, image_lin_displayp3_standard_surface10_subsurface_scale, image_lin_displayp3_standard_surface10_subsurface_anisotropy, image_lin_displayp3_standard_surface10_sheen, image_lin_displayp3_standard_surface10_sheen_color, image_lin_displayp3_standard_surface10_sheen_roughness, image_lin_displayp3_standard_surface10_coat, image_lin_displayp3_standard_surface10_coat_color, image_lin_displayp3_standard_surface10_coat_roughness, image_lin_displayp3_standard_surface10_coat_anisotropy, image_lin_displayp3_standard_surface10_coat_rotation, image_lin_displayp3_standard_surface10_coat_IOR, geomprop_Nworld_out1, image_lin_displayp3_standard_surface10_coat_affect_color, image_lin_displayp3_standard_surface10_coat_affect_roughness, image_lin_displayp3_standard_surface10_thin_film_thickness, image_lin_displayp3_standard_surface10_thin_film_IOR, image_lin_displayp3_standard_surface10_emission, image_lin_displayp3_standard_surface10_emission_color, image_lin_displayp3_standard_surface10_opacity, image_lin_displayp3_standard_surface10_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, image_lin_displayp3_standard_surface10_out);
    image_lin_displayp3_out1 = vec4(image_lin_displayp3_standard_surface10_out.color, 1.0);
}
