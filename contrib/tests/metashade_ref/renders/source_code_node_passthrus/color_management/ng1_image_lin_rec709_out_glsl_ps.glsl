...
uniform sampler2D image_lin_rec709_file;
uniform int image_lin_rec709_layer = 0;
uniform vec3 image_lin_rec709_default = vec3(0.000000, 0.000000, 0.000000);
uniform int image_lin_rec709_uaddressmode = 2;
uniform int image_lin_rec709_vaddressmode = 2;
uniform int image_lin_rec709_filtertype = 1;
uniform int image_lin_rec709_framerange = 0;
uniform int image_lin_rec709_frameoffset = 0;
uniform int image_lin_rec709_frameendaction = 0;
uniform vec2 image_lin_rec709_uv_scale = vec2(1.000000, 1.000000);
uniform vec2 image_lin_rec709_uv_offset = vec2(0.000000, 0.000000);
uniform float image_lin_rec709_standard_surface_base = 1.000000;
uniform float image_lin_rec709_standard_surface_diffuse_roughness = 0.000000;
uniform float image_lin_rec709_standard_surface_metalness = 0.000000;
uniform float image_lin_rec709_standard_surface_specular = 1.000000;
uniform vec3 image_lin_rec709_standard_surface_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_lin_rec709_standard_surface_specular_roughness = 0.200000;
uniform float image_lin_rec709_standard_surface_specular_IOR = 1.500000;
uniform float image_lin_rec709_standard_surface_specular_anisotropy = 0.000000;
uniform float image_lin_rec709_standard_surface_specular_rotation = 0.000000;
uniform float image_lin_rec709_standard_surface_transmission = 0.000000;
uniform vec3 image_lin_rec709_standard_surface_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_lin_rec709_standard_surface_transmission_depth = 0.000000;
uniform vec3 image_lin_rec709_standard_surface_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float image_lin_rec709_standard_surface_transmission_scatter_anisotropy = 0.000000;
uniform float image_lin_rec709_standard_surface_transmission_dispersion = 0.000000;
uniform float image_lin_rec709_standard_surface_transmission_extra_roughness = 0.000000;
uniform float image_lin_rec709_standard_surface_subsurface = 0.000000;
uniform vec3 image_lin_rec709_standard_surface_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_lin_rec709_standard_surface_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float image_lin_rec709_standard_surface_subsurface_scale = 1.000000;
uniform float image_lin_rec709_standard_surface_subsurface_anisotropy = 0.000000;
uniform float image_lin_rec709_standard_surface_sheen = 0.000000;
uniform vec3 image_lin_rec709_standard_surface_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_lin_rec709_standard_surface_sheen_roughness = 0.300000;
uniform float image_lin_rec709_standard_surface_coat = 0.000000;
uniform vec3 image_lin_rec709_standard_surface_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_lin_rec709_standard_surface_coat_roughness = 0.100000;
uniform float image_lin_rec709_standard_surface_coat_anisotropy = 0.000000;
uniform float image_lin_rec709_standard_surface_coat_rotation = 0.000000;
uniform float image_lin_rec709_standard_surface_coat_IOR = 1.500000;
uniform float image_lin_rec709_standard_surface_coat_affect_color = 0.000000;
uniform float image_lin_rec709_standard_surface_coat_affect_roughness = 0.000000;
uniform float image_lin_rec709_standard_surface_thin_film_thickness = 0.000000;
uniform float image_lin_rec709_standard_surface_thin_film_IOR = 1.500000;
uniform float image_lin_rec709_standard_surface_emission = 0.000000;
uniform vec3 image_lin_rec709_standard_surface_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_lin_rec709_standard_surface_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool image_lin_rec709_standard_surface_thin_walled = false;
...
out vec4 image_lin_rec709_out1;
