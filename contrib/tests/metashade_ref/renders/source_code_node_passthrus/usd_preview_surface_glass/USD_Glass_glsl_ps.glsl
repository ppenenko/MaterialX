...
uniform vec3 SR_glass_diffuseColor = vec3(0.000000, 0.000000, 0.000000);
uniform vec3 SR_glass_emissiveColor = vec3(0.000000, 0.000000, 0.000000);
uniform int SR_glass_useSpecularWorkflow = 0;
uniform vec3 SR_glass_specularColor = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_glass_metallic = 0.000000;
uniform float SR_glass_roughness = 0.010000;
uniform float SR_glass_clearcoat = 0.000000;
uniform float SR_glass_clearcoatRoughness = 0.010000;
uniform float SR_glass_opacity = 0.000000;
uniform int SR_glass_opacityMode = 0;
uniform float SR_glass_opacityThreshold = 0.000000;
uniform float SR_glass_ior = 1.520000;
uniform vec3 SR_glass_normal = vec3(0.000000, 0.000000, 1.000000);
uniform float SR_glass_displacement = 0.000000;
uniform float SR_glass_occlusion = 1.000000;
...
void main()
{
    ...
    material USD_Glass_out = SR_glass_out;
    float outAlpha = clamp(1.0 - dot(USD_Glass_out.transparency, vec3(0.3333)), 0.0, 1.0);
    out1 = vec4(USD_Glass_out.color, outAlpha);
