...
uniform float generalized_schlick_brdf_1_weight = 1.000000;
uniform vec3 generalized_schlick_brdf_1_color0 = vec3(0.040000, 0.040000, 0.040000);
uniform vec3 generalized_schlick_brdf_1_color82 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 generalized_schlick_brdf_1_color90 = vec3(1.000000, 1.000000, 1.000000);
uniform float generalized_schlick_brdf_1_exponent = 5.000000;
uniform vec2 generalized_schlick_brdf_1_roughness = vec2(0.000000, 0.000000);
uniform bool generalized_schlick_brdf_1_retroreflective = false;
uniform float generalized_schlick_brdf_1_thinfilm_thickness = 550.000000;
uniform float generalized_schlick_brdf_1_thinfilm_ior = 1.500000;
uniform int generalized_schlick_brdf_1_distribution = 0;
uniform int generalized_schlick_brdf_1_scatter_mode = 0;
...
void main()
{
    ...
    surfaceshader surface1_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            BSDF generalized_schlick_brdf_1_out = BSDF(vec3(0.0),vec3(1.0));
            mx_generalized_schlick_bsdf_metashade(closureData, generalized_schlick_brdf_1_weight, generalized_schlick_brdf_1_color0, generalized_schlick_brdf_1_color82, generalized_schlick_brdf_1_color90, generalized_schlick_brdf_1_exponent, generalized_schlick_brdf_1_roughness, generalized_schlick_brdf_1_retroreflective, generalized_schlick_brdf_1_thinfilm_thickness, generalized_schlick_brdf_1_thinfilm_ior, geomprop_Nworld_out1, geomprop_Tworld_out1, generalized_schlick_brdf_1_distribution, generalized_schlick_brdf_1_scatter_mode, generalized_schlick_brdf_1_out);

            surface1_out.color += occlusion * generalized_schlick_brdf_1_out.response;
        }
        ...
        BSDF generalized_schlick_brdf_1_out = BSDF(vec3(0.0),vec3(1.0));
        mx_generalized_schlick_bsdf_metashade(closureData, generalized_schlick_brdf_1_weight, generalized_schlick_brdf_1_color0, generalized_schlick_brdf_1_color82, generalized_schlick_brdf_1_color90, generalized_schlick_brdf_1_exponent, generalized_schlick_brdf_1_roughness, generalized_schlick_brdf_1_retroreflective, generalized_schlick_brdf_1_thinfilm_thickness, generalized_schlick_brdf_1_thinfilm_ior, geomprop_Nworld_out1, geomprop_Tworld_out1, generalized_schlick_brdf_1_distribution, generalized_schlick_brdf_1_scatter_mode, generalized_schlick_brdf_1_out);
        surface1_out.color += generalized_schlick_brdf_1_out.response;
