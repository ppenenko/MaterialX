...
uniform sampler2D image_lin_adobergb_file;
uniform int image_lin_adobergb_layer = 0;
uniform vec3 image_lin_adobergb_default = vec3(0.000000, 0.000000, 0.000000);
uniform int image_lin_adobergb_uaddressmode = 2;
uniform int image_lin_adobergb_vaddressmode = 2;
uniform int image_lin_adobergb_filtertype = 1;
uniform int image_lin_adobergb_framerange = 0;
uniform int image_lin_adobergb_frameoffset = 0;
uniform int image_lin_adobergb_frameendaction = 0;
uniform vec2 image_lin_adobergb_uv_scale = vec2(1.000000, 1.000000);
uniform vec2 image_lin_adobergb_uv_offset = vec2(0.000000, 0.000000);
uniform float image_lin_adobergb_standard_surface8_base = 1.000000;
uniform float image_lin_adobergb_standard_surface8_diffuse_roughness = 0.000000;
uniform float image_lin_adobergb_standard_surface8_metalness = 0.000000;
uniform float image_lin_adobergb_standard_surface8_specular = 1.000000;
uniform vec3 image_lin_adobergb_standard_surface8_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_lin_adobergb_standard_surface8_specular_roughness = 0.200000;
uniform float image_lin_adobergb_standard_surface8_specular_IOR = 1.500000;
uniform float image_lin_adobergb_standard_surface8_specular_anisotropy = 0.000000;
uniform float image_lin_adobergb_standard_surface8_specular_rotation = 0.000000;
uniform float image_lin_adobergb_standard_surface8_transmission = 0.000000;
uniform vec3 image_lin_adobergb_standard_surface8_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_lin_adobergb_standard_surface8_transmission_depth = 0.000000;
uniform vec3 image_lin_adobergb_standard_surface8_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float image_lin_adobergb_standard_surface8_transmission_scatter_anisotropy = 0.000000;
uniform float image_lin_adobergb_standard_surface8_transmission_dispersion = 0.000000;
uniform float image_lin_adobergb_standard_surface8_transmission_extra_roughness = 0.000000;
uniform float image_lin_adobergb_standard_surface8_subsurface = 0.000000;
uniform vec3 image_lin_adobergb_standard_surface8_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_lin_adobergb_standard_surface8_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float image_lin_adobergb_standard_surface8_subsurface_scale = 1.000000;
uniform float image_lin_adobergb_standard_surface8_subsurface_anisotropy = 0.000000;
uniform float image_lin_adobergb_standard_surface8_sheen = 0.000000;
uniform vec3 image_lin_adobergb_standard_surface8_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_lin_adobergb_standard_surface8_sheen_roughness = 0.300000;
uniform float image_lin_adobergb_standard_surface8_coat = 0.000000;
uniform vec3 image_lin_adobergb_standard_surface8_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_lin_adobergb_standard_surface8_coat_roughness = 0.100000;
uniform float image_lin_adobergb_standard_surface8_coat_anisotropy = 0.000000;
uniform float image_lin_adobergb_standard_surface8_coat_rotation = 0.000000;
uniform float image_lin_adobergb_standard_surface8_coat_IOR = 1.500000;
uniform float image_lin_adobergb_standard_surface8_coat_affect_color = 0.000000;
uniform float image_lin_adobergb_standard_surface8_coat_affect_roughness = 0.000000;
uniform float image_lin_adobergb_standard_surface8_thin_film_thickness = 0.000000;
uniform float image_lin_adobergb_standard_surface8_thin_film_IOR = 1.500000;
uniform float image_lin_adobergb_standard_surface8_emission = 0.000000;
uniform vec3 image_lin_adobergb_standard_surface8_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_lin_adobergb_standard_surface8_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool image_lin_adobergb_standard_surface8_thin_walled = false;
...
out vec4 image_lin_adobergb_out1;
...
void main()
{
    ...
    vec3 image_lin_adobergb_out2 = vec3(0.0);
    mx_image_color3(image_lin_adobergb_file, image_lin_adobergb_layer, image_lin_adobergb_default, geomprop_UV0_out1, image_lin_adobergb_uaddressmode, image_lin_adobergb_vaddressmode, image_lin_adobergb_filtertype, image_lin_adobergb_framerange, image_lin_adobergb_frameoffset, image_lin_adobergb_frameendaction, image_lin_adobergb_uv_scale, image_lin_adobergb_uv_offset, image_lin_adobergb_out2);
    vec3 image_lin_adobergb_out_cm_out = vec3(0.0);
    NG_lin_adobergb_to_lin_rec709_color3(image_lin_adobergb_out2, image_lin_adobergb_out_cm_out);
    surfaceshader image_lin_adobergb_standard_surface8_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    image_lin_adobergb_out1 = vec4(image_lin_adobergb_standard_surface8_out.color, 1.0);
}
