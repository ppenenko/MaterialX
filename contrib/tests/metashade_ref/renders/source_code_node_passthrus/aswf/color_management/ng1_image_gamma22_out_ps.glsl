...
uniform sampler2D image_gamma22_file;
uniform int image_gamma22_layer = 0;
uniform vec3 image_gamma22_default = vec3(0.000000, 0.000000, 0.000000);
uniform int image_gamma22_uaddressmode = 2;
uniform int image_gamma22_vaddressmode = 2;
uniform int image_gamma22_filtertype = 1;
uniform int image_gamma22_framerange = 0;
uniform int image_gamma22_frameoffset = 0;
uniform int image_gamma22_frameendaction = 0;
uniform vec2 image_gamma22_uv_scale = vec2(1.000000, 1.000000);
uniform vec2 image_gamma22_uv_offset = vec2(0.000000, 0.000000);
uniform float image_gamma22_standard_surface3_base = 1.000000;
uniform float image_gamma22_standard_surface3_diffuse_roughness = 0.000000;
uniform float image_gamma22_standard_surface3_metalness = 0.000000;
uniform float image_gamma22_standard_surface3_specular = 1.000000;
uniform vec3 image_gamma22_standard_surface3_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_gamma22_standard_surface3_specular_roughness = 0.200000;
uniform float image_gamma22_standard_surface3_specular_IOR = 1.500000;
uniform float image_gamma22_standard_surface3_specular_anisotropy = 0.000000;
uniform float image_gamma22_standard_surface3_specular_rotation = 0.000000;
uniform float image_gamma22_standard_surface3_transmission = 0.000000;
uniform vec3 image_gamma22_standard_surface3_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_gamma22_standard_surface3_transmission_depth = 0.000000;
uniform vec3 image_gamma22_standard_surface3_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float image_gamma22_standard_surface3_transmission_scatter_anisotropy = 0.000000;
uniform float image_gamma22_standard_surface3_transmission_dispersion = 0.000000;
uniform float image_gamma22_standard_surface3_transmission_extra_roughness = 0.000000;
uniform float image_gamma22_standard_surface3_subsurface = 0.000000;
uniform vec3 image_gamma22_standard_surface3_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_gamma22_standard_surface3_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float image_gamma22_standard_surface3_subsurface_scale = 1.000000;
uniform float image_gamma22_standard_surface3_subsurface_anisotropy = 0.000000;
uniform float image_gamma22_standard_surface3_sheen = 0.000000;
uniform vec3 image_gamma22_standard_surface3_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_gamma22_standard_surface3_sheen_roughness = 0.300000;
uniform float image_gamma22_standard_surface3_coat = 0.000000;
uniform vec3 image_gamma22_standard_surface3_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_gamma22_standard_surface3_coat_roughness = 0.100000;
uniform float image_gamma22_standard_surface3_coat_anisotropy = 0.000000;
uniform float image_gamma22_standard_surface3_coat_rotation = 0.000000;
uniform float image_gamma22_standard_surface3_coat_IOR = 1.500000;
uniform float image_gamma22_standard_surface3_coat_affect_color = 0.000000;
uniform float image_gamma22_standard_surface3_coat_affect_roughness = 0.000000;
uniform float image_gamma22_standard_surface3_thin_film_thickness = 0.000000;
uniform float image_gamma22_standard_surface3_thin_film_IOR = 1.500000;
uniform float image_gamma22_standard_surface3_emission = 0.000000;
uniform vec3 image_gamma22_standard_surface3_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_gamma22_standard_surface3_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool image_gamma22_standard_surface3_thin_walled = false;
...
void main()
{
    ...
    vec3 image_gamma22_out2 = vec3(0.0);
    mx_image_color3(image_gamma22_file, image_gamma22_layer, image_gamma22_default, geomprop_UV0_out1, image_gamma22_uaddressmode, image_gamma22_vaddressmode, image_gamma22_filtertype, image_gamma22_framerange, image_gamma22_frameoffset, image_gamma22_frameendaction, image_gamma22_uv_scale, image_gamma22_uv_offset, image_gamma22_out2);
    vec3 image_gamma22_out_cm_out = vec3(0.0);
    NG_g22_rec709_to_lin_rec709_color3(image_gamma22_out2, image_gamma22_out_cm_out);
    surfaceshader image_gamma22_standard_surface3_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(image_gamma22_standard_surface3_base, image_gamma22_out_cm_out, image_gamma22_standard_surface3_diffuse_roughness, image_gamma22_standard_surface3_metalness, image_gamma22_standard_surface3_specular, image_gamma22_standard_surface3_specular_color, image_gamma22_standard_surface3_specular_roughness, image_gamma22_standard_surface3_specular_IOR, image_gamma22_standard_surface3_specular_anisotropy, image_gamma22_standard_surface3_specular_rotation, image_gamma22_standard_surface3_transmission, image_gamma22_standard_surface3_transmission_color, image_gamma22_standard_surface3_transmission_depth, image_gamma22_standard_surface3_transmission_scatter, image_gamma22_standard_surface3_transmission_scatter_anisotropy, image_gamma22_standard_surface3_transmission_dispersion, image_gamma22_standard_surface3_transmission_extra_roughness, image_gamma22_standard_surface3_subsurface, image_gamma22_standard_surface3_subsurface_color, image_gamma22_standard_surface3_subsurface_radius, image_gamma22_standard_surface3_subsurface_scale, image_gamma22_standard_surface3_subsurface_anisotropy, image_gamma22_standard_surface3_sheen, image_gamma22_standard_surface3_sheen_color, image_gamma22_standard_surface3_sheen_roughness, image_gamma22_standard_surface3_coat, image_gamma22_standard_surface3_coat_color, image_gamma22_standard_surface3_coat_roughness, image_gamma22_standard_surface3_coat_anisotropy, image_gamma22_standard_surface3_coat_rotation, image_gamma22_standard_surface3_coat_IOR, geomprop_Nworld_out1, image_gamma22_standard_surface3_coat_affect_color, image_gamma22_standard_surface3_coat_affect_roughness, image_gamma22_standard_surface3_thin_film_thickness, image_gamma22_standard_surface3_thin_film_IOR, image_gamma22_standard_surface3_emission, image_gamma22_standard_surface3_emission_color, image_gamma22_standard_surface3_opacity, image_gamma22_standard_surface3_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, image_gamma22_standard_surface3_out);
    image_gamma22_out1 = vec4(image_gamma22_standard_surface3_out.color, 1.0);
}
