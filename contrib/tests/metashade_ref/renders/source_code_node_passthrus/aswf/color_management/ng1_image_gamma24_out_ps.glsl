...
uniform sampler2D image_gamma24_file;
uniform int image_gamma24_layer = 0;
uniform vec3 image_gamma24_default = vec3(0.000000, 0.000000, 0.000000);
uniform int image_gamma24_uaddressmode = 2;
uniform int image_gamma24_vaddressmode = 2;
uniform int image_gamma24_filtertype = 1;
uniform int image_gamma24_framerange = 0;
uniform int image_gamma24_frameoffset = 0;
uniform int image_gamma24_frameendaction = 0;
uniform vec2 image_gamma24_uv_scale = vec2(1.000000, 1.000000);
uniform vec2 image_gamma24_uv_offset = vec2(0.000000, 0.000000);
uniform float image_gamma24_standard_surface4_base = 1.000000;
uniform float image_gamma24_standard_surface4_diffuse_roughness = 0.000000;
uniform float image_gamma24_standard_surface4_metalness = 0.000000;
uniform float image_gamma24_standard_surface4_specular = 1.000000;
uniform vec3 image_gamma24_standard_surface4_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_gamma24_standard_surface4_specular_roughness = 0.200000;
uniform float image_gamma24_standard_surface4_specular_IOR = 1.500000;
uniform float image_gamma24_standard_surface4_specular_anisotropy = 0.000000;
uniform float image_gamma24_standard_surface4_specular_rotation = 0.000000;
uniform float image_gamma24_standard_surface4_transmission = 0.000000;
uniform vec3 image_gamma24_standard_surface4_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_gamma24_standard_surface4_transmission_depth = 0.000000;
uniform vec3 image_gamma24_standard_surface4_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float image_gamma24_standard_surface4_transmission_scatter_anisotropy = 0.000000;
uniform float image_gamma24_standard_surface4_transmission_dispersion = 0.000000;
uniform float image_gamma24_standard_surface4_transmission_extra_roughness = 0.000000;
uniform float image_gamma24_standard_surface4_subsurface = 0.000000;
uniform vec3 image_gamma24_standard_surface4_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_gamma24_standard_surface4_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float image_gamma24_standard_surface4_subsurface_scale = 1.000000;
uniform float image_gamma24_standard_surface4_subsurface_anisotropy = 0.000000;
uniform float image_gamma24_standard_surface4_sheen = 0.000000;
uniform vec3 image_gamma24_standard_surface4_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_gamma24_standard_surface4_sheen_roughness = 0.300000;
uniform float image_gamma24_standard_surface4_coat = 0.000000;
uniform vec3 image_gamma24_standard_surface4_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_gamma24_standard_surface4_coat_roughness = 0.100000;
uniform float image_gamma24_standard_surface4_coat_anisotropy = 0.000000;
uniform float image_gamma24_standard_surface4_coat_rotation = 0.000000;
uniform float image_gamma24_standard_surface4_coat_IOR = 1.500000;
uniform float image_gamma24_standard_surface4_coat_affect_color = 0.000000;
uniform float image_gamma24_standard_surface4_coat_affect_roughness = 0.000000;
uniform float image_gamma24_standard_surface4_thin_film_thickness = 0.000000;
uniform float image_gamma24_standard_surface4_thin_film_IOR = 1.500000;
uniform float image_gamma24_standard_surface4_emission = 0.000000;
uniform vec3 image_gamma24_standard_surface4_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_gamma24_standard_surface4_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool image_gamma24_standard_surface4_thin_walled = false;
...
void main()
{
    ...
    vec3 image_gamma24_out2 = vec3(0.0);
    mx_image_color3(image_gamma24_file, image_gamma24_layer, image_gamma24_default, geomprop_UV0_out1, image_gamma24_uaddressmode, image_gamma24_vaddressmode, image_gamma24_filtertype, image_gamma24_framerange, image_gamma24_frameoffset, image_gamma24_frameendaction, image_gamma24_uv_scale, image_gamma24_uv_offset, image_gamma24_out2);
    vec3 image_gamma24_out_cm_out = vec3(0.0);
    NG_rec709_display_to_lin_rec709_color3(image_gamma24_out2, image_gamma24_out_cm_out);
    surfaceshader image_gamma24_standard_surface4_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    image_gamma24_out1 = vec4(image_gamma24_standard_surface4_out.color, 1.0);
}
