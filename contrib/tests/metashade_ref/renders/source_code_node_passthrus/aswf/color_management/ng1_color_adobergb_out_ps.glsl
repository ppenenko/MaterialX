...
uniform vec4 color_adobergb_value_cm_in = vec4(0.500000, 0.000000, 0.000000, 1.000000);
uniform float color_adobergb_standard_surface7_base = 1.000000;
uniform float color_adobergb_standard_surface7_diffuse_roughness = 0.000000;
uniform float color_adobergb_standard_surface7_metalness = 0.000000;
uniform float color_adobergb_standard_surface7_specular = 1.000000;
uniform vec3 color_adobergb_standard_surface7_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_adobergb_standard_surface7_specular_roughness = 0.200000;
uniform float color_adobergb_standard_surface7_specular_IOR = 1.500000;
uniform float color_adobergb_standard_surface7_specular_anisotropy = 0.000000;
uniform float color_adobergb_standard_surface7_specular_rotation = 0.000000;
uniform float color_adobergb_standard_surface7_transmission = 0.000000;
uniform vec3 color_adobergb_standard_surface7_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_adobergb_standard_surface7_transmission_depth = 0.000000;
uniform vec3 color_adobergb_standard_surface7_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float color_adobergb_standard_surface7_transmission_scatter_anisotropy = 0.000000;
uniform float color_adobergb_standard_surface7_transmission_dispersion = 0.000000;
uniform float color_adobergb_standard_surface7_transmission_extra_roughness = 0.000000;
uniform float color_adobergb_standard_surface7_subsurface = 0.000000;
uniform vec3 color_adobergb_standard_surface7_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 color_adobergb_standard_surface7_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float color_adobergb_standard_surface7_subsurface_scale = 1.000000;
uniform float color_adobergb_standard_surface7_subsurface_anisotropy = 0.000000;
uniform float color_adobergb_standard_surface7_sheen = 0.000000;
uniform vec3 color_adobergb_standard_surface7_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_adobergb_standard_surface7_sheen_roughness = 0.300000;
uniform float color_adobergb_standard_surface7_coat = 0.000000;
uniform vec3 color_adobergb_standard_surface7_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_adobergb_standard_surface7_coat_roughness = 0.100000;
uniform float color_adobergb_standard_surface7_coat_anisotropy = 0.000000;
uniform float color_adobergb_standard_surface7_coat_rotation = 0.000000;
uniform float color_adobergb_standard_surface7_coat_IOR = 1.500000;
uniform float color_adobergb_standard_surface7_coat_affect_color = 0.000000;
uniform float color_adobergb_standard_surface7_coat_affect_roughness = 0.000000;
uniform float color_adobergb_standard_surface7_thin_film_thickness = 0.000000;
uniform float color_adobergb_standard_surface7_thin_film_IOR = 1.500000;
uniform float color_adobergb_standard_surface7_emission = 0.000000;
uniform vec3 color_adobergb_standard_surface7_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 color_adobergb_standard_surface7_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool color_adobergb_standard_surface7_thin_walled = false;
...
void NG_adobergb_to_lin_rec709_color4(vec4 in1, out vec4 out1)
{
    ...
    NG_adobergb_to_lin_rec709_color3(asColor3_out, transform_out);
...
void main()
{
    vec4 color_adobergb_value_cm_out = vec4(0.0);
    NG_adobergb_to_lin_rec709_color4(color_adobergb_value_cm_in, color_adobergb_value_cm_out);
    vec3 geomprop_Nworld_out1 = normalize(vd.normalWorld);
    vec3 geomprop_Tworld_out1 = normalize(vd.tangentWorld);
    vec3 color_adobergb_color3_out = vec3(0.0);
    NG_convert_color4_color3(color_adobergb_value_cm_out, color_adobergb_color3_out);
    surfaceshader color_adobergb_standard_surface7_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(color_adobergb_standard_surface7_base, color_adobergb_color3_out, color_adobergb_standard_surface7_diffuse_roughness, color_adobergb_standard_surface7_metalness, color_adobergb_standard_surface7_specular, color_adobergb_standard_surface7_specular_color, color_adobergb_standard_surface7_specular_roughness, color_adobergb_standard_surface7_specular_IOR, color_adobergb_standard_surface7_specular_anisotropy, color_adobergb_standard_surface7_specular_rotation, color_adobergb_standard_surface7_transmission, color_adobergb_standard_surface7_transmission_color, color_adobergb_standard_surface7_transmission_depth, color_adobergb_standard_surface7_transmission_scatter, color_adobergb_standard_surface7_transmission_scatter_anisotropy, color_adobergb_standard_surface7_transmission_dispersion, color_adobergb_standard_surface7_transmission_extra_roughness, color_adobergb_standard_surface7_subsurface, color_adobergb_standard_surface7_subsurface_color, color_adobergb_standard_surface7_subsurface_radius, color_adobergb_standard_surface7_subsurface_scale, color_adobergb_standard_surface7_subsurface_anisotropy, color_adobergb_standard_surface7_sheen, color_adobergb_standard_surface7_sheen_color, color_adobergb_standard_surface7_sheen_roughness, color_adobergb_standard_surface7_coat, color_adobergb_standard_surface7_coat_color, color_adobergb_standard_surface7_coat_roughness, color_adobergb_standard_surface7_coat_anisotropy, color_adobergb_standard_surface7_coat_rotation, color_adobergb_standard_surface7_coat_IOR, geomprop_Nworld_out1, color_adobergb_standard_surface7_coat_affect_color, color_adobergb_standard_surface7_coat_affect_roughness, color_adobergb_standard_surface7_thin_film_thickness, color_adobergb_standard_surface7_thin_film_IOR, color_adobergb_standard_surface7_emission, color_adobergb_standard_surface7_emission_color, color_adobergb_standard_surface7_opacity, color_adobergb_standard_surface7_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, color_adobergb_standard_surface7_out);
    color_adobergb_out1 = vec4(color_adobergb_standard_surface7_out.color, 1.0);
}
