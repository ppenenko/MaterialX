...
uniform sampler2D image_g22_ap1_file;
uniform int image_g22_ap1_layer = 0;
uniform vec3 image_g22_ap1_default = vec3(0.000000, 0.000000, 0.000000);
uniform int image_g22_ap1_uaddressmode = 2;
uniform int image_g22_ap1_vaddressmode = 2;
uniform int image_g22_ap1_filtertype = 1;
uniform int image_g22_ap1_framerange = 0;
uniform int image_g22_ap1_frameoffset = 0;
uniform int image_g22_ap1_frameendaction = 0;
uniform vec2 image_g22_ap1_uv_scale = vec2(1.000000, 1.000000);
uniform vec2 image_g22_ap1_uv_offset = vec2(0.000000, 0.000000);
uniform float image_g22_ap1_standard_surface5_base = 1.000000;
uniform float image_g22_ap1_standard_surface5_diffuse_roughness = 0.000000;
uniform float image_g22_ap1_standard_surface5_metalness = 0.000000;
uniform float image_g22_ap1_standard_surface5_specular = 1.000000;
uniform vec3 image_g22_ap1_standard_surface5_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_g22_ap1_standard_surface5_specular_roughness = 0.200000;
uniform float image_g22_ap1_standard_surface5_specular_IOR = 1.500000;
uniform float image_g22_ap1_standard_surface5_specular_anisotropy = 0.000000;
uniform float image_g22_ap1_standard_surface5_specular_rotation = 0.000000;
uniform float image_g22_ap1_standard_surface5_transmission = 0.000000;
uniform vec3 image_g22_ap1_standard_surface5_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_g22_ap1_standard_surface5_transmission_depth = 0.000000;
uniform vec3 image_g22_ap1_standard_surface5_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float image_g22_ap1_standard_surface5_transmission_scatter_anisotropy = 0.000000;
uniform float image_g22_ap1_standard_surface5_transmission_dispersion = 0.000000;
uniform float image_g22_ap1_standard_surface5_transmission_extra_roughness = 0.000000;
uniform float image_g22_ap1_standard_surface5_subsurface = 0.000000;
uniform vec3 image_g22_ap1_standard_surface5_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_g22_ap1_standard_surface5_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float image_g22_ap1_standard_surface5_subsurface_scale = 1.000000;
uniform float image_g22_ap1_standard_surface5_subsurface_anisotropy = 0.000000;
uniform float image_g22_ap1_standard_surface5_sheen = 0.000000;
uniform vec3 image_g22_ap1_standard_surface5_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_g22_ap1_standard_surface5_sheen_roughness = 0.300000;
uniform float image_g22_ap1_standard_surface5_coat = 0.000000;
uniform vec3 image_g22_ap1_standard_surface5_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float image_g22_ap1_standard_surface5_coat_roughness = 0.100000;
uniform float image_g22_ap1_standard_surface5_coat_anisotropy = 0.000000;
uniform float image_g22_ap1_standard_surface5_coat_rotation = 0.000000;
uniform float image_g22_ap1_standard_surface5_coat_IOR = 1.500000;
uniform float image_g22_ap1_standard_surface5_coat_affect_color = 0.000000;
uniform float image_g22_ap1_standard_surface5_coat_affect_roughness = 0.000000;
uniform float image_g22_ap1_standard_surface5_thin_film_thickness = 0.000000;
uniform float image_g22_ap1_standard_surface5_thin_film_IOR = 1.500000;
uniform float image_g22_ap1_standard_surface5_emission = 0.000000;
uniform vec3 image_g22_ap1_standard_surface5_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 image_g22_ap1_standard_surface5_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool image_g22_ap1_standard_surface5_thin_walled = false;
...
void main()
{
    ...
    vec3 image_g22_ap1_out2 = vec3(0.0);
    mx_image_color3(image_g22_ap1_file, image_g22_ap1_layer, image_g22_ap1_default, geomprop_UV0_out1, image_g22_ap1_uaddressmode, image_g22_ap1_vaddressmode, image_g22_ap1_filtertype, image_g22_ap1_framerange, image_g22_ap1_frameoffset, image_g22_ap1_frameendaction, image_g22_ap1_uv_scale, image_g22_ap1_uv_offset, image_g22_ap1_out2);
    vec3 image_g22_ap1_out_cm_out = vec3(0.0);
    NG_g22_ap1_to_lin_rec709_color3(image_g22_ap1_out2, image_g22_ap1_out_cm_out);
    surfaceshader image_g22_ap1_standard_surface5_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(image_g22_ap1_standard_surface5_base, image_g22_ap1_out_cm_out, image_g22_ap1_standard_surface5_diffuse_roughness, image_g22_ap1_standard_surface5_metalness, image_g22_ap1_standard_surface5_specular, image_g22_ap1_standard_surface5_specular_color, image_g22_ap1_standard_surface5_specular_roughness, image_g22_ap1_standard_surface5_specular_IOR, image_g22_ap1_standard_surface5_specular_anisotropy, image_g22_ap1_standard_surface5_specular_rotation, image_g22_ap1_standard_surface5_transmission, image_g22_ap1_standard_surface5_transmission_color, image_g22_ap1_standard_surface5_transmission_depth, image_g22_ap1_standard_surface5_transmission_scatter, image_g22_ap1_standard_surface5_transmission_scatter_anisotropy, image_g22_ap1_standard_surface5_transmission_dispersion, image_g22_ap1_standard_surface5_transmission_extra_roughness, image_g22_ap1_standard_surface5_subsurface, image_g22_ap1_standard_surface5_subsurface_color, image_g22_ap1_standard_surface5_subsurface_radius, image_g22_ap1_standard_surface5_subsurface_scale, image_g22_ap1_standard_surface5_subsurface_anisotropy, image_g22_ap1_standard_surface5_sheen, image_g22_ap1_standard_surface5_sheen_color, image_g22_ap1_standard_surface5_sheen_roughness, image_g22_ap1_standard_surface5_coat, image_g22_ap1_standard_surface5_coat_color, image_g22_ap1_standard_surface5_coat_roughness, image_g22_ap1_standard_surface5_coat_anisotropy, image_g22_ap1_standard_surface5_coat_rotation, image_g22_ap1_standard_surface5_coat_IOR, geomprop_Nworld_out1, image_g22_ap1_standard_surface5_coat_affect_color, image_g22_ap1_standard_surface5_coat_affect_roughness, image_g22_ap1_standard_surface5_thin_film_thickness, image_g22_ap1_standard_surface5_thin_film_IOR, image_g22_ap1_standard_surface5_emission, image_g22_ap1_standard_surface5_emission_color, image_g22_ap1_standard_surface5_opacity, image_g22_ap1_standard_surface5_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, image_g22_ap1_standard_surface5_out);
    image_g22_ap1_out1 = vec4(image_g22_ap1_standard_surface5_out.color, 1.0);
}
