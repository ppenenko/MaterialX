...
uniform vec4 color_lin_rec709_color3_in = vec4(0.500000, 0.000000, 0.000000, 1.000000);
uniform float color_lin_rec709_standard_surface_base = 1.000000;
uniform float color_lin_rec709_standard_surface_diffuse_roughness = 0.000000;
uniform float color_lin_rec709_standard_surface_metalness = 0.000000;
uniform float color_lin_rec709_standard_surface_specular = 1.000000;
uniform vec3 color_lin_rec709_standard_surface_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_lin_rec709_standard_surface_specular_roughness = 0.200000;
uniform float color_lin_rec709_standard_surface_specular_IOR = 1.500000;
uniform float color_lin_rec709_standard_surface_specular_anisotropy = 0.000000;
uniform float color_lin_rec709_standard_surface_specular_rotation = 0.000000;
uniform float color_lin_rec709_standard_surface_transmission = 0.000000;
uniform vec3 color_lin_rec709_standard_surface_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_lin_rec709_standard_surface_transmission_depth = 0.000000;
uniform vec3 color_lin_rec709_standard_surface_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float color_lin_rec709_standard_surface_transmission_scatter_anisotropy = 0.000000;
uniform float color_lin_rec709_standard_surface_transmission_dispersion = 0.000000;
uniform float color_lin_rec709_standard_surface_transmission_extra_roughness = 0.000000;
uniform float color_lin_rec709_standard_surface_subsurface = 0.000000;
uniform vec3 color_lin_rec709_standard_surface_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 color_lin_rec709_standard_surface_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float color_lin_rec709_standard_surface_subsurface_scale = 1.000000;
uniform float color_lin_rec709_standard_surface_subsurface_anisotropy = 0.000000;
uniform float color_lin_rec709_standard_surface_sheen = 0.000000;
uniform vec3 color_lin_rec709_standard_surface_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_lin_rec709_standard_surface_sheen_roughness = 0.300000;
uniform float color_lin_rec709_standard_surface_coat = 0.000000;
uniform vec3 color_lin_rec709_standard_surface_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float color_lin_rec709_standard_surface_coat_roughness = 0.100000;
uniform float color_lin_rec709_standard_surface_coat_anisotropy = 0.000000;
uniform float color_lin_rec709_standard_surface_coat_rotation = 0.000000;
uniform float color_lin_rec709_standard_surface_coat_IOR = 1.500000;
uniform float color_lin_rec709_standard_surface_coat_affect_color = 0.000000;
uniform float color_lin_rec709_standard_surface_coat_affect_roughness = 0.000000;
uniform float color_lin_rec709_standard_surface_thin_film_thickness = 0.000000;
uniform float color_lin_rec709_standard_surface_thin_film_IOR = 1.500000;
uniform float color_lin_rec709_standard_surface_emission = 0.000000;
uniform vec3 color_lin_rec709_standard_surface_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 color_lin_rec709_standard_surface_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool color_lin_rec709_standard_surface_thin_walled = false;
...
out vec4 color_lin_rec709_out1;
...
void main()
{
    vec3 color_lin_rec709_color3_out = vec3(0.0);
    ...
    surfaceshader color_lin_rec709_standard_surface_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    color_lin_rec709_out1 = vec4(color_lin_rec709_standard_surface_out.color, 1.0);
}
