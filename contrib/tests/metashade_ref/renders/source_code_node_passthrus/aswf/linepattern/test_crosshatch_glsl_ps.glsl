...
uniform float SR_test_crosshatch_base = 1.000000;
uniform float SR_test_crosshatch_diffuse_roughness = 0.000000;
uniform float SR_test_crosshatch_metalness = 0.000000;
uniform float SR_test_crosshatch_specular = 1.000000;
uniform vec3 SR_test_crosshatch_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_crosshatch_specular_roughness = 0.200000;
uniform float SR_test_crosshatch_specular_IOR = 1.500000;
uniform float SR_test_crosshatch_specular_anisotropy = 0.000000;
uniform float SR_test_crosshatch_specular_rotation = 0.000000;
uniform float SR_test_crosshatch_transmission = 0.000000;
uniform vec3 SR_test_crosshatch_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_crosshatch_transmission_depth = 0.000000;
uniform vec3 SR_test_crosshatch_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_test_crosshatch_transmission_scatter_anisotropy = 0.000000;
uniform float SR_test_crosshatch_transmission_dispersion = 0.000000;
uniform float SR_test_crosshatch_transmission_extra_roughness = 0.000000;
uniform float SR_test_crosshatch_subsurface = 0.000000;
uniform vec3 SR_test_crosshatch_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_test_crosshatch_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_crosshatch_subsurface_scale = 1.000000;
uniform float SR_test_crosshatch_subsurface_anisotropy = 0.000000;
uniform float SR_test_crosshatch_sheen = 0.000000;
uniform vec3 SR_test_crosshatch_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_crosshatch_sheen_roughness = 0.300000;
uniform float SR_test_crosshatch_coat = 0.000000;
uniform vec3 SR_test_crosshatch_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_test_crosshatch_coat_roughness = 0.100000;
uniform float SR_test_crosshatch_coat_anisotropy = 0.000000;
uniform float SR_test_crosshatch_coat_rotation = 0.000000;
uniform float SR_test_crosshatch_coat_IOR = 1.500000;
uniform float SR_test_crosshatch_coat_affect_color = 0.000000;
uniform float SR_test_crosshatch_coat_affect_roughness = 0.000000;
uniform float SR_test_crosshatch_thin_film_thickness = 0.000000;
uniform float SR_test_crosshatch_thin_film_IOR = 1.500000;
uniform float SR_test_crosshatch_emission = 0.000000;
uniform vec3 SR_test_crosshatch_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_test_crosshatch_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool SR_test_crosshatch_thin_walled = false;
...
void main()
{
    ...
    surfaceshader SR_test_crosshatch_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    material test_crosshatch_out = SR_test_crosshatch_out;
    out1 = vec4(test_crosshatch_out.color, 1.0);
}
