...
uniform float diffuse_brdf1_weight = 1.000000;
...
void main()
{
    ...
    surfaceshader surface1_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            mx_oren_nayar_diffuse_bsdf(closureData, diffuse_brdf1_weight, diffuse_brdf1_color, diffuse_brdf1_roughness, geomprop_Nworld_out1, diffuse_brdf1_energy_compensation, diffuse_brdf1_out);
            BSDF mix_bsdf1_out = BSDF(vec3(0.0),vec3(1.0));
            mx_mix_bsdf(closureData, dielectric_brdf1_out, diffuse_brdf1_out, mix_bsdf1_mix, mix_bsdf1_out);

            surface1_out.color += occlusion * mix_bsdf1_out.response;
        }
        ...
        BSDF mix_bsdf1_out = BSDF(vec3(0.0),vec3(1.0));
        mx_mix_bsdf(closureData, dielectric_brdf1_out, diffuse_brdf1_out, mix_bsdf1_mix, mix_bsdf1_out);
        surface1_out.color += mix_bsdf1_out.response;
