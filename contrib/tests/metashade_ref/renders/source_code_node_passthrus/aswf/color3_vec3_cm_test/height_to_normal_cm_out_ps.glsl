...
void main()
{
    ...
    mx_heighttonormal_vector3(extract1_out, impl_heighttonormalmap_scale, geomprop_UV0_out1, impl_heighttonormalmap_out);
    out11 = vec4(impl_heighttonormalmap_out, 1.0);
}
