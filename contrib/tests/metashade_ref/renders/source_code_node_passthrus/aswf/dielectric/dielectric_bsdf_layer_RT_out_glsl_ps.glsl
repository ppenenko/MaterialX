...
uniform vec3 dielectric_R_tint = vec3(0.700000, 0.700000, 0.700000);
uniform float dielectric_R_ior = 1.500000;
...
uniform vec3 dielectric_T_tint = vec3(0.700000, 0.700000, 0.700000);
...
void main()
{
    ...
    surfaceshader surface_layer_RT_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            mx_layer_bsdf(closureData, dielectric_R_out, dielectric_T_out, layer_RT_out2);
