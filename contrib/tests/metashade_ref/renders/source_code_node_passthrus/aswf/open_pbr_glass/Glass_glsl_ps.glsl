...
uniform float open_pbr_surface_surfaceshader_specular_ior = 1.520000;
...
uniform float open_pbr_surface_surfaceshader_transmission_dispersion_scale = 1.000000;
uniform float open_pbr_surface_surfaceshader_transmission_dispersion_abbe_number = 64.000000;
...
void main()
{
    ...
    material Glass_out = open_pbr_surface_surfaceshader_out;
