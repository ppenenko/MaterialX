...
uniform float multiply_bsdf_1_in2 = 0.800000;
...
void main()
{
    ...
    surfaceshader surface1_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            BSDF multiply_bsdf_1_out = BSDF(vec3(0.0),vec3(1.0));
            mx_multiply_bsdf_float(closureData, dielectric_brdf_1_out, multiply_bsdf_1_in2, multiply_bsdf_1_out);

            surface1_out.color += occlusion * multiply_bsdf_1_out.response;
        }
        ...
        BSDF multiply_bsdf_1_out = BSDF(vec3(0.0),vec3(1.0));
        mx_multiply_bsdf_float(closureData, dielectric_brdf_1_out, multiply_bsdf_1_in2, multiply_bsdf_1_out);
        surface1_out.color += multiply_bsdf_1_out.response;
