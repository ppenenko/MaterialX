...
uniform vec3 dielectric_brdf_2_tint = vec3(0.100000, 1.000000, 0.100000);
uniform float dielectric_brdf_2_ior = 2.500000;
uniform vec2 dielectric_brdf_2_roughness = vec2(0.000000, 0.000000);
...
void main()
{
    ...
    surfaceshader surface1_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            surface1_out.color += occlusion * layer_bsdf_1_out.response;
        }
        ...
        BSDF layer_bsdf_1_out = BSDF(vec3(0.0),vec3(1.0));
        mx_layer_bsdf(closureData, dielectric_brdf_2_out, dielectric_brdf_1_out, layer_bsdf_1_out);
        surface1_out.color += layer_bsdf_1_out.response;
