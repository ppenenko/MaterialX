...
uniform sampler2D bl_texture_file;
uniform sampler2D bl1_texture_file;
uniform int geomprop_UV0_index = 0;
uniform sampler2D tr1_file;
uniform int tr1_layer = 0;
uniform vec3 tr1_default = vec3(0.000000, 0.000000, 0.000000);
uniform int tr1_uaddressmode = 2;
uniform int tr1_vaddressmode = 2;
uniform int tr1_filtertype = 1;
uniform int tr1_framerange = 0;
uniform int tr1_frameoffset = 0;
uniform int tr1_frameendaction = 0;
uniform vec2 tr1_uv_scale = vec2(1.000000, 1.000000);
uniform vec2 tr1_uv_offset = vec2(0.000000, 0.000000);
uniform float shaderref1_base = 1.000000;
uniform float shaderref1_diffuse_roughness = 0.000000;
uniform float shaderref1_metalness = 0.000000;
uniform float shaderref1_specular = 1.000000;
uniform float shaderref1_specular_roughness = 0.200000;
uniform float shaderref1_specular_IOR = 1.500000;
uniform float shaderref1_specular_anisotropy = 0.000000;
uniform float shaderref1_specular_rotation = 0.000000;
uniform float shaderref1_transmission = 0.000000;
uniform float shaderref1_transmission_depth = 0.000000;
uniform vec3 shaderref1_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float shaderref1_transmission_scatter_anisotropy = 0.000000;
uniform float shaderref1_transmission_dispersion = 0.000000;
uniform float shaderref1_transmission_extra_roughness = 0.000000;
uniform float shaderref1_subsurface = 0.000000;
uniform vec3 shaderref1_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 shaderref1_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float shaderref1_subsurface_scale = 1.000000;
uniform float shaderref1_subsurface_anisotropy = 0.000000;
uniform float shaderref1_sheen = 0.000000;
uniform vec3 shaderref1_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float shaderref1_sheen_roughness = 0.300000;
uniform float shaderref1_coat = 0.000000;
uniform vec3 shaderref1_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float shaderref1_coat_roughness = 0.100000;
uniform float shaderref1_coat_anisotropy = 0.000000;
uniform float shaderref1_coat_rotation = 0.000000;
uniform float shaderref1_coat_IOR = 1.500000;
uniform float shaderref1_coat_affect_color = 0.000000;
uniform float shaderref1_coat_affect_roughness = 0.000000;
uniform float shaderref1_thin_film_thickness = 0.000000;
uniform float shaderref1_thin_film_IOR = 1.500000;
uniform float shaderref1_emission = 0.000000;
uniform vec3 shaderref1_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 shaderref1_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool shaderref1_thin_walled = false;
...
void NG_tm_test(sampler2D texture_file, out vec3 out1)
{
    vec2 geomprop_UV0_out1 = vd.texcoord_0.xy;
    vec3 b_image_out = vec3(0.0);
    mx_image_color3(texture_file, 0, vec3(0.000000, 0.000000, 0.000000), geomprop_UV0_out1, 2, 2, 1, 0, 0, 0, vec2(1.000000, 1.000000), vec2(0.000000, 0.000000), b_image_out);
    out1 = b_image_out;
}

void NG_tm_retest(sampler2D texture_file, out vec3 out1)
{
    vec2 geomprop_UV0_out1 = vd.texcoord_0.xy;
    vec3 b_image_out = vec3(0.0);
    mx_image_color3(texture_file, 0, vec3(0.000000, 0.000000, 0.000000), geomprop_UV0_out1, 2, 2, 1, 0, 0, 0, vec2(1.000000, 1.000000), vec2(0.000000, 0.000000), b_image_out);
...
void main()
{
    ...
    vec3 bl_out = vec3(0.0);
    NG_tm_test(bl_texture_file, bl_out);
    vec3 bl1_out = vec3(0.0);
    NG_tm_retest(bl1_texture_file, bl1_out);
    vec2 geomprop_UV0_out1 = vd.texcoord_0.xy;
    vec3 bl_out_cm_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(bl_out, bl_out_cm_out);
    vec3 bl1_out_cm_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(bl1_out, bl1_out_cm_out);
    vec3 tr1_out = vec3(0.0);
    mx_image_color3(tr1_file, tr1_layer, tr1_default, geomprop_UV0_out1, tr1_uaddressmode, tr1_vaddressmode, tr1_filtertype, tr1_framerange, tr1_frameoffset, tr1_frameendaction, tr1_uv_scale, tr1_uv_offset, tr1_out);
    vec3 tr1_out_cm_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(tr1_out, tr1_out_cm_out);
    surfaceshader shaderref1_out = surfaceshader(vec3(0.0),vec3(0.0));
    ...
    material Filename_CM_Test_out = shaderref1_out;
    out1 = vec4(Filename_CM_Test_out.color, 1.0);
}
