...
uniform vec3 albedo = vec3(0.800000, 0.200000, 0.100000);
uniform vec3 subsurface = vec3(0.100000, 0.100000, 0.800000);
uniform float subsurface_weight = 0.000000;
uniform vec3 emission = vec3(0.000000, 0.000000, 0.000000);
