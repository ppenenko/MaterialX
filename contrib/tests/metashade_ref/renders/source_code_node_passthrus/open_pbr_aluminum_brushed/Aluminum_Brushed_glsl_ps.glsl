...
uniform vec3 open_pbr_surface_surfaceshader_base_color = vec3(0.912000, 0.914000, 0.920000);
uniform float open_pbr_surface_surfaceshader_base_diffuse_roughness = 0.000000;
uniform float open_pbr_surface_surfaceshader_base_metalness = 1.000000;
uniform float open_pbr_surface_surfaceshader_specular_weight = 1.000000;
uniform vec3 open_pbr_surface_surfaceshader_specular_color = vec3(0.970000, 0.979000, 0.988000);
uniform float open_pbr_surface_surfaceshader_specular_roughness = 0.200000;
uniform float open_pbr_surface_surfaceshader_specular_ior = 1.500000;
uniform float open_pbr_surface_surfaceshader_specular_roughness_anisotropy = 0.900000;
...
uniform float open_pbr_surface_surfaceshader_thin_film_weight = 0.000000;
...
void main()
{
    ...
    material Aluminum_Brushed_out = open_pbr_surface_surfaceshader_out;
    out1 = vec4(Aluminum_Brushed_out.color, 1.0);
}
