...
uniform float open_pbr_surface_surfaceshader_emission_luminance = 10000.000000;
uniform vec3 open_pbr_surface_surfaceshader_emission_color = vec3(1.000000, 0.415000, 0.099000);
...
void main()
{
    ...
    material Light_Bulb_out = open_pbr_surface_surfaceshader_out;
    out1 = vec4(Light_Bulb_out.color, 1.0);
}
