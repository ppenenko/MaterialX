...
uniform float sheen_brdf_1_weight = 1.000000;
uniform vec3 sheen_brdf_1_color = vec3(1.000000, 1.000000, 1.000000);
uniform float sheen_brdf_1_roughness = 0.300000;
uniform int sheen_brdf_1_mode = 0;
uniform float diffuse_brdf_1_weight = 1.000000;
uniform vec3 diffuse_brdf_1_color = vec3(0.180000, 0.180000, 0.180000);
uniform float diffuse_brdf_1_roughness = 0.000000;
uniform bool diffuse_brdf_1_energy_compensation = false;
uniform float dielectric_brdf_2_weight = 1.000000;
uniform vec3 dielectric_brdf_2_tint = vec3(1.000000, 0.000000, 0.000000);
uniform float dielectric_brdf_2_ior = 1.200000;
uniform vec2 dielectric_brdf_2_roughness = vec2(0.050000, 0.050000);
uniform bool dielectric_brdf_2_retroreflective = false;
uniform float dielectric_brdf_2_thinfilm_thickness = 0.000000;
uniform float dielectric_brdf_2_thinfilm_ior = 1.500000;
uniform int dielectric_brdf_2_distribution = 0;
uniform int dielectric_brdf_2_scatter_mode = 0;
uniform float dielectric_brdf_1_weight = 1.000000;
uniform vec3 dielectric_brdf_1_tint = vec3(1.000000, 1.000000, 1.000000);
uniform float dielectric_brdf_1_ior = 2.500000;
uniform vec2 dielectric_brdf_1_roughness = vec2(0.050000, 0.050000);
uniform bool dielectric_brdf_1_retroreflective = false;
uniform float dielectric_brdf_1_thinfilm_thickness = 0.000000;
uniform float dielectric_brdf_1_thinfilm_ior = 1.500000;
uniform int dielectric_brdf_1_distribution = 0;
uniform int dielectric_brdf_1_scatter_mode = 0;
...
void main()
{
    ...
    surfaceshader surface1_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            BSDF dielectric_brdf_2_out = BSDF(vec3(0.0),vec3(1.0));
            mx_dielectric_bsdf(closureData, dielectric_brdf_2_weight, dielectric_brdf_2_tint, dielectric_brdf_2_ior, dielectric_brdf_2_roughness, dielectric_brdf_2_retroreflective, dielectric_brdf_2_thinfilm_thickness, dielectric_brdf_2_thinfilm_ior, geomprop_Nworld_out1, geomprop_Tworld_out1, dielectric_brdf_2_distribution, dielectric_brdf_2_scatter_mode, dielectric_brdf_2_out);
            BSDF dielectric_brdf_1_out = BSDF(vec3(0.0),vec3(1.0));
            mx_dielectric_bsdf(closureData, dielectric_brdf_1_weight, dielectric_brdf_1_tint, dielectric_brdf_1_ior, dielectric_brdf_1_roughness, dielectric_brdf_1_retroreflective, dielectric_brdf_1_thinfilm_thickness, dielectric_brdf_1_thinfilm_ior, geomprop_Nworld_out1, geomprop_Tworld_out1, dielectric_brdf_1_distribution, dielectric_brdf_1_scatter_mode, dielectric_brdf_1_out);
            BSDF layer_bsdf_1_out = BSDF(vec3(0.0),vec3(1.0));
            mx_layer_bsdf(closureData, dielectric_brdf_2_out, dielectric_brdf_1_out, layer_bsdf_1_out);
            BSDF sheen_brdf_1_out = BSDF(vec3(0.0),vec3(1.0));
            mx_sheen_bsdf(closureData, sheen_brdf_1_weight, sheen_brdf_1_color, sheen_brdf_1_roughness, geomprop_Nworld_out1, sheen_brdf_1_mode, sheen_brdf_1_out);
            BSDF layer_bsdf_2_out = BSDF(vec3(0.0),vec3(1.0));
            mx_layer_bsdf(closureData, layer_bsdf_1_out, sheen_brdf_1_out, layer_bsdf_2_out);
            BSDF diffuse_brdf_1_out = BSDF(vec3(0.0),vec3(1.0));
            mx_oren_nayar_diffuse_bsdf(closureData, diffuse_brdf_1_weight, diffuse_brdf_1_color, diffuse_brdf_1_roughness, geomprop_Nworld_out1, diffuse_brdf_1_energy_compensation, diffuse_brdf_1_out);
            BSDF layer_bsdf_3_out = BSDF(vec3(0.0),vec3(1.0));
            mx_layer_bsdf(closureData, layer_bsdf_2_out, diffuse_brdf_1_out, layer_bsdf_3_out);

            surface1_out.color += occlusion * layer_bsdf_3_out.response;
        }
        ...
        BSDF layer_bsdf_3_out = BSDF(vec3(0.0),vec3(1.0));
        mx_layer_bsdf(closureData, layer_bsdf_2_out, diffuse_brdf_1_out, layer_bsdf_3_out);
        surface1_out.color += layer_bsdf_3_out.response;
