...
uniform float schlick_R2_weight = 1.000000;
uniform vec3 schlick_R2_color0 = vec3(0.800000, 0.200000, 0.200000);
uniform vec3 schlick_R2_color82 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 schlick_R2_color90 = vec3(0.200000, 0.800000, 0.200000);
uniform float schlick_R2_exponent = 5.000000;
uniform vec2 schlick_R2_roughness = vec2(0.020000, 0.020000);
uniform bool schlick_R2_retroreflective = false;
uniform float schlick_R2_thinfilm_thickness = 0.000000;
uniform float schlick_R2_thinfilm_ior = 1.500000;
uniform int schlick_R2_distribution = 0;
uniform int schlick_R2_scatter_mode = 0;
uniform float schlick_T2_weight = 1.000000;
uniform vec3 schlick_T2_color0 = vec3(0.800000, 0.200000, 0.200000);
uniform vec3 schlick_T2_color82 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 schlick_T2_color90 = vec3(0.200000, 0.800000, 0.200000);
uniform float schlick_T2_exponent = 5.000000;
uniform vec2 schlick_T2_roughness = vec2(0.020000, 0.020000);
uniform bool schlick_T2_retroreflective = false;
uniform float schlick_T2_thinfilm_thickness = 0.000000;
uniform float schlick_T2_thinfilm_ior = 1.500000;
uniform int schlick_T2_distribution = 0;
uniform int schlick_T2_scatter_mode = 1;
uniform float surface_layer_RT2_opacity = 1.000000;
uniform bool surface_layer_RT2_thin_walled = false;
...
void main()
{
    ...
    surfaceshader surface_layer_RT2_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        float surfaceOpacity = surface_layer_RT2_opacity;
        ...
        // Add environment contribution
        {
            ...
            BSDF schlick_R2_out = BSDF(vec3(0.0),vec3(1.0));
            mx_generalized_schlick_bsdf_metashade(closureData, schlick_R2_weight, schlick_R2_color0, schlick_R2_color82, schlick_R2_color90, schlick_R2_exponent, schlick_R2_roughness, schlick_R2_retroreflective, schlick_R2_thinfilm_thickness, schlick_R2_thinfilm_ior, geomprop_Nworld_out1, geomprop_Tworld_out1, schlick_R2_distribution, schlick_R2_scatter_mode, schlick_R2_out);
            BSDF schlick_T2_out = BSDF(vec3(0.0),vec3(1.0));
            mx_generalized_schlick_bsdf_metashade(closureData, schlick_T2_weight, schlick_T2_color0, schlick_T2_color82, schlick_T2_color90, schlick_T2_exponent, schlick_T2_roughness, schlick_T2_retroreflective, schlick_T2_thinfilm_thickness, schlick_T2_thinfilm_ior, geomprop_Nworld_out1, geomprop_Tworld_out1, schlick_T2_distribution, schlick_T2_scatter_mode, schlick_T2_out);
            BSDF layer_RT2_out2 = BSDF(vec3(0.0),vec3(1.0));
            mx_layer_bsdf(closureData, schlick_R2_out, schlick_T2_out, layer_RT2_out2);

            surface_layer_RT2_out.color += occlusion * layer_RT2_out2.response;
        }
        ...
        BSDF layer_RT2_out2 = BSDF(vec3(0.0),vec3(1.0));
        mx_layer_bsdf(closureData, schlick_R2_out, schlick_T2_out, layer_RT2_out2);
        surface_layer_RT2_out.color += layer_RT2_out2.response;

        // Compute and apply surface opacity
        {
            surface_layer_RT2_out.color *= surfaceOpacity;
            surface_layer_RT2_out.transparency = mix(vec3(1.000000, 1.000000, 1.000000), surface_layer_RT2_out.transparency, surfaceOpacity);
        }
    }

    layer_RT2_out1 = vec4(surface_layer_RT2_out.color, 1.0);
}
