...
uniform float surface_T2_opacity = 1.000000;
uniform bool surface_T2_thin_walled = false;
...
void main()
{
    ...
    surfaceshader surface_T2_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        float surfaceOpacity = surface_T2_opacity;
        ...
        // Add environment contribution
        {
            ...
            surface_T2_out.color += occlusion * schlick_T2_out.response;
        }
        ...
        BSDF schlick_T2_out = BSDF(vec3(0.0),vec3(1.0));
        mx_generalized_schlick_bsdf_metashade(closureData, schlick_T2_weight, schlick_T2_color0, schlick_T2_color82, schlick_T2_color90, schlick_T2_exponent, schlick_T2_roughness, schlick_T2_retroreflective, schlick_T2_thinfilm_thickness, schlick_T2_thinfilm_ior, geomprop_Nworld_out1, geomprop_Tworld_out1, schlick_T2_distribution, schlick_T2_scatter_mode, schlick_T2_out);
        surface_T2_out.color += schlick_T2_out.response;

        // Compute and apply surface opacity
        {
            surface_T2_out.color *= surfaceOpacity;
            surface_T2_out.transparency = mix(vec3(1.000000, 1.000000, 1.000000), surface_T2_out.transparency, surfaceOpacity);
        }
    }

    T2_out1 = vec4(surface_T2_out.color, 1.0);
}
