...
uniform float surface_R2_opacity = 1.000000;
uniform bool surface_R2_thin_walled = false;
...
void main()
{
    ...
    surfaceshader surface_R2_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        float surfaceOpacity = surface_R2_opacity;
        ...
        // Add environment contribution
        {
            ...
            surface_R2_out.color += occlusion * schlick_R2_out.response;
        }
        ...
        BSDF schlick_R2_out = BSDF(vec3(0.0),vec3(1.0));
        mx_generalized_schlick_bsdf_metashade(closureData, schlick_R2_weight, schlick_R2_color0, schlick_R2_color82, schlick_R2_color90, schlick_R2_exponent, schlick_R2_roughness, schlick_R2_retroreflective, schlick_R2_thinfilm_thickness, schlick_R2_thinfilm_ior, geomprop_Nworld_out1, geomprop_Tworld_out1, schlick_R2_distribution, schlick_R2_scatter_mode, schlick_R2_out);
        surface_R2_out.color += schlick_R2_out.response;

        // Compute and apply surface opacity
        {
            surface_R2_out.color *= surfaceOpacity;
            surface_R2_out.transparency = mix(vec3(1.000000, 1.000000, 1.000000), surface_R2_out.transparency, surfaceOpacity);
        }
    }

    R2_out1 = vec4(surface_R2_out.color, 1.0);
}
