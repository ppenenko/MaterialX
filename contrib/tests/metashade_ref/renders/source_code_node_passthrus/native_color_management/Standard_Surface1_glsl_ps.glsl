...
uniform int texcoord2_index = 0;
uniform vec3 switch2_in1_cm_in = vec3(0.642500, 0.532400, 0.479800);
uniform vec3 switch2_in2_cm_in = vec3(0.859100, 0.744700, 0.687800);
uniform vec3 switch2_in3_cm_in = vec3(0.587900, 0.663900, 0.763800);
uniform vec3 switch2_in4_cm_in = vec3(0.550200, 0.620500, 0.475900);
uniform vec3 switch2_in5_cm_in = vec3(0.696500, 0.681900, 0.816400);
uniform vec3 switch2_in6_cm_in = vec3(0.604300, 0.846700, 0.798300);
uniform vec3 switch2_in7_cm_in = vec3(0.907200, 0.675900, 0.376800);
uniform vec3 switch2_in8_cm_in = vec3(0.525200, 0.564100, 0.787800);
uniform vec3 switch2_in9_cm_in = vec3(0.856600, 0.560700, 0.591200);
uniform vec3 switch2_in10_cm_in = vec3(0.574400, 0.447600, 0.620500);
uniform vec3 switch3_in1_cm_in = vec3(0.696300, 0.597100, 0.548400);
uniform vec3 switch3_in2_cm_in = vec3(0.883100, 0.785700, 0.736200);
uniform vec3 switch3_in3_cm_in = vec3(0.647500, 0.715300, 0.802100);
uniform vec3 switch3_in4_cm_in = vec3(0.613400, 0.676700, 0.544700);
uniform vec3 switch3_in5_cm_in = vec3(0.743900, 0.731000, 0.847100);
uniform vec3 switch3_in6_cm_in = vec3(0.662300, 0.872700, 0.831700);
uniform vec3 switch3_in7_cm_in = vec3(0.923400, 0.725800, 0.449900);
uniform vec3 switch3_in8_cm_in = vec3(0.590400, 0.626000, 0.822700);
uniform vec3 switch3_in9_cm_in = vec3(0.881100, 0.622900, 0.650500);
uniform vec3 switch3_in10_cm_in = vec3(0.635300, 0.518000, 0.676700);
uniform vec3 switch4_in1_cm_in = vec3(0.717600, 0.623300, 0.576500);
uniform vec3 switch4_in2_cm_in = vec3(0.892300, 0.801600, 0.755200);
uniform vec3 switch4_in3_cm_in = vec3(0.671400, 0.735500, 0.817000);
uniform vec3 switch4_in4_cm_in = vec3(0.638900, 0.699100, 0.573000);
uniform vec3 switch4_in5_cm_in = vec3(0.762400, 0.750400, 0.858900);
uniform vec3 switch4_in6_cm_in = vec3(0.685400, 0.882700, 0.844600);
uniform vec3 switch4_in7_cm_in = vec3(0.929600, 0.745500, 0.480900);
uniform vec3 switch4_in8_cm_in = vec3(0.616900, 0.650900, 0.836200);
uniform vec3 switch4_in9_cm_in = vec3(0.890400, 0.648000, 0.674200);
uniform vec3 switch4_in10_cm_in = vec3(0.659800, 0.547200, 0.699100);
uniform vec3 switch5_in1_cm_in = vec3(0.398300, 0.329900, 0.276500);
uniform vec3 switch5_in2_cm_in = vec3(0.690300, 0.599300, 0.523600);
uniform vec3 switch5_in3_cm_in = vec3(0.427200, 0.473700, 0.595900);
uniform vec3 switch5_in4_cm_in = vec3(0.365400, 0.415600, 0.282000);
uniform vec3 switch5_in5_cm_in = vec3(0.523100, 0.505900, 0.669500);
uniform vec3 switch5_in6_cm_in = vec3(0.530900, 0.716500, 0.669400);
uniform vec3 switch5_in7_cm_in = vec3(0.690500, 0.514000, 0.221500);
uniform vec3 switch5_in8_cm_in = vec3(0.344400, 0.357800, 0.611800);
uniform vec3 switch5_in9_cm_in = vec3(0.602300, 0.381800, 0.392000);
uniform vec3 switch5_in10_cm_in = vec3(0.326000, 0.247200, 0.401800);
uniform vec3 switch6_in1_cm_in = vec3(0.658100, 0.604100, 0.557500);
uniform vec3 switch6_in2_cm_in = vec3(0.845000, 0.792400, 0.745200);
uniform vec3 switch6_in3_cm_in = vec3(0.679400, 0.712000, 0.790300);
uniform vec3 switch6_in4_cm_in = vec3(0.632800, 0.670900, 0.562500);
uniform vec3 switch6_in5_cm_in = vec3(0.744900, 0.733700, 0.833300);
uniform vec3 switch6_in6_cm_in = vec3(0.749900, 0.859400, 0.833200);
uniform vec3 switch6_in7_cm_in = vec3(0.845000, 0.739000, 0.504000);
uniform vec3 switch6_in8_cm_in = vec3(0.616000, 0.626800, 0.799800);
uniform vec3 switch6_in9_cm_in = vec3(0.794100, 0.645500, 0.653300);
uniform vec3 switch6_in10_cm_in = vec3(0.600800, 0.529800, 0.660700);
uniform vec3 switch7_in1_cm_in = vec3(0.702100, 0.602600, 0.553200);
uniform vec3 switch7_in2_cm_in = vec3(0.886400, 0.790700, 0.741800);
uniform vec3 switch7_in3_cm_in = vec3(0.653300, 0.721000, 0.807000);
uniform vec3 switch7_in4_cm_in = vec3(0.619000, 0.682500, 0.549500);
uniform vec3 switch7_in5_cm_in = vec3(0.749400, 0.736600, 0.851100);
uniform vec3 switch7_in6_cm_in = vec3(0.668100, 0.876200, 0.836000);
uniform vec3 switch7_in7_cm_in = vec3(0.925700, 0.731500, 0.452300);
uniform vec3 switch7_in8_cm_in = vec3(0.595900, 0.631700, 0.827200);
uniform vec3 switch7_in9_cm_in = vec3(0.884400, 0.628600, 0.656300);
uniform vec3 switch7_in10_cm_in = vec3(0.641100, 0.522300, 0.682500);
uniform vec3 switch8_in1_cm_in = vec3(0.414100, 0.321600, 0.268900);
uniform vec3 switch8_in2_cm_in = vec3(0.711600, 0.588200, 0.513000);
uniform vec3 switch8_in3_cm_in = vec3(0.411100, 0.478400, 0.610000);
uniform vec3 switch8_in4_cm_in = vec3(0.364600, 0.423500, 0.269400);
uniform vec3 switch8_in5_cm_in = vec3(0.516000, 0.502000, 0.686200);
uniform vec3 switch8_in6_cm_in = vec3(0.500000, 0.741200, 0.669700);
uniform vec3 switch8_in7_cm_in = vec3(0.740900, 0.494100, 0.185800);
uniform vec3 switch8_in8_cm_in = vec3(0.326000, 0.356900, 0.638900);
uniform vec3 switch8_in9_cm_in = vec3(0.641800, 0.352900, 0.386800);
uniform vec3 switch8_in10_cm_in = vec3(0.330600, 0.235300, 0.415800);
uniform vec3 switch9_in1_cm_in = vec3(0.669700, 0.597000, 0.550400);
uniform vec3 switch9_in2_cm_in = vec3(0.856700, 0.785600, 0.738200);
uniform vec3 switch9_in3_cm_in = vec3(0.667500, 0.715200, 0.798700);
uniform vec3 switch9_in4_cm_in = vec3(0.632100, 0.676600, 0.550800);
uniform vec3 switch9_in5_cm_in = vec3(0.740200, 0.731000, 0.842600);
uniform vec3 switch9_in6_cm_in = vec3(0.729700, 0.872700, 0.833400);
uniform vec3 switch9_in7_cm_in = vec3(0.872500, 0.725700, 0.465200);
uniform vec3 switch9_in8_cm_in = vec3(0.600700, 0.625900, 0.815700);
uniform vec3 switch9_in9_cm_in = vec3(0.817400, 0.622800, 0.649300);
uniform vec3 switch9_in10_cm_in = vec3(0.604600, 0.517900, 0.671000);
uniform vec3 switch10_in1_cm_in = vec3(0.685800, 0.606200, 0.560000);
uniform vec3 switch10_in2_cm_in = vec3(0.870400, 0.794200, 0.748200);
uniform vec3 switch10_in3_cm_in = vec3(0.666000, 0.718800, 0.798800);
uniform vec3 switch10_in4_cm_in = vec3(0.630900, 0.680600, 0.561800);
uniform vec3 switch10_in5_cm_in = vec3(0.747100, 0.737100, 0.841900);
uniform vec3 switch10_in6_cm_in = vec3(0.711000, 0.870300, 0.836500);
uniform vec3 switch10_in7_cm_in = vec3(0.895200, 0.739000, 0.492600);
uniform vec3 switch10_in8_cm_in = vec3(0.602400, 0.630600, 0.811700);
uniform vec3 switch10_in9_cm_in = vec3(0.846200, 0.639300, 0.659100);
uniform vec3 switch10_in10_cm_in = vec3(0.622100, 0.526800, 0.671900);
uniform vec3 switch11_in1_cm_in = vec3(0.428000, 0.325900, 0.273800);
uniform vec3 switch11_in2_cm_in = vec3(0.730200, 0.594000, 0.519800);
uniform vec3 switch11_in3_cm_in = vec3(0.401000, 0.475300, 0.601800);
uniform vec3 switch11_in4_cm_in = vec3(0.355800, 0.420800, 0.275700);
uniform vec3 switch11_in5_cm_in = vec3(0.518100, 0.502600, 0.677300);
uniform vec3 switch11_in6_cm_in = vec3(0.463800, 0.730000, 0.667600);
uniform vec3 switch11_in7_cm_in = vec3(0.777900, 0.505600, 0.207200);
uniform vec3 switch11_in8_cm_in = vec3(0.321400, 0.355400, 0.623900);
uniform vec3 switch11_in9_cm_in = vec3(0.685200, 0.366300, 0.392000);
uniform vec3 switch11_in10_cm_in = vec3(0.345000, 0.239700, 0.409000);
uniform int extract1_index = 0;
uniform float multiply2_in2 = 2.000000;
uniform float add1_in2 = 1.000000;
uniform float multiply1_in2 = 5.000000;
uniform float multiply3_in2 = 20.000000;
uniform float standard_surface1_base = 1.000000;
uniform float standard_surface1_diffuse_roughness = 0.000000;
uniform float standard_surface1_metalness = 0.000000;
uniform float standard_surface1_specular = 1.000000;
uniform vec3 standard_surface1_specular_color = vec3(1.000000, 1.000000, 1.000000);
uniform float standard_surface1_specular_roughness = 0.200000;
uniform float standard_surface1_specular_IOR = 1.500000;
uniform float standard_surface1_specular_anisotropy = 0.000000;
uniform float standard_surface1_specular_rotation = 0.000000;
uniform float standard_surface1_transmission = 0.000000;
uniform vec3 standard_surface1_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float standard_surface1_transmission_depth = 0.000000;
uniform vec3 standard_surface1_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float standard_surface1_transmission_scatter_anisotropy = 0.000000;
uniform float standard_surface1_transmission_dispersion = 0.000000;
uniform float standard_surface1_transmission_extra_roughness = 0.000000;
uniform float standard_surface1_subsurface = 0.000000;
uniform vec3 standard_surface1_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 standard_surface1_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float standard_surface1_subsurface_scale = 1.000000;
uniform float standard_surface1_subsurface_anisotropy = 0.000000;
uniform float standard_surface1_sheen = 0.000000;
uniform vec3 standard_surface1_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float standard_surface1_sheen_roughness = 0.300000;
uniform float standard_surface1_coat = 0.000000;
uniform vec3 standard_surface1_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float standard_surface1_coat_roughness = 0.100000;
uniform float standard_surface1_coat_anisotropy = 0.000000;
uniform float standard_surface1_coat_rotation = 0.000000;
uniform float standard_surface1_coat_IOR = 1.500000;
uniform float standard_surface1_coat_affect_color = 0.000000;
uniform float standard_surface1_coat_affect_roughness = 0.000000;
uniform float standard_surface1_thin_film_thickness = 0.000000;
uniform float standard_surface1_thin_film_IOR = 1.500000;
uniform float standard_surface1_emission = 0.000000;
uniform vec3 standard_surface1_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 standard_surface1_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool standard_surface1_thin_walled = false;
...
void NG_g18_rec709_to_lin_rec709_color3(vec3 in1, out vec3 out1)
{
    const float max_in2_tmp = 0.000000;
    vec3 max_out = max(in1, max_in2_tmp);
    const float gamma_in2_tmp = 1.800000;
    vec3 gamma_out = pow(max_out, vec3(gamma_in2_tmp));
    out1 = gamma_out;
}

void NG_g22_rec709_to_lin_rec709_color3(vec3 in1, out vec3 out1)
{
    const float max_in2_tmp = 0.000000;
    vec3 max_out = max(in1, max_in2_tmp);
    const float gamma_in2_tmp = 2.200000;
    vec3 gamma_out = pow(max_out, vec3(gamma_in2_tmp));
    out1 = gamma_out;
}

void NG_rec709_display_to_lin_rec709_color3(vec3 in1, out vec3 out1)
{
    const float max_in2_tmp = 0.000000;
    vec3 max_out = max(in1, max_in2_tmp);
    const float gamma_in2_tmp = 2.400000;
    vec3 gamma_out = pow(max_out, vec3(gamma_in2_tmp));
    out1 = gamma_out;
}
...
void NG_acescg_to_lin_rec709_color3(vec3 in1, out vec3 out1)
{
    ...
    vec3 transform_out = mx_matrix_mul(transform_mat_tmp, asVec_out);
    vec3 asColor_out = vec3(0.0);
    NG_convert_vector3_color3(transform_out, asColor_out);
    out1 = asColor_out;
}

void NG_g22_ap1_to_lin_rec709_color3(vec3 in1, out vec3 out1)
{
    const float max_in2_tmp = 0.000000;
    vec3 max_out = max(in1, max_in2_tmp);
    const float gamma_in2_tmp = 2.200000;
    vec3 gamma_out = pow(max_out, vec3(gamma_in2_tmp));
    vec3 rec709_out = vec3(0.0);
...
void NG_lin_adobergb_to_lin_rec709_color3(vec3 in1, out vec3 out1)
{
    vec3 asVec_out = vec3(0.0);
    NG_convert_color3_vector3(in1, asVec_out);
    const mat3 transform_mat_tmp = mat3(1.398356, -0.000000, 0.000000, -0.398356, 1.000000, -0.042929, 0.000000, 0.000000, 1.042929);
    vec3 transform_out = mx_matrix_mul(transform_mat_tmp, asVec_out);
    vec3 asColor_out = vec3(0.0);
    NG_convert_vector3_color3(transform_out, asColor_out);
    out1 = asColor_out;
...
void NG_adobergb_to_lin_rec709_color3(vec3 in1, out vec3 out1)
{
    const float max_in2_tmp = 0.000000;
    vec3 max_out = max(in1, max_in2_tmp);
    const float constant_in1_tmp = 563.000000;
    const float constant_in2_tmp = 256.000000;
    float constant_out = constant_in1_tmp / constant_in2_tmp;
    vec3 gamma_out = pow(max_out, vec3(constant_out));
    vec3 rec709_out = vec3(0.0);
    NG_lin_adobergb_to_lin_rec709_color3(gamma_out, rec709_out);
    out1 = rec709_out;
}

void NG_srgb_displayp3_to_lin_rec709_color3(vec3 in1, out vec3 out1)
{
    vec3 srgb_transform_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(in1, srgb_transform_out);
    vec3 asVec_out = vec3(0.0);
    NG_convert_color3_vector3(srgb_transform_out, asVec_out);
    const mat3 transform_mat_tmp = mat3(1.224930, -0.042059, -0.019641, -0.224930, 1.042059, -0.078648, 0.000000, -0.000000, 1.098289);
    vec3 transform_out = mx_matrix_mul(transform_mat_tmp, asVec_out);
    vec3 asColor_out = vec3(0.0);
    NG_convert_vector3_color3(transform_out, asColor_out);
    out1 = asColor_out;
...
void NG_lin_displayp3_to_lin_rec709_color3(vec3 in1, out vec3 out1)
{
    vec3 asVec_out = vec3(0.0);
    NG_convert_color3_vector3(in1, asVec_out);
    const mat3 transform_mat_tmp = mat3(1.224930, -0.042059, -0.019641, -0.224930, 1.042059, -0.078648, 0.000000, -0.000000, 1.098289);
...
void NG_trianglewave_float(float in1, out float out1)
{
    float absval1_out = abs(in1);
    const float modulo1_in2_tmp = 1.000000;
    float modulo1_out = mx_mod(absval1_out, modulo1_in2_tmp);
    const float subtract1_in2_tmp = 0.500000;
    float subtract1_out = modulo1_out - subtract1_in2_tmp;
    float absval2_out = abs(subtract1_out);
    const float subtract2_in1_tmp = 0.500000;
    float subtract2_out = subtract2_in1_tmp - absval2_out;
    out1 = subtract2_out;
}
...
void main()
{
    ...
    vec2 texcoord2_out = vd.texcoord_0.xy;
    vec3 position1_out = vd.positionObject;
    vec3 switch2_in1_cm_out = vec3(0.0);
    NG_g18_rec709_to_lin_rec709_color3(switch2_in1_cm_in, switch2_in1_cm_out);
    vec3 switch2_in2_cm_out = vec3(0.0);
    NG_g18_rec709_to_lin_rec709_color3(switch2_in2_cm_in, switch2_in2_cm_out);
    vec3 switch2_in3_cm_out = vec3(0.0);
    NG_g18_rec709_to_lin_rec709_color3(switch2_in3_cm_in, switch2_in3_cm_out);
    vec3 switch2_in4_cm_out = vec3(0.0);
    NG_g18_rec709_to_lin_rec709_color3(switch2_in4_cm_in, switch2_in4_cm_out);
    vec3 switch2_in5_cm_out = vec3(0.0);
    NG_g18_rec709_to_lin_rec709_color3(switch2_in5_cm_in, switch2_in5_cm_out);
    vec3 switch2_in6_cm_out = vec3(0.0);
    NG_g18_rec709_to_lin_rec709_color3(switch2_in6_cm_in, switch2_in6_cm_out);
    vec3 switch2_in7_cm_out = vec3(0.0);
    NG_g18_rec709_to_lin_rec709_color3(switch2_in7_cm_in, switch2_in7_cm_out);
    vec3 switch2_in8_cm_out = vec3(0.0);
    NG_g18_rec709_to_lin_rec709_color3(switch2_in8_cm_in, switch2_in8_cm_out);
    vec3 switch2_in9_cm_out = vec3(0.0);
    NG_g18_rec709_to_lin_rec709_color3(switch2_in9_cm_in, switch2_in9_cm_out);
    vec3 switch2_in10_cm_out = vec3(0.0);
    NG_g18_rec709_to_lin_rec709_color3(switch2_in10_cm_in, switch2_in10_cm_out);
    vec3 switch3_in1_cm_out = vec3(0.0);
    NG_g22_rec709_to_lin_rec709_color3(switch3_in1_cm_in, switch3_in1_cm_out);
    vec3 switch3_in2_cm_out = vec3(0.0);
    NG_g22_rec709_to_lin_rec709_color3(switch3_in2_cm_in, switch3_in2_cm_out);
    vec3 switch3_in3_cm_out = vec3(0.0);
    NG_g22_rec709_to_lin_rec709_color3(switch3_in3_cm_in, switch3_in3_cm_out);
    vec3 switch3_in4_cm_out = vec3(0.0);
    NG_g22_rec709_to_lin_rec709_color3(switch3_in4_cm_in, switch3_in4_cm_out);
    vec3 switch3_in5_cm_out = vec3(0.0);
    NG_g22_rec709_to_lin_rec709_color3(switch3_in5_cm_in, switch3_in5_cm_out);
    vec3 switch3_in6_cm_out = vec3(0.0);
    NG_g22_rec709_to_lin_rec709_color3(switch3_in6_cm_in, switch3_in6_cm_out);
    vec3 switch3_in7_cm_out = vec3(0.0);
    NG_g22_rec709_to_lin_rec709_color3(switch3_in7_cm_in, switch3_in7_cm_out);
    vec3 switch3_in8_cm_out = vec3(0.0);
    NG_g22_rec709_to_lin_rec709_color3(switch3_in8_cm_in, switch3_in8_cm_out);
    vec3 switch3_in9_cm_out = vec3(0.0);
    NG_g22_rec709_to_lin_rec709_color3(switch3_in9_cm_in, switch3_in9_cm_out);
    vec3 switch3_in10_cm_out = vec3(0.0);
    NG_g22_rec709_to_lin_rec709_color3(switch3_in10_cm_in, switch3_in10_cm_out);
    vec3 switch4_in1_cm_out = vec3(0.0);
    NG_rec709_display_to_lin_rec709_color3(switch4_in1_cm_in, switch4_in1_cm_out);
    vec3 switch4_in2_cm_out = vec3(0.0);
    NG_rec709_display_to_lin_rec709_color3(switch4_in2_cm_in, switch4_in2_cm_out);
    vec3 switch4_in3_cm_out = vec3(0.0);
    NG_rec709_display_to_lin_rec709_color3(switch4_in3_cm_in, switch4_in3_cm_out);
    vec3 switch4_in4_cm_out = vec3(0.0);
    NG_rec709_display_to_lin_rec709_color3(switch4_in4_cm_in, switch4_in4_cm_out);
    vec3 switch4_in5_cm_out = vec3(0.0);
    NG_rec709_display_to_lin_rec709_color3(switch4_in5_cm_in, switch4_in5_cm_out);
    vec3 switch4_in6_cm_out = vec3(0.0);
    NG_rec709_display_to_lin_rec709_color3(switch4_in6_cm_in, switch4_in6_cm_out);
    vec3 switch4_in7_cm_out = vec3(0.0);
    NG_rec709_display_to_lin_rec709_color3(switch4_in7_cm_in, switch4_in7_cm_out);
    vec3 switch4_in8_cm_out = vec3(0.0);
    NG_rec709_display_to_lin_rec709_color3(switch4_in8_cm_in, switch4_in8_cm_out);
    vec3 switch4_in9_cm_out = vec3(0.0);
    NG_rec709_display_to_lin_rec709_color3(switch4_in9_cm_in, switch4_in9_cm_out);
    vec3 switch4_in10_cm_out = vec3(0.0);
    NG_rec709_display_to_lin_rec709_color3(switch4_in10_cm_in, switch4_in10_cm_out);
    vec3 switch5_in1_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch5_in1_cm_in, switch5_in1_cm_out);
    vec3 switch5_in2_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch5_in2_cm_in, switch5_in2_cm_out);
    vec3 switch5_in3_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch5_in3_cm_in, switch5_in3_cm_out);
    vec3 switch5_in4_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch5_in4_cm_in, switch5_in4_cm_out);
    vec3 switch5_in5_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch5_in5_cm_in, switch5_in5_cm_out);
    vec3 switch5_in6_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch5_in6_cm_in, switch5_in6_cm_out);
    vec3 switch5_in7_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch5_in7_cm_in, switch5_in7_cm_out);
    vec3 switch5_in8_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch5_in8_cm_in, switch5_in8_cm_out);
    vec3 switch5_in9_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch5_in9_cm_in, switch5_in9_cm_out);
    vec3 switch5_in10_cm_out = vec3(0.0);
    NG_acescg_to_lin_rec709_color3(switch5_in10_cm_in, switch5_in10_cm_out);
    vec3 switch6_in1_cm_out = vec3(0.0);
    NG_g22_ap1_to_lin_rec709_color3(switch6_in1_cm_in, switch6_in1_cm_out);
    vec3 switch6_in2_cm_out = vec3(0.0);
    NG_g22_ap1_to_lin_rec709_color3(switch6_in2_cm_in, switch6_in2_cm_out);
    vec3 switch6_in3_cm_out = vec3(0.0);
    NG_g22_ap1_to_lin_rec709_color3(switch6_in3_cm_in, switch6_in3_cm_out);
    vec3 switch6_in4_cm_out = vec3(0.0);
    NG_g22_ap1_to_lin_rec709_color3(switch6_in4_cm_in, switch6_in4_cm_out);
    vec3 switch6_in5_cm_out = vec3(0.0);
    NG_g22_ap1_to_lin_rec709_color3(switch6_in5_cm_in, switch6_in5_cm_out);
    vec3 switch6_in6_cm_out = vec3(0.0);
    NG_g22_ap1_to_lin_rec709_color3(switch6_in6_cm_in, switch6_in6_cm_out);
    vec3 switch6_in7_cm_out = vec3(0.0);
    NG_g22_ap1_to_lin_rec709_color3(switch6_in7_cm_in, switch6_in7_cm_out);
    vec3 switch6_in8_cm_out = vec3(0.0);
    NG_g22_ap1_to_lin_rec709_color3(switch6_in8_cm_in, switch6_in8_cm_out);
    vec3 switch6_in9_cm_out = vec3(0.0);
    NG_g22_ap1_to_lin_rec709_color3(switch6_in9_cm_in, switch6_in9_cm_out);
    vec3 switch6_in10_cm_out = vec3(0.0);
    NG_g22_ap1_to_lin_rec709_color3(switch6_in10_cm_in, switch6_in10_cm_out);
    vec3 switch7_in1_cm_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(switch7_in1_cm_in, switch7_in1_cm_out);
    vec3 switch7_in2_cm_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(switch7_in2_cm_in, switch7_in2_cm_out);
    vec3 switch7_in3_cm_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(switch7_in3_cm_in, switch7_in3_cm_out);
    vec3 switch7_in4_cm_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(switch7_in4_cm_in, switch7_in4_cm_out);
    vec3 switch7_in5_cm_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(switch7_in5_cm_in, switch7_in5_cm_out);
    vec3 switch7_in6_cm_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(switch7_in6_cm_in, switch7_in6_cm_out);
    vec3 switch7_in7_cm_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(switch7_in7_cm_in, switch7_in7_cm_out);
    vec3 switch7_in8_cm_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(switch7_in8_cm_in, switch7_in8_cm_out);
    vec3 switch7_in9_cm_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(switch7_in9_cm_in, switch7_in9_cm_out);
    vec3 switch7_in10_cm_out = vec3(0.0);
    NG_srgb_texture_to_lin_rec709_color3(switch7_in10_cm_in, switch7_in10_cm_out);
    vec3 switch8_in1_cm_out = vec3(0.0);
    NG_lin_adobergb_to_lin_rec709_color3(switch8_in1_cm_in, switch8_in1_cm_out);
    vec3 switch8_in2_cm_out = vec3(0.0);
    NG_lin_adobergb_to_lin_rec709_color3(switch8_in2_cm_in, switch8_in2_cm_out);
    vec3 switch8_in3_cm_out = vec3(0.0);
    NG_lin_adobergb_to_lin_rec709_color3(switch8_in3_cm_in, switch8_in3_cm_out);
    vec3 switch8_in4_cm_out = vec3(0.0);
    NG_lin_adobergb_to_lin_rec709_color3(switch8_in4_cm_in, switch8_in4_cm_out);
    vec3 switch8_in5_cm_out = vec3(0.0);
    NG_lin_adobergb_to_lin_rec709_color3(switch8_in5_cm_in, switch8_in5_cm_out);
    vec3 switch8_in6_cm_out = vec3(0.0);
    NG_lin_adobergb_to_lin_rec709_color3(switch8_in6_cm_in, switch8_in6_cm_out);
    vec3 switch8_in7_cm_out = vec3(0.0);
    NG_lin_adobergb_to_lin_rec709_color3(switch8_in7_cm_in, switch8_in7_cm_out);
    vec3 switch8_in8_cm_out = vec3(0.0);
    NG_lin_adobergb_to_lin_rec709_color3(switch8_in8_cm_in, switch8_in8_cm_out);
    vec3 switch8_in9_cm_out = vec3(0.0);
    NG_lin_adobergb_to_lin_rec709_color3(switch8_in9_cm_in, switch8_in9_cm_out);
    vec3 switch8_in10_cm_out = vec3(0.0);
    NG_lin_adobergb_to_lin_rec709_color3(switch8_in10_cm_in, switch8_in10_cm_out);
    vec3 switch9_in1_cm_out = vec3(0.0);
    NG_adobergb_to_lin_rec709_color3(switch9_in1_cm_in, switch9_in1_cm_out);
    vec3 switch9_in2_cm_out = vec3(0.0);
    NG_adobergb_to_lin_rec709_color3(switch9_in2_cm_in, switch9_in2_cm_out);
    vec3 switch9_in3_cm_out = vec3(0.0);
    NG_adobergb_to_lin_rec709_color3(switch9_in3_cm_in, switch9_in3_cm_out);
    vec3 switch9_in4_cm_out = vec3(0.0);
    NG_adobergb_to_lin_rec709_color3(switch9_in4_cm_in, switch9_in4_cm_out);
    vec3 switch9_in5_cm_out = vec3(0.0);
    NG_adobergb_to_lin_rec709_color3(switch9_in5_cm_in, switch9_in5_cm_out);
    vec3 switch9_in6_cm_out = vec3(0.0);
    NG_adobergb_to_lin_rec709_color3(switch9_in6_cm_in, switch9_in6_cm_out);
    vec3 switch9_in7_cm_out = vec3(0.0);
    NG_adobergb_to_lin_rec709_color3(switch9_in7_cm_in, switch9_in7_cm_out);
    vec3 switch9_in8_cm_out = vec3(0.0);
    NG_adobergb_to_lin_rec709_color3(switch9_in8_cm_in, switch9_in8_cm_out);
    vec3 switch9_in9_cm_out = vec3(0.0);
    NG_adobergb_to_lin_rec709_color3(switch9_in9_cm_in, switch9_in9_cm_out);
    vec3 switch9_in10_cm_out = vec3(0.0);
    NG_adobergb_to_lin_rec709_color3(switch9_in10_cm_in, switch9_in10_cm_out);
    vec3 switch10_in1_cm_out = vec3(0.0);
    NG_srgb_displayp3_to_lin_rec709_color3(switch10_in1_cm_in, switch10_in1_cm_out);
    vec3 switch10_in2_cm_out = vec3(0.0);
    NG_srgb_displayp3_to_lin_rec709_color3(switch10_in2_cm_in, switch10_in2_cm_out);
    vec3 switch10_in3_cm_out = vec3(0.0);
    NG_srgb_displayp3_to_lin_rec709_color3(switch10_in3_cm_in, switch10_in3_cm_out);
    vec3 switch10_in4_cm_out = vec3(0.0);
    NG_srgb_displayp3_to_lin_rec709_color3(switch10_in4_cm_in, switch10_in4_cm_out);
    vec3 switch10_in5_cm_out = vec3(0.0);
    NG_srgb_displayp3_to_lin_rec709_color3(switch10_in5_cm_in, switch10_in5_cm_out);
    vec3 switch10_in6_cm_out = vec3(0.0);
    NG_srgb_displayp3_to_lin_rec709_color3(switch10_in6_cm_in, switch10_in6_cm_out);
    vec3 switch10_in7_cm_out = vec3(0.0);
    NG_srgb_displayp3_to_lin_rec709_color3(switch10_in7_cm_in, switch10_in7_cm_out);
    vec3 switch10_in8_cm_out = vec3(0.0);
    NG_srgb_displayp3_to_lin_rec709_color3(switch10_in8_cm_in, switch10_in8_cm_out);
    vec3 switch10_in9_cm_out = vec3(0.0);
    NG_srgb_displayp3_to_lin_rec709_color3(switch10_in9_cm_in, switch10_in9_cm_out);
    vec3 switch10_in10_cm_out = vec3(0.0);
    NG_srgb_displayp3_to_lin_rec709_color3(switch10_in10_cm_in, switch10_in10_cm_out);
    vec3 switch11_in1_cm_out = vec3(0.0);
    NG_lin_displayp3_to_lin_rec709_color3(switch11_in1_cm_in, switch11_in1_cm_out);
    vec3 switch11_in2_cm_out = vec3(0.0);
    NG_lin_displayp3_to_lin_rec709_color3(switch11_in2_cm_in, switch11_in2_cm_out);
    vec3 switch11_in3_cm_out = vec3(0.0);
    NG_lin_displayp3_to_lin_rec709_color3(switch11_in3_cm_in, switch11_in3_cm_out);
    vec3 switch11_in4_cm_out = vec3(0.0);
    NG_lin_displayp3_to_lin_rec709_color3(switch11_in4_cm_in, switch11_in4_cm_out);
    vec3 switch11_in5_cm_out = vec3(0.0);
    NG_lin_displayp3_to_lin_rec709_color3(switch11_in5_cm_in, switch11_in5_cm_out);
    vec3 switch11_in6_cm_out = vec3(0.0);
    NG_lin_displayp3_to_lin_rec709_color3(switch11_in6_cm_in, switch11_in6_cm_out);
    vec3 switch11_in7_cm_out = vec3(0.0);
    NG_lin_displayp3_to_lin_rec709_color3(switch11_in7_cm_in, switch11_in7_cm_out);
    vec3 switch11_in8_cm_out = vec3(0.0);
    NG_lin_displayp3_to_lin_rec709_color3(switch11_in8_cm_in, switch11_in8_cm_out);
    vec3 switch11_in9_cm_out = vec3(0.0);
    NG_lin_displayp3_to_lin_rec709_color3(switch11_in9_cm_in, switch11_in9_cm_out);
    vec3 switch11_in10_cm_out = vec3(0.0);
    NG_lin_displayp3_to_lin_rec709_color3(switch11_in10_cm_in, switch11_in10_cm_out);
    float extract1_out = texcoord2_out[extract1_index];
    float separate3_1_outx = 0.0;
    float separate3_1_outy = 0.0;
    float separate3_1_outz = 0.0;
    NG_separate3_vector3(position1_out, separate3_1_outx, separate3_1_outy, separate3_1_outz);
    float multiply2_out = extract1_out * multiply2_in2;
    float add1_out = separate3_1_outy + add1_in2;
    float trianglewave1_out = 0.0;
    NG_trianglewave_float(multiply2_out, trianglewave1_out);
    float multiply1_out = add1_out * multiply1_in2;
    float multiply3_out = trianglewave1_out * multiply3_in2;
    vec3 switch2_out = vec3(0.0);
    NG_switch_color3(switch2_in1_cm_out, switch2_in2_cm_out, switch2_in3_cm_out, switch2_in4_cm_out, switch2_in5_cm_out, switch2_in6_cm_out, switch2_in7_cm_out, switch2_in8_cm_out, switch2_in9_cm_out, switch2_in10_cm_out, multiply3_out, switch2_out);
    vec3 switch3_out = vec3(0.0);
    NG_switch_color3(switch3_in1_cm_out, switch3_in2_cm_out, switch3_in3_cm_out, switch3_in4_cm_out, switch3_in5_cm_out, switch3_in6_cm_out, switch3_in7_cm_out, switch3_in8_cm_out, switch3_in9_cm_out, switch3_in10_cm_out, multiply3_out, switch3_out);
    vec3 switch4_out = vec3(0.0);
    NG_switch_color3(switch4_in1_cm_out, switch4_in2_cm_out, switch4_in3_cm_out, switch4_in4_cm_out, switch4_in5_cm_out, switch4_in6_cm_out, switch4_in7_cm_out, switch4_in8_cm_out, switch4_in9_cm_out, switch4_in10_cm_out, multiply3_out, switch4_out);
    vec3 switch5_out = vec3(0.0);
    NG_switch_color3(switch5_in1_cm_out, switch5_in2_cm_out, switch5_in3_cm_out, switch5_in4_cm_out, switch5_in5_cm_out, switch5_in6_cm_out, switch5_in7_cm_out, switch5_in8_cm_out, switch5_in9_cm_out, switch5_in10_cm_out, multiply3_out, switch5_out);
    vec3 switch6_out = vec3(0.0);
    NG_switch_color3(switch6_in1_cm_out, switch6_in2_cm_out, switch6_in3_cm_out, switch6_in4_cm_out, switch6_in5_cm_out, switch6_in6_cm_out, switch6_in7_cm_out, switch6_in8_cm_out, switch6_in9_cm_out, switch6_in10_cm_out, multiply3_out, switch6_out);
    vec3 switch7_out = vec3(0.0);
    NG_switch_color3(switch7_in1_cm_out, switch7_in2_cm_out, switch7_in3_cm_out, switch7_in4_cm_out, switch7_in5_cm_out, switch7_in6_cm_out, switch7_in7_cm_out, switch7_in8_cm_out, switch7_in9_cm_out, switch7_in10_cm_out, multiply3_out, switch7_out);
    vec3 switch8_out = vec3(0.0);
    NG_switch_color3(switch8_in1_cm_out, switch8_in2_cm_out, switch8_in3_cm_out, switch8_in4_cm_out, switch8_in5_cm_out, switch8_in6_cm_out, switch8_in7_cm_out, switch8_in8_cm_out, switch8_in9_cm_out, switch8_in10_cm_out, multiply3_out, switch8_out);
    vec3 switch9_out = vec3(0.0);
    NG_switch_color3(switch9_in1_cm_out, switch9_in2_cm_out, switch9_in3_cm_out, switch9_in4_cm_out, switch9_in5_cm_out, switch9_in6_cm_out, switch9_in7_cm_out, switch9_in8_cm_out, switch9_in9_cm_out, switch9_in10_cm_out, multiply3_out, switch9_out);
    vec3 switch10_out = vec3(0.0);
    NG_switch_color3(switch10_in1_cm_out, switch10_in2_cm_out, switch10_in3_cm_out, switch10_in4_cm_out, switch10_in5_cm_out, switch10_in6_cm_out, switch10_in7_cm_out, switch10_in8_cm_out, switch10_in9_cm_out, switch10_in10_cm_out, multiply3_out, switch10_out);
    vec3 switch11_out = vec3(0.0);
    NG_switch_color3(switch11_in1_cm_out, switch11_in2_cm_out, switch11_in3_cm_out, switch11_in4_cm_out, switch11_in5_cm_out, switch11_in6_cm_out, switch11_in7_cm_out, switch11_in8_cm_out, switch11_in9_cm_out, switch11_in10_cm_out, multiply3_out, switch11_out);
    vec3 switch1_out = vec3(0.0);
    NG_switch_color3(switch2_out, switch3_out, switch4_out, switch5_out, switch6_out, switch7_out, switch8_out, switch9_out, switch10_out, switch11_out, multiply1_out, switch1_out);
    surfaceshader standard_surface1_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_standard_surface_surfaceshader_100(standard_surface1_base, switch1_out, standard_surface1_diffuse_roughness, standard_surface1_metalness, standard_surface1_specular, standard_surface1_specular_color, standard_surface1_specular_roughness, standard_surface1_specular_IOR, standard_surface1_specular_anisotropy, standard_surface1_specular_rotation, standard_surface1_transmission, standard_surface1_transmission_color, standard_surface1_transmission_depth, standard_surface1_transmission_scatter, standard_surface1_transmission_scatter_anisotropy, standard_surface1_transmission_dispersion, standard_surface1_transmission_extra_roughness, standard_surface1_subsurface, standard_surface1_subsurface_color, standard_surface1_subsurface_radius, standard_surface1_subsurface_scale, standard_surface1_subsurface_anisotropy, standard_surface1_sheen, standard_surface1_sheen_color, standard_surface1_sheen_roughness, standard_surface1_coat, standard_surface1_coat_color, standard_surface1_coat_roughness, standard_surface1_coat_anisotropy, standard_surface1_coat_rotation, standard_surface1_coat_IOR, geomprop_Nworld_out1, standard_surface1_coat_affect_color, standard_surface1_coat_affect_roughness, standard_surface1_thin_film_thickness, standard_surface1_thin_film_IOR, standard_surface1_emission, standard_surface1_emission_color, standard_surface1_opacity, standard_surface1_thin_walled, geomprop_Nworld_out1, geomprop_Tworld_out1, standard_surface1_out);
    material Standard_Surface1_out = standard_surface1_out;
    out1 = vec4(Standard_Surface1_out.color, 1.0);
}
