...
uniform vec3 SR_carpaint_diffuseColor = vec3(0.051890, 0.296060, 0.425324);
uniform vec3 SR_carpaint_emissiveColor = vec3(0.000000, 0.000000, 0.000000);
uniform int SR_carpaint_useSpecularWorkflow = 0;
uniform vec3 SR_carpaint_specularColor = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_carpaint_metallic = 0.000000;
uniform float SR_carpaint_roughness = 0.400000;
uniform float SR_carpaint_clearcoat = 1.000000;
uniform float SR_carpaint_clearcoatRoughness = 0.000000;
uniform float SR_carpaint_opacity = 1.000000;
uniform int SR_carpaint_opacityMode = 0;
uniform float SR_carpaint_opacityThreshold = 0.000000;
uniform float SR_carpaint_ior = 1.500000;
uniform vec3 SR_carpaint_normal = vec3(0.000000, 0.000000, 1.000000);
uniform float SR_carpaint_displacement = 0.000000;
uniform float SR_carpaint_occlusion = 1.000000;
...
void main()
{
    ...
    IMP_UsdPreviewSurface_surfaceshader(SR_carpaint_diffuseColor, SR_carpaint_emissiveColor, SR_carpaint_useSpecularWorkflow, SR_carpaint_specularColor, SR_carpaint_metallic, SR_carpaint_roughness, SR_carpaint_clearcoat, SR_carpaint_clearcoatRoughness, SR_carpaint_opacity, SR_carpaint_opacityMode, SR_carpaint_opacityThreshold, SR_carpaint_ior, SR_carpaint_normal, SR_carpaint_displacement, SR_carpaint_occlusion, SR_carpaint_out);
    material USD_Car_Paint_out = SR_carpaint_out;
    float outAlpha = clamp(1.0 - dot(USD_Car_Paint_out.transparency, vec3(0.3333)), 0.0, 1.0);
    out1 = vec4(USD_Car_Paint_out.color, outAlpha);
