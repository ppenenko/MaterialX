...
uniform float open_pbr_surface_surfaceshader_specular_ior = 1.504000;
...
uniform vec3 open_pbr_surface_surfaceshader_transmission_color = vec3(0.830000, 0.400000, 0.040000);
uniform float open_pbr_surface_surfaceshader_transmission_depth = 2.000000;
uniform vec3 open_pbr_surface_surfaceshader_transmission_scatter = vec3(0.900000, 0.900000, 0.900000);
...
void main()
{
    ...
    material Honey_out = open_pbr_surface_surfaceshader_out;
    float outAlpha = clamp(1.0 - dot(Honey_out.transparency, vec3(0.3333)), 0.0, 1.0);
    out1 = vec4(Honey_out.color, outAlpha);
