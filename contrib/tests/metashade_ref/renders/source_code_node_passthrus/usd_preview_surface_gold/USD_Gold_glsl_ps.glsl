...
uniform vec3 SR_gold_diffuseColor = vec3(0.944000, 0.776000, 0.373000);
uniform vec3 SR_gold_emissiveColor = vec3(0.000000, 0.000000, 0.000000);
uniform int SR_gold_useSpecularWorkflow = 0;
uniform vec3 SR_gold_specularColor = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_gold_metallic = 1.000000;
uniform float SR_gold_roughness = 0.020000;
uniform float SR_gold_clearcoat = 0.000000;
uniform float SR_gold_clearcoatRoughness = 0.010000;
uniform float SR_gold_opacity = 1.000000;
uniform int SR_gold_opacityMode = 0;
uniform float SR_gold_opacityThreshold = 0.000000;
uniform float SR_gold_ior = 1.500000;
uniform vec3 SR_gold_normal = vec3(0.000000, 0.000000, 1.000000);
uniform float SR_gold_displacement = 0.000000;
uniform float SR_gold_occlusion = 1.000000;
...
void main()
{
    ...
    IMP_UsdPreviewSurface_surfaceshader(SR_gold_diffuseColor, SR_gold_emissiveColor, SR_gold_useSpecularWorkflow, SR_gold_specularColor, SR_gold_metallic, SR_gold_roughness, SR_gold_clearcoat, SR_gold_clearcoatRoughness, SR_gold_opacity, SR_gold_opacityMode, SR_gold_opacityThreshold, SR_gold_ior, SR_gold_normal, SR_gold_displacement, SR_gold_occlusion, SR_gold_out);
    material USD_Gold_out = SR_gold_out;
    float outAlpha = clamp(1.0 - dot(USD_Gold_out.transparency, vec3(0.3333)), 0.0, 1.0);
    out1 = vec4(USD_Gold_out.color, outAlpha);
