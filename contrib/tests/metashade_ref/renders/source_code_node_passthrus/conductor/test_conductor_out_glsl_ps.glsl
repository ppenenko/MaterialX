...
uniform float roughness1_roughness = 0.200000;
uniform float roughness1_anisotropy = 0.000000;
uniform vec3 conductor_brdf1_artistic_ior_reflectivity = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 conductor_brdf1_artistic_ior_edge_color = vec3(1.000000, 1.000000, 1.000000);
...
void main()
{
    ...
    vec2 roughness1_out = vec2(0.0);
    mx_roughness_anisotropy(roughness1_roughness, roughness1_anisotropy, roughness1_out);
    ...
    surfaceshader surface1_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            mx_conductor_bsdf(closureData, conductor_brdf1_weight, conductor_brdf1_artistic_ior_ior, conductor_brdf1_artistic_ior_extinction, roughness1_out, conductor_brdf1_retroreflective, conductor_brdf1_thinfilm_thickness, conductor_brdf1_thinfilm_ior, geomprop_Nworld_out1, geomprop_Tworld_out1, conductor_brdf1_distribution, conductor_brdf1_out);
