...
uniform vec3 SR_default_diffuseColor = vec3(0.180000, 0.180000, 0.180000);
uniform vec3 SR_default_emissiveColor = vec3(0.000000, 0.000000, 0.000000);
uniform int SR_default_useSpecularWorkflow = 0;
uniform vec3 SR_default_specularColor = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_default_metallic = 0.000000;
uniform float SR_default_roughness = 0.500000;
uniform float SR_default_clearcoat = 0.000000;
uniform float SR_default_clearcoatRoughness = 0.010000;
uniform float SR_default_opacity = 1.000000;
uniform int SR_default_opacityMode = 0;
uniform float SR_default_opacityThreshold = 0.000000;
uniform float SR_default_ior = 1.500000;
uniform vec3 SR_default_normal = vec3(0.000000, 0.000000, 1.000000);
uniform float SR_default_displacement = 0.000000;
uniform float SR_default_occlusion = 1.000000;
...
void main()
{
    ...
    material USD_Default_out = SR_default_out;
    float outAlpha = clamp(1.0 - dot(USD_Default_out.transparency, vec3(0.3333)), 0.0, 1.0);
    out1 = vec4(USD_Default_out.color, outAlpha);
