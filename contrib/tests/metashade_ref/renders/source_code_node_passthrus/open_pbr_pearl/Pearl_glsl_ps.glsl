...
uniform vec3 open_pbr_surface_surfaceshader_base_color = vec3(0.800000, 0.750000, 0.700000);
...
uniform float open_pbr_surface_surfaceshader_specular_roughness = 0.350000;
uniform float open_pbr_surface_surfaceshader_specular_ior = 1.500000;
uniform float open_pbr_surface_surfaceshader_specular_roughness_anisotropy = 0.000000;
uniform float open_pbr_surface_surfaceshader_transmission_weight = 0.000000;
...
uniform float open_pbr_surface_surfaceshader_subsurface_weight = 1.000000;
uniform vec3 open_pbr_surface_surfaceshader_subsurface_color = vec3(0.800000, 0.750000, 0.700000);
uniform float open_pbr_surface_surfaceshader_subsurface_radius = 1.000000;
uniform vec3 open_pbr_surface_surfaceshader_subsurface_radius_scale = vec3(0.300000, 0.500000, 0.300000);
...
uniform float open_pbr_surface_surfaceshader_coat_weight = 1.000000;
uniform vec3 open_pbr_surface_surfaceshader_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float open_pbr_surface_surfaceshader_coat_roughness = 0.150000;
uniform float open_pbr_surface_surfaceshader_coat_roughness_anisotropy = 0.000000;
uniform float open_pbr_surface_surfaceshader_coat_ior = 1.680000;
...
uniform float open_pbr_surface_surfaceshader_thin_film_thickness = 0.420000;
uniform float open_pbr_surface_surfaceshader_thin_film_ior = 2.000000;
...
uniform bool open_pbr_surface_surfaceshader_geometry_thin_walled = false;
...
void NG_open_pbr_surface_surfaceshader(float base_weight, vec3 base_color, float base_diffuse_roughness, float base_metalness, float specular_weight, vec3 specular_color, float specular_roughness, float specular_ior, float specular_roughness_anisotropy, float transmission_weight, vec3 transmission_color, float transmission_depth, vec3 transmission_scatter, float transmission_scatter_anisotropy, float transmission_dispersion_scale, float transmission_dispersion_abbe_number, float subsurface_weight, vec3 subsurface_color, float subsurface_radius, vec3 subsurface_radius_scale, float subsurface_scatter_anisotropy, float fuzz_weight, vec3 fuzz_color, float fuzz_roughness, float coat_weight, vec3 coat_color, float coat_roughness, float coat_roughness_anisotropy, float coat_ior, float coat_darkening, float thin_film_weight, float thin_film_thickness, float thin_film_ior, float emission_luminance, vec3 emission_color, float geometry_opacity, bool geometry_thin_walled, vec3 geometry_normal, vec3 geometry_coat_normal, vec3 geometry_tangent, vec3 geometry_coat_tangent, out surfaceshader out1)
{
    ...
    surfaceshader shader_constructor_out = surfaceshader(vec3(0.0),vec3(0.0));
    {
        ...
        // Add environment contribution
        {
            ...
            mx_generalized_schlick_bsdf_metashade(closureData, metal_bsdf_tf_mix_fg_weight_out, metal_reflectivity_out, specular_color, vec3(1.000000, 1.000000, 1.000000), 5.000000, main_roughness_out, false, thin_film_thickness_nm_out, thin_film_ior, geometry_normal, geometry_tangent, 0, 0, metal_bsdf_tf_out);
            BSDF metal_bsdf_out = BSDF(vec3(0.0),vec3(1.0));
            mx_generalized_schlick_bsdf_metashade(closureData, metal_bsdf_tf_mix_bg_weight_out, metal_reflectivity_out, specular_color, vec3(1.000000, 1.000000, 1.000000), 5.000000, main_roughness_out, false, 0.000000, 1.500000, geometry_normal, geometry_tangent, 0, 0, metal_bsdf_out);
...
void main()
{
    ...
    material Pearl_out = open_pbr_surface_surfaceshader_out;
    out1 = vec4(Pearl_out.color, 1.0);
}
