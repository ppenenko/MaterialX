...
void NG_legacy_hardwood(vec3 color, bool stain_enable, vec3 stain_color, int finish, int used_for, bool tint_enable, vec3 tint_color, bool relief_pattern_enable, int relief_pattern_type, float relief_pattern_auto_amount, vec3 normal_pattern_custom, vec3 normal_floor_bump, out surfaceshader out1)
{
    ...
    NG_metashade_standard_surface(1.000000, tint_selection_out, 0.000000, 0.000000, 1.000000, vec3(1.000000, 1.000000, 1.000000), switch_rough_out, 1.500000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.000000, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 1.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, switch_coat_out, vec3(1.000000, 1.000000, 1.000000), switch_finish_out, 0.000000, 0.000000, 1.500000, geomprop_Nworld_out1, 0.000000, 0.000000, 0.000000, 1.500000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), false, relief_pattern_selection_out, geomprop_Tworld_out1, standard_surface_out);
