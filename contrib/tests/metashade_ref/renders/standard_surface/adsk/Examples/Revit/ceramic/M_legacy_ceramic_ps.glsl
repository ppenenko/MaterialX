...
void NG_legacy_ceramic(vec3 color, bool tint_enable, vec3 tint_color, int type, int finish, bool finish_bump_enable, int finish_bump, vec3 normal_custom_finish, vec3 normal_wavy_finish, bool relief_pattern_enable, vec3 normal_relief_pattern, out surfaceshader out1)
{
    ...
    NG_metashade_standard_surface(1.000000, tint_selection_out, 0.000000, 0.000000, 1.000000, vec3(1.000000, 1.000000, 1.000000), switch_rough_out, 1.500000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.000000, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 1.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, 1.000000, vec3(1.000000, 1.000000, 1.000000), switch_coat_out, 0.000000, 0.000000, switch_ior_out, geomprop_Nworld_out1, 0.000000, 0.000000, 0.000000, 1.500000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), false, bump_enable_select_out, geomprop_Tworld_out1, standard_surface_out);
