...
void adsk_NG_adsk_opaque(vec3 surface_normal, vec3 surface_cutout, vec3 surface_albedo, vec3 opaque_albedo, float surface_roughness, float surface_anisotropy, float surface_rotation, float opaque_f0, bool opaque_translucency, vec3 opaque_mfp_modifier, float opaque_mfp, bool opaque_emission, float opaque_luminance, vec3 opaque_luminance_modifier, out surfaceshader out1)
{
    ...
    NG_metashade_standard_surface(1.000000, opaque_albedo, 0.000000, 0.000000, 1.000000, surface_albedo, specular_roughness_value_out, specular_IOR_value_out, specular_anisotropy_value_out, specular_rotation_value_out, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.000000, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, 0.000000, subsurface_value_out, opaque_albedo, opaque_mfp_modifier, opaque_mfp, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.100000, 0.000000, 0.000000, 1.500000, geomprop_Nworld_out1, 0.000000, 0.000000, 0.000000, 1.500000, emission_value_scaled_out, opaque_luminance_modifier, surface_cutout, false, surface_normal, geomprop_Tworld_out1, standard_surface0_out);
