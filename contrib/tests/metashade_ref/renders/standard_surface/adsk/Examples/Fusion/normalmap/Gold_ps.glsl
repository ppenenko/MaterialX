...
uniform vec2 normal_texturemap_realworld_scale_unit_in1 = vec2(1.000000, 1.000000);
...
uniform float SR_gold_pass_base = 1.000000;
uniform vec3 SR_gold_pass_base_color = vec3(0.944000, 0.776000, 0.373000);
uniform float SR_gold_pass_diffuse_roughness = 0.000000;
uniform float SR_gold_pass_metalness = 1.000000;
uniform float SR_gold_pass_specular = 0.000000;
uniform vec3 SR_gold_pass_specular_color = vec3(0.998000, 0.981000, 0.751000);
uniform float SR_gold_pass_specular_roughness = 0.020000;
uniform float SR_gold_pass_specular_IOR = 1.500000;
uniform float SR_gold_pass_specular_anisotropy = 0.000000;
uniform float SR_gold_pass_specular_rotation = 0.000000;
uniform float SR_gold_pass_transmission = 0.000000;
uniform vec3 SR_gold_pass_transmission_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_gold_pass_transmission_depth = 0.000000;
uniform vec3 SR_gold_pass_transmission_scatter = vec3(0.000000, 0.000000, 0.000000);
uniform float SR_gold_pass_transmission_scatter_anisotropy = 0.000000;
uniform float SR_gold_pass_transmission_dispersion = 0.000000;
uniform float SR_gold_pass_transmission_extra_roughness = 0.000000;
uniform float SR_gold_pass_subsurface = 0.000000;
uniform vec3 SR_gold_pass_subsurface_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_gold_pass_subsurface_radius = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_gold_pass_subsurface_scale = 1.000000;
uniform float SR_gold_pass_subsurface_anisotropy = 0.000000;
uniform float SR_gold_pass_sheen = 0.000000;
uniform vec3 SR_gold_pass_sheen_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_gold_pass_sheen_roughness = 0.300000;
uniform float SR_gold_pass_coat = 0.000000;
uniform vec3 SR_gold_pass_coat_color = vec3(1.000000, 1.000000, 1.000000);
uniform float SR_gold_pass_coat_roughness = 0.100000;
uniform float SR_gold_pass_coat_anisotropy = 0.000000;
uniform float SR_gold_pass_coat_rotation = 0.000000;
uniform float SR_gold_pass_coat_IOR = 1.500000;
uniform float SR_gold_pass_coat_affect_color = 0.000000;
uniform float SR_gold_pass_coat_affect_roughness = 0.000000;
uniform float SR_gold_pass_thin_film_thickness = 0.000000;
uniform float SR_gold_pass_thin_film_IOR = 1.500000;
uniform float SR_gold_pass_emission = 0.000000;
uniform vec3 SR_gold_pass_emission_color = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 SR_gold_pass_opacity = vec3(1.000000, 1.000000, 1.000000);
uniform bool SR_gold_pass_thin_walled = false;
...
void main()
{
    ...
    surfaceshader SR_gold_pass_out = surfaceshader(vec3(0.0),vec3(0.0));
    NG_metashade_standard_surface(SR_gold_pass_base, SR_gold_pass_base_color, SR_gold_pass_diffuse_roughness, SR_gold_pass_metalness, SR_gold_pass_specular, SR_gold_pass_specular_color, SR_gold_pass_specular_roughness, SR_gold_pass_specular_IOR, SR_gold_pass_specular_anisotropy, SR_gold_pass_specular_rotation, SR_gold_pass_transmission, SR_gold_pass_transmission_color, SR_gold_pass_transmission_depth, SR_gold_pass_transmission_scatter, SR_gold_pass_transmission_scatter_anisotropy, SR_gold_pass_transmission_dispersion, SR_gold_pass_transmission_extra_roughness, SR_gold_pass_subsurface, SR_gold_pass_subsurface_color, SR_gold_pass_subsurface_radius, SR_gold_pass_subsurface_scale, SR_gold_pass_subsurface_anisotropy, SR_gold_pass_sheen, SR_gold_pass_sheen_color, SR_gold_pass_sheen_roughness, SR_gold_pass_coat, SR_gold_pass_coat_color, SR_gold_pass_coat_roughness, SR_gold_pass_coat_anisotropy, SR_gold_pass_coat_rotation, SR_gold_pass_coat_IOR, geomprop_Nworld_out1, SR_gold_pass_coat_affect_color, SR_gold_pass_coat_affect_roughness, SR_gold_pass_thin_film_thickness, SR_gold_pass_thin_film_IOR, SR_gold_pass_emission, SR_gold_pass_emission_color, SR_gold_pass_opacity, SR_gold_pass_thin_walled, normal_texturemap_out, geomprop_Tworld_out1, SR_gold_pass_out);
    material Gold_out = SR_gold_pass_out;
