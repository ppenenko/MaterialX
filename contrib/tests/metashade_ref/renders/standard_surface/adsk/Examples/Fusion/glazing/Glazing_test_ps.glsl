...
void adsk_NG_adsk_glazing(vec3 surface_albedo, vec3 surface_normal, vec3 surface_cutout, float surface_roughness, float surface_anisotropy, float surface_rotation, vec3 glazing_transmission_color, float glazing_transmission_roughness, vec3 glazing_f0, bool glazing_backface_culling, out surfaceshader out1)
{
    ...
    NG_metashade_standard_surface(1.000000, vec3(0.800000, 0.800000, 0.800000), 0.000000, 0.000000, 1.000000, surface_albedo, specular_roughness_value_out, specular_IOR_value_out, specular_anisotropy_value_out, specular_rotation_value_out, 1.000000, glazing_transmission_color_value_out, 0.000000, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, transmission_extra_roughness_value_out, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 1.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.100000, 0.000000, 0.000000, 1.500000, geomprop_Nworld_out1, 0.000000, 0.000000, 0.000000, 1.500000, 0.000000, vec3(1.000000, 1.000000, 1.000000), opacity_value_out, true, surface_normal, geomprop_Tworld_out1, standard_surface0_out);
