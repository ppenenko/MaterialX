...
void adsk_NG_adsk_transparent(vec3 surface_normal, vec3 surface_cutout, vec3 surface_albedo, float surface_roughness, float surface_anisotropy, float surface_rotation, float transparent_ior, vec3 transparent_color, float transparent_distance, out surfaceshader out1)
{
    ...
    NG_metashade_standard_surface(1.000000, vec3(0.800000, 0.800000, 0.800000), 0.000000, 0.000000, 1.000000, surface_albedo, specular_roughness_value_out, transparent_ior, specular_anisotropy_value_out, specular_rotation_value_out, 1.000000, transparent_color, transparent_distance, vec3(0.000000, 0.000000, 0.000000), 0.000000, 0.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), vec3(1.000000, 1.000000, 1.000000), 1.000000, 0.000000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.300000, 0.000000, vec3(1.000000, 1.000000, 1.000000), 0.100000, 0.000000, 0.000000, 1.500000, geomprop_Nworld_out1, 0.000000, 0.000000, 0.000000, 1.500000, 0.000000, vec3(1.000000, 1.000000, 1.000000), surface_cutout, false, surface_normal, geomprop_Tworld_out1, standard_surface0_out);
